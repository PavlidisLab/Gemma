...
/**
 * All web flow non-form action classes should subclass this. It adds easy-to-use message setting capabilities.
 * <hr>
 * <p>
 ...
 */
public abstract class AbstractFlowAction extends AbstractAction implements ApplicationContextAware {
    ...
    protected Object addMessage( RequestContext context, String messageKey, Object[] parameters ) {
        return context.getRequestScope()
                .setAttribute( "messages", getMessageSourceAccessor().getMessage( messageKey, parameters ) );
    }

...
public class PlatformFilterArg extends FilterArg {
    ...
    private PlatformFilterArg( List<String[]> propertyNames, List<Object[]> propertyValues,
            List<String[]> propertyOperators ) {
        super( propertyNames, propertyValues, propertyOperators, ObjectFilter.DAO_AD_ALIAS );
    }
    ...
    public static PlatformFilterArg valueOf( final String s ) {
        if( Strings.isNullOrEmpty(s)) return new PlatformFilterArg( null, null, null );
        ...
        try {
            ...
            checkProperties( propertyNames, ArrayDesign.class );
        } catch ( IllegalArgumentException e ) {
            return new PlatformFilterArg( ERROR_PARSE_ERROR, e );
        } catch ( NoSuchFieldException e ) {
            return new PlatformFilterArg( ERROR_INVALID_PROPERTY, e );
        }
        return new PlatformFilterArg( propertyNames, propertyValues, propertyOperators );
    }

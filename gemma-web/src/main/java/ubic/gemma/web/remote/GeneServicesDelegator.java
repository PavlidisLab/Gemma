...
public class GeneServicesDelegator {
    ...
    public Collection findGOTerms( GeneDelegator geneDelegator ) {
        Gene g = Gene.Factory.newInstance();
        g.setId( geneDelegator.getId() );
        return gene2GOAssociationService.findByGene( g );
    }

...
public class ExtCoexpressionSearchController extends BaseFormController {
    ...
    private void generateDatasetSummary( List<ExpressionExperimentValueObject> eevos,
            ExtCoexpressionMetaValueObject result, CountingMap<Long> supportCount,
     ...
     */
    @SuppressWarnings("unchecked")
    private ExtCoexpressionMetaValueObject getCannedAnalysisResults( Long cannedAnalysisId,
        ...
        ExtCoexpressionMetaValueObject result = initValueObject( queryGenes, eevos, true );
        ...
        for ( Gene queryGene : gg2gs.keySet() ) {
            ...
            ExtCoexpressionSummaryValueObject summary = makeSummary( eevos, datasetsTested, linksMetPositiveStringency,
                    linksMetNegativeStringency );
    ...
    private ExtCoexpressionMetaValueObject getCustomAnalysisResults( Collection<Long> eeIds, Collection<Gene> genes,
        ...
        ExtCoexpressionMetaValueObject result = initValueObject( genes, eevos, false );
     ...
     * @param queryGene
     */
    private void getGoOverlap( Collection<ExtCoexpressionValueObject> ecvos, Gene queryGene ) {
        /*
     ...
     * @return
     */
    private ExtCoexpressionMetaValueObject initValueObject( Collection<Gene> genes,
     ...
     * @return
     */
    private ExtCoexpressionSummaryValueObject makeSummary( List<ExpressionExperimentValueObject> eevos,

...
//        
//        try{
//            GZIPInputStream is = new GZIPInputStream( this.getClass().getResourceAsStream("/data/loader/ontology/MGEDOntology.owl.gz" ) );
//            OntologyTools.initOntology( is, "http://mged.sourceforge.net/ontologies/MGEDOntology.owl", OntModelSpec.OWL_MEM_RDFS_INF );
//        }
//        catch(Exception e){

...
import ubic.gemma.web.util.MessageUtil;
    ...
    /**
     * Extends this when the controller needs to display multiple progress information for different actions.
     * For each task that needs a progress bar extend the BackgroundControllerJob<ModelAndView>, put the work of the job in the
     * getRunner Method and pass it into startTask.   
     * 
     * @author klc
     * 
     * @version $Id$

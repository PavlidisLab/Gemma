...
/**
 * <p>
 * This class is designed to render a <label> tag for labeling your forms and adds an asterik (*) for required fields.
 * It was originally written by Erik Hatcher (http://www.ehatchersolutions.com/JavaDevWithAnt/).
 * </p>
 * <p>
 ...
 * </p>
 * 
 * @jsp.tag name="label" body-content="empty"
 * @version $Id$
 */
public class LabelTag extends TagSupport {
    ...
    /**
     * Setter for displaying a JavaScript popup helptip. Default is false because error text is shown next to field.
     * 
     * @jsp.attribute required="false" rtexprvalue="true"
     */

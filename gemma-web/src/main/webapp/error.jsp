...
<page:applyDecorator name="default">
    <c:choose>
        <c:when test="${requestScope['jakarta.servlet.error.status_code'] == 400}">
        ...
        <c:when test="${requestScope['jakarta.servlet.error.status_code'] == 405}">
            <%@ include file="/pages/error/405.jsp" %>
        </c:when>
        <c:when test="${requestScope['jakarta.servlet.error.status_code'] == 406}">
            <%@ include file="/pages/error/406.jsp" %>
        </c:when>
        <c:when test="${requestScope['jakarta.servlet.error.status_code'] == 415}">
        ...
        <c:when test="${requestScope['jakarta.servlet.error.status_code'] == 501}">

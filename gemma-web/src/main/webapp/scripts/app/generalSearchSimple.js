...
Gemma.Search.GeneralSearchSimpleCombo = Ext.extend(Ext.form.ComboBox, {
			...
			store : new Ext.data.ArrayStore({
						...
						data : [['everything', 'everything'], ['genes', 'genes'],
								['phenotypes', 'phenotypes'], ['experiments', 'experiments']]
			...
			/**
			 * returns an array of letters that can be used to code for the scope in a searcher.html 
			 * URL query
			 */

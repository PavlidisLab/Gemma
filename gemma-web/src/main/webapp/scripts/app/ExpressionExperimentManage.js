...
Ext
		.onReady( function() {
			...
			var adminRenderer = function(value, metadata, record, rowIndex,
				...
				// + '&nbsp;<a
				// href="/Gemma/expressionExperiment/editExpressionExperiment.html?id='
				// + value
				// + '" target="_blank"><img
				// src="/Gemma/images/icons/wrench.png" ext:qtip="Go to editor
				// page for this
			...
			var experimentalDesignEditRenderer = function(value, metadata,
				...
				var url = '<a target="_blank" href="/Gemma/experimentalDesign/showExperimentalDesign.html?eeid=' + id + '"><img src="/Gemma/images/icons/pencil.png" alt="view/edit experimental design" title="view/edit experimental design"/></a>';
				return value + '&nbsp;' + url;
			};
			...
			var experimentTaggerRenderer = function(value, metadata, record,
				...
				var id = record.get('id');
				var url = '<a href="#" onClick="return Ext.getCmp(\'eemanager\').tagger(' + id + ')"><img src="/Gemma/images/icons/pencil.png" alt="add tags" title="add tags"/></a>';
				return value + '&nbsp;' + url;
			};
			...
			var differentialAnalysisRenderer = function(value, metadata,
					record, rowIndex, colIndex, store) {
				var id = record.get('id');
				var runurl = '<a href="#" onClick="return Ext.getCmp(\'eemanager\').doDifferential(' + id + ')"><img src="/Gemma/images/icons/control_play_blue.png" alt="differential expression analysis" ext:qtip="Run differential expression analysis"/></a>';
			...
			/*
			 * FIXME. Only show this control if the user is admin? Or has at
			 * least _limit_ studies (hard to know in advance...)
			 */
			var controlForm = new Ext.form.FormPanel(
					{
						...
						items : [ {
							xtype :'checkbox',
							boxLabel :'Show all [Default: show only up to ' + limit + ' most recently changed (ties may result in more)]',
							hideLabel :true,

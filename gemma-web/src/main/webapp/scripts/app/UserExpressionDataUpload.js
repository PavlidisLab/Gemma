...
Gemma.DatasetUploadTool = Ext.extend(Ext.util.Observable, {
    ...
    onValidated : function(result) {
        ...
        if (result.valid) {
            ...
            Ext.Msg.alert("Your data look valid", "Your data matrix had " + result.numRows + " rows, "
                            ...
                            + " probes on the platform matched your data, " + result.numberOfNonMatchingProbes
                            + " didn't." + " If this all looks correct to you, click 'submit' to continue", function() {
                        /*
    ...
    submitDataset : function() {
         ...
         * everything 2) do the conversion 3) forward the user to the new data set page. Make sure they get instructions
         * on how to
         */
        ...
        items : [{
                    ...
                    items : [{
                        ...
                        items : [{
                                    ...
                                    xtype : 'label',
                                    style : 'color: #800000;',
                                    text : (Ext.get('hasAdmin') !== null) ? (Ext.get('hasAdmin').getValue()
                                            ? adminDataAvailabilityMessage

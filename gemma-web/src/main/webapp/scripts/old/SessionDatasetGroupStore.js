 ...
 * 
 * Though this should only be used for creation, EXT requires all CRUD operations to be defined: read: retrieves all
 * session-bound groups update: uses same method as UserSessionDatasetGroupStore destroy: uses same method as
 * UserSessionDatasetGroupStore
 * 

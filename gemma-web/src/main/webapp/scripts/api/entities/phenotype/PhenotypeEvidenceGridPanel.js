...
Gemma.PhenotypeEvidenceGridPanel = Ext
   .extend(
      Ext.grid.GridPanel,
      {
         storeAutoLoad : false,
         ...
         initComponent : function() {
            ...
            var generatePublicationLinks = function( pudmedId, pubmedUrl ) {
               ...
               if ( pudmedId != null ) {
                  ...
                  if ( Gemma.isRunningOutsideOfGemma() ) {
                     anchor += generateLink( 'showDialogViewBibliographicReferenceOutsideOfGemma();', imageSrc,
            ...
            var showPhenotypeAssociationFormWindow = function( action, data ) {
               if ( !phenotypeAssociationFormWindow
                  || (phenotypeAssociationFormWindow && phenotypeAssociationFormWindow.isDestroyed) ) {
            ...
            var createPhenotypeAssociationButton = new Ext.Button( {
               ...
               handler : Gemma.isRunningOutsideOfGemma() ? function() {
                  Ext.Msg.alert(
                     Gemma.HelpText.WidgetDefaults.PhenotypePanel.modifyPhenotypeAssociationOutsideOfGemmaTitle,
            ...
            var getFormWindowData = function( id ) {
               ...
               if ( evidenceClassName === 'LiteratureEvidenceValueObject' ) {
                  ...
                  data = {
                     primaryPubMedId : phenotypeAssPubVO[0].citationValueObject != null ? phenotypeAssPubVO[0].citationValueObject.pubmedAccession
                        : null,
                     // Assume we have at most one other PubMed
                     // Id.

                     secondaryPubMedId : phenotypeAssPubVO.length > 1
                        && phenotypeAssPubVO[1].citationValueObject != null ? phenotypeAssPubVO[1].citationValueObject.pubmedAccession
                        : null,
                  ...
                  var viewEvidenceWindow = new Gemma.MetaAnalysisEvidenceWindow(
                     {
                        ...
                        title : 'View Phenocarta evidence for '
                           + record.data.geneDifferentialExpressionMetaAnalysisSummaryValueObject.name,
                        ...
                        read : {
                           ...
                           getDwrArgsFunction : function( request ) {
                              return [ request.params['taxonId'], request.params['showOnlyEditable'],
                                      request.params['databaseIds'], request.params["geneId"],
                                  ...
                                  'homologueEvidence',
                                  {
                                     ...
                                     convert : function( value, record ) {
                                        ...
                                        switch (record.className) {
                                           case 'DiffExpressionEvidenceValueObject':
                                              ...
                                              descriptionHtml += '<b>p-value</b>: '
                                                 + record.metaPvalue.toExponential( 2 ) + '; ' + '<b>q-value</b>: '
                                                 + record.metaQvalue.toExponential( 2 ) + '; ' + '<b>Direction</b>: '
                                                 + metaAnalysisUtilities.generateDirectionHtml( record.upperTail )
                                                 + '<br />';
                                           ...
                                           case 'ExperimentalEvidenceValueObject':
                                              ...
                                              for (var i = 0; i < record.phenotypeAssPubVO.length; i++) {
                                                 ...
                                                 descriptionHtml += '<b>' + record.phenotypeAssPubVO[i].type
                                                    + ' Publication</b>: ';
                                                 descriptionHtml += record.phenotypeAssPubVO[i].citationValueObject.citation
                                                    + ' '
                                                    + generatePublicationLinks(
                                                       record.phenotypeAssPubVO[i].citationValueObject.pubmedAccession,
                                                       record.phenotypeAssPubVO[i].citationValueObject.pubmedURL )
                                                    + '<br />';
                                              }
                                           ...
                                           case 'LiteratureEvidenceValueObject':
                                              ...
                                              if ( record.phenotypeAssPubVO.length > 1 ) {
                                                 ...
                                                 descriptionHtml += '<p><b>Publication</b>: '
                                                    + record.phenotypeAssPubVO[0].citationValueObject.citation
                                                    + ' '
                                                    + generatePublicationLinks(
                                                       record.phenotypeAssPubVO[0].citationValueObject.pubmedAccession,
                                                       record.phenotypeAssPubVO[0].citationValueObject.pubmedURL )
                                                    + '</p>';
                                              }
                                              descriptionHtml += '<\p>';
                                        ...
                                        if ( record.evidenceSource != null
                                           && record.evidenceSource.externalDatabase.name != null
                                           && record.evidenceSource.externalUrl != null ) {
                                           var databaseName = record.evidenceSource.externalDatabase.name;
                                           descriptionHtml += '<p><b>Evidence Source</b>: '
                                              + databaseName
                                              + ' '
                                              + convertToExternalDatabaseAnchor( databaseName,
                                                 record.evidenceSource.externalUrl, false ) + '</p>';
                                        }
                                        ...
                                        if ( record.homologueEvidence ) {
                                           ...
                                           descriptionHtml += String
                                              .format(
                                                 "<p><b>*</b> Inferred from homology with the {0} gene {1} "
                  ...
                  listeners : {
                     load : function( store, records, options ) {
                        if ( Ext.getCmp( "evidenceGrid" ) != null ) {
                           Ext.getCmp( "evidenceGrid" ).setTitle(
                              store.getCount() + " Evidence for "
                                 + Ext.getCmp( "evidenceGrid" ).currentGene.officialSymbol );
                        }
                     }
                  }
            ...
            var columns = [
                           ...
                           },
                           {
                              ...
                              renderer : function( value, metadata, record, rowIndex, colIndex, store ) {
                                 ...
                                 if ( record.data.evidenceSource != null
                                    && record.data.evidenceSource.externalDatabase != null ) {
                                    externalSource = 'External Source ['
                                       + record.data.evidenceSource.externalDatabase.name + ']';
                                 }
                                 ...
                                 switch (value) {
                                    ...
                                    case 'ExperimentalEvidenceValueObject':
                                       ...
                                       if ( experimentCharacteristics != null ) {
                                          ...
                                          if ( experimentValues.length > 0 ) {
                                             experimentValues = ' [ '
                                                + experimentValues.substr( 0, experimentValues.length - 3 ) + ' ]';
                                          }
                                       }
                                    ...
                                    case 'LiteratureEvidenceValueObject':
                                       ...
                                       if ( record.data.phenotypeAssPubVO.length > 1 ) {
                                          typeColumnHtml = '<b>' + record.data.phenotypeAssPubVO.length
                                             + 'x</b> Literature';
                                       } else {
                                 ...
                                 fn : function( value, metadata, record, rowIndex, colIndex, store ) {
                                    ...
                                    if ( record.data.homologueEvidence ) {
                                       columnRenderer = '<span ext:qwidth="200" ext:qtip="'
                                          + 'Inferred from homology with the ' + record.data.taxonCommonName + ' gene '
                                          + record.data.geneOfficialSymbol + '.' + '">' + 'Inferred from '
                                          + record.data.geneOfficialSymbol + ' [' + record.data.taxonCommonName + ']'
                                          + '</span>';
                                    } else {
                                       var evidenceCodeInfo = Gemma.EvidenceCodeInfo[value];
                                       var qtipInfo = Gemma.EvidenceCodeInfo.getQtipInfo( value, evidenceCodeInfo );

                                       columnRenderer = '<span ext:qwidth="' + qtipInfo.width + '" ext:qtip="'
                                          + qtipInfo.text + '">'
                                          + (this.displayEvidenceCodeFullName ? evidenceCodeInfo.name : value)
                                          + '</span>';
                                    }
                           ...
                           },
                           {
                              ...
                              renderer : function( value, metadata, record, rowIndex, colIndex, store ) {
                                 ...
                                 if ( value != null && value.externalDatabase.name != null && value.externalUrl != null ) {
                                    ...
                                    linkOutHtml += convertToExternalDatabaseAnchor( value.externalDatabase.name,
                                       value.externalUrl, true );
                                 }
                           ...
                           },
                           {
                              ...
                              renderer : function( value, metadata, record, rowIndex, colIndex, store ) {
                                 ...
                                 // Don't display anything if this column is hidden because users can still show this
                                 // column
                                 // manually.
                                 if ( !this.hidden && record.data.className !== 'DiffExpressionEvidenceValueObject' ) {
                                    ...
                                    adminLinks += Gemma.SecurityManager.getSecurityLink(
                                       'ubic.gemma.model.association.phenotype.PhenotypeAssociation', record.data.id,
                                       record.data.evidenceSecurityValueObject.publik,
                                       record.data.evidenceSecurityValueObject.shared,
                                       record.data.evidenceSecurityValueObject.currentUserHasWritePermission, null,
                                       null, 'Phenotype Association',
            ...
            Ext.apply( this, {
               ...
               removeEvidence : function( id ) {
                  Ext.MessageBox.confirm( 'Confirm', 'Are you sure you want to remove this evidence?',
                     function( button ) {
                        if ( button === 'yes' ) {
                           PhenotypeController.removePhenotypeAssociation( id, function( validateEvidenceValueObject ) {
                              if ( validateEvidenceValueObject == null ) {
                                 ...
                                 if ( validateEvidenceValueObject.evidenceNotFound ) {
                                    ...
                                    // removed.
                                    this.fireEvent( 'phenotypeAssociationChanged' );
                                    Ext.Msg.alert( 'Evidence already removed',
                                       'This evidence has already been removed by someone else.' );
                                 } else {
                                    Ext.Msg.alert( 'Cannot remove evidence', Gemma

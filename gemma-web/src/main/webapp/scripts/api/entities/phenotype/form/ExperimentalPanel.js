      ...
      initComponent : function() {
         ...
         var updatePubMedIdsValidity = function( isModifying, literaturePanel, isValid ) {
            ...
            this.fireEvent( 'validtyStatusChanged', isModifying, pubMedIdErrorMessages
               .concat( experimentTagErrorMessages ) );
         }.createDelegate( this );
         ...
         var updateExperimentTagsValidity = function( isModifying ) {
            ...
            if ( experimentTagsPanel.checkDuplicate() ) {
               experimentTagErrorMessages
                  .push( Gemma.HelpText.WidgetDefaults.PhenotypeAssociationForm.ErrorMessage.experimentTagsDuplicate );
               this.fireEvent( 'validtyStatusChanged', isModifying, pubMedIdErrorMessages
                  .concat( experimentTagErrorMessages ) );
            } else {
               this.fireEvent( 'validtyStatusChanged', isModifying, pubMedIdErrorMessages );
         ...
         Ext.apply( this, {
            ...
            selectExperimentalData : function( primaryPubMedId, secondaryPubMedId, experimentTagSelections,
               geneSelection ) {
            ...
            isValid : function() {
               ...
               return primaryLiteraturePanel.isValid() && secondaryLiteraturePanel.isValid()
                  && ((primaryPubMedId !== secondaryPubMedId) || (primaryPubMedId === '' && secondaryPubMedId === ''))
                  && (primaryPubMedId !== '' || secondaryPubMedId === '') && experimentTagsPanel.isValid();
            },
            getValues : function() {

...
Gemma.PhenotypeGeneGridPanel = Ext
   .extend(
      Ext.grid.GridPanel,
      {
         title : 'Genes',
         ...
         initComponent : function() {
            var DEFAULT_TITLE = this.title; // A constant title that will be used when we don't have current
                                             // phenotypes.

            var titleText = this.title; // Contains the title's text without any HTML code whereas title may contain
                                          // HTML
            // code.
                  ...
                  this,
                  {
                     store : new Ext.data.Store(
                        {
                                 ...
                                 read : {
                                    ...
                                    getDwrArgsFunction : function( request ) {
                                       return [ request.params['taxonId'], request.params['showOnlyEditable'],
                                               request.params['databaseIds'], request.params["phenotypeValueUris"] ];
                           ...
                           listeners : {
                              ...
                              // The main purpose of this load listener is to fix the problem that loading genes for
                              // current
                              // phenotypes
                              // may take a very long time and current phenotypes may have been changed by users during
                              // this
                              // loading period.
                              // By the time genes are loaded, these genes will replace existing genes for current
                              // phenotypes.
                              ...
                              load : function( store, records, options ) {
                                 ...
                                 this.setCurrentPhenotypes( this.currentFilters, this.currentPhenotypes, store
                                    .getCount() );
                     ...
                     setCurrentPhenotypes : function( currentFilters, currentPhenotypes, count ) {
                        ...
                        if ( hasCurrentPhenotypes ) {
                           ...
                           this.setTitle( "<div style='height: 15px; overflow: hidden;' " + // Make the header one line
                                                                                             // only.
                           "ext:qtitle='" + selectedPhenotypePrefix + "' " + "ext:qtip='" + selectedPhenotypeTooltip
                              + "'>" + selectedPhenotypeHeader + "</div>" );

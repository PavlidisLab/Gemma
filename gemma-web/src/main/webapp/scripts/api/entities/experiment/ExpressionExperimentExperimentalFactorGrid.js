...
Gemma.ExpressionExperimentExperimentalFactorGrid = Ext.extend( Ext.grid.PropertyGrid, {
   ...
   /**
    * Implementation note: PropertyGrid does not support custom cell renders the way regular Grids do, so we preformat
    * the Factor name on the server.
    */

   /**
    * @memberOf Gemma.ExpressionExperimentExperimentalFactorGrid
    */

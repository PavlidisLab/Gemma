...
Gemma.GeneGroupCombo = Ext.extend(Ext.form.ComboBox, {
    ...
    listEmptyTextBlankQuery: "Choose or search for groups",
    minChars: 1,
    selectOnFocus: true,
    mode: 'remote',
    ...
    /**
     * @memberOf Gemma.GeneGroupCombo
     */
    initComponent: function () {

        var template = new Ext.XTemplate(
            '<tpl for="."><div style="font-size:11px" class="x-combo-list-item" ext:qtip="{name} ({size})"> {name} - {description} ({size})</div></tpl>');

 ...
 * @type {*}
 */
Gemma.MetaHeatmapDataSelection = Ext
   .extend(
      Ext.Panel,
      {
          ...
          * 
          * @param target
          * @memberOf Gemma.MetaHeatmapDataSelection
          */
         prepareVisualization : function( target ) {
            ...
            if ( datasetGroupsToBindToSession.length !== 0 ) {
               ...
               ExpressionExperimentSetController.addSessionGroups( datasetGroupsToBindToSession, false, function(
                  datasetSets ) {
         ...
         doVisualization : function() {
            ...
            if ( this.initexperimentGroupValueObjects ) {
               this.experimentGroupValueObjects = this.experimentGroupValueObjects
                  .concat( this.initExperimentGroupResultValueObjects );
            }
            if ( this.initexperimentGroupValueObjects ) {
               this.experimentGroupValueObjects = this.experimentGroupValueObjects
                  .concat( this.initexperimentGroupValueObjects );
            }
            ...
            DifferentialExpressionSearchController.scheduleDiffExpSearchTask( this.taxonId,
               ...
               this.initExperimentSessionGroupQueries, this._initBackgroundTaskProgress.createDelegate( this ) );
         },

...
ExperimentalDesignController._path = '/dwr';
ExperimentalDesignController.getBioMaterialCharacteristicCategories = function(p0, callback) {
  dwr.engine._execute(ExperimentalDesignController._path, 'ExperimentalDesignController', 'getBioMaterialCharacteristicCategories', p0, callback);
}
...
ExperimentalDesignController.markFactorValuesAsNeedsAttention = function(p0, p1, callback) {
  dwr.engine._execute(ExperimentalDesignController._path, 'ExperimentalDesignController', 'markFactorValuesAsNeedsAttention', p0, p1, callback);
}
ExperimentalDesignController.clearFactorValuesNeedsAttention = function(p0, p1, callback) {
  dwr.engine._execute(ExperimentalDesignController._path, 'ExperimentalDesignController', 'clearFactorValuesNeedsAttention', p0, p1, callback);
}
...
ExperimentalDesignController.deleteExperimentalFactors = function(p0, p1, callback) {
  dwr.engine._execute(ExperimentalDesignController._path, 'ExperimentalDesignController', 'deleteExperimentalFactors', p0, p1, callback);
}
...
ExperimentalDesignController.duplicateFactorValue = function(p0, p1, callback) {
  dwr.engine._execute(ExperimentalDesignController._path, 'ExperimentalDesignController', 'duplicateFactorValue', p0, p1, callback);
}
...
window.ExperimentalDesignController = ExperimentalDesignController;
export default ExperimentalDesignController;

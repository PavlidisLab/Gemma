...
Gemma.AnalysisResultsSearch = Ext.extend( Ext.Panel, {
   ...
   /**
    * @memberOf Gemma.AnalysisResultsSearch
    */
   initComponent : function() {
      ...
      searchForm.on( "showOptions", function( stringency, queryGenesOnly ) {
         if ( this.admin ) {
            coexResultsTabPanel.insert( 1, {
               border : false,
               html : '<h4>Refinements Used:</h4>Stringency = ' + stringency + "<br>Results only among query genes: "
                  + queryGenesOnly + '<br>'
            } );
         } else {
            coexResultsTabPanel.insert( 1, {

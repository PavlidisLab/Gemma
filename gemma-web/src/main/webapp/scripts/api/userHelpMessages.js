...
Gemma.HelpText.WidgetDefaults = {
	...
	ArrayDesignsNonPagingGrid: {
		...
		hideOrphansTT: "Click to show/hide platforms that aren't used by any experiments in Gemma", hideAffyAltTT: "Click to show/hide platforms that are alternative Affymetrix layouts (generally not used in Gemma)",

...

{
   ...
   plugins : [ new Ext.ux.plugins.ContainerMask({ msg : 'Loading ... <img src="/Gemma/images/loading.gif" />',
      masked : true }) ],

   graphConfig : { label : true, forceFit : true },
   ...
   show : function(config) {
      ...
      this.dataView.getStore().load({ params : params, callback : this.dedvCallback.createDelegate(this) });
   ...
   initComponent : function() {
      ...
      this.dataView = new Ext.DataView({ autoHeight : true, emptyText : 'Data not available',
         loadingText : 'Loading...', store : new Gemma.VisualizationStore({ readMethod : this.readMethod }) });

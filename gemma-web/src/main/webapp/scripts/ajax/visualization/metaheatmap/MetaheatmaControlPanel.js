...
Gemma.Metaheatmap.Strings.ControlPanel.SortConditionCombo.fieldTipHTML = '<br><b>Full Name</b>: official descriptive title<br><br>'
   + '<b>Short Name</b>: short name or ID (ex: GSE1234)<br><br>' + '<b>q Value</b>: confidence that the selected genes are differentially expressed<br><br>'
...
Gemma.Metaheatmap.Strings.ControlPanel.SortConditionCombo.fieldTip = 'Name: official descriptive title.  q Value: confidence in the expression levels of the selected genes.  '
   + 'Diff. Exp. Specificity: the proportion of probes that are differentially expressed ' + 'across each experimental factor '
   + 'versus the total number of expressed probes. This measure is represented by each column\'s pie chart. Experiments are ordered based '
         ...
         Ext.apply(this, {
               ...
               items : [{
                     ...
                     items : [{
                           ...
                           // '+
                           // 'Allows you to hide a gene based on how many conditions it\'s missing data for"
                  ...
                  }, // eo gene fieldset
                  {
                     ...
                     items : [{
                           ...
                           // html : 'Missing data filter <img ext:qtip="<b>Control the tolerance for missing data.</b>
                           // '+
                           // 'Allows you to hide a condition based on how many genes it\'s missing data for"
                           // src="/Gemma/images/icons/question_blue.png"/>:',
                           height : 15
                        }, {
                           xtype : 'slider',

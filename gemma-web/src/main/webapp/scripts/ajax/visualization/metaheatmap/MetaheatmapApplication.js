...
Gemma.Metaheatmap.Application = Ext.extend(Ext.Panel, {
       ...
       *           state.geneSort state.eeSort state.filters = list of filters applied, values listed should be filtered
       *           OUT (note this is the opposite heuristic as in viz) (done to minimize url length) state.taxonId

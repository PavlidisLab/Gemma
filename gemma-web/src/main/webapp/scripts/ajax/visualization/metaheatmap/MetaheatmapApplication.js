		...
		Ext.apply(this, {
			...
			items : [{
				...
				tpl : new Ext.XTemplate(
						...
						'</tpl>',
						'<tpl if="type==\'minipie\'">',
						'<b>Total Number of Probes</b>: {numberOfProbesTotal}<br><br>',
						'<b>Number of Probes Differentially Expressed</b>: {numberOfProbesDiffExpressed}<br> <br>',
						'<b>Number of Probes Up Regulated</b>: {numberOfProbesUpRegulated}<br><br> ',
						'<b>Number of Probes Down Regulated</b>: {numberOfProbesDownRegulated}<br><br>',
						'</tpl>',
						'<tpl if="type==\'gene\'">',

...
GemmaStatUtils.logGamma = function(x) {
   ...
   var aCoefficient = [ 8.11614167470508450300E-4, -5.95061904284301438324E-4, 7.93650340457716943945E-4,
         -2.77777777730099687205E-3, 8.33333333333331927722E-2 ];
   var bCoefficient = [ -1.37825152569120859100E3, -3.88016315134637840924E4, -3.31612992738871184744E5,
...
GemmaStatUtils.dbinom_raw = function(x, n, p, q) {
   ...
   lc = GemmaStatUtils.stirlerr(n) - GemmaStatUtils.stirlerr(x) - GemmaStatUtils.stirlerr(n - x)
         - GemmaStatUtils.bd0(x, n * p) - GemmaStatUtils.bd0(n - x, n * q);
   f = (2 * Math.PI * x * (n - x)) / n;

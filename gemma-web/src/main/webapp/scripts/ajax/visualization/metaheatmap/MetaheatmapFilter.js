...
function GemmaMetaheatmapFilter(){
	 ...
	 *
	 * If you add at index 18 and there are only 2 filters, it will just be added to the end
	 * (That means a subsequent addition at index 17 would actually come *after*.
	 *  Use this.getFilterCount()-x to insert appropriately)
	 *
	 * If you just want the filter to be added on to the end, pass in index = null or leave it off
	 *
	 * @param {Object} fn should return true if object should be hidden
	 * @param {Object} index (optional) indicates order in which to run this filter relative to others

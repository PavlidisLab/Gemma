...
Gemma.CytoscapeJSPanel = Ext.extend( Ext.Panel,
   {
      ...
      initComponent : function() {
            ...
            items : [
                     ...
                     },
                     {
                        ...
                        html : '&nbsp&nbsp<img ext:qtip="'
                           + Gemma.HelpText.WidgetDefaults.CytoscapePanel.graphSizeMenuTT2
                     ...
                     },
                     {
                        ...
                        html : '&nbsp&nbsp<img ext:qtip="'
                           + Gemma.HelpText.WidgetDefaults.CytoscapePanel.graphSizeMenuTT
                           + '" src="/Gemma/images/icons/question_blue.png"/>&nbsp',
                        height : 15
                     } ]
         ...
         this.coexpressionSearchData.on( 'complete-search-results-ready', function( searchResults,
            ...
            if ( !this.coexGraphData.mediumGraphDataEnabled ) {
               ...
               if ( this.coexpressionSearchData.cytoscapeSearchResults.nonQueryGeneTrimmedValue > 0 ) {
                  this.showUserMessageBar( this.coexpressionSearchData.cytoscapeSearchResults.nonQueryGeneTrimmedValue,
                     false );
               } else {
         ...
         /*
          * this.coexpressionSearchData.on('aftersearch', function() { if (this.loadMask) { this.loadMask.hide(); } },
          * this);
          */
      ...
      /**
       * @private Since we are a panel inside tabpanel [grid, visualization]. This is run when user selects
       *          visualization tab.
       * 
       */
      onPanelActivation : function() {
         ...
         // check to see if coexGrid display stringency is below cytoscape results stringency, if so, give the user the
      ...
      extendSelectedNodes : function() {
         ...
         if ( (queryGeneIds.length + selectedGeneIds.length) <= Gemma.MAX_GENES_PER_CO_EX_VIZ_QUERY ) {
            ...
            Ext.Msg.confirm( Gemma.HelpText.WidgetDefaults.CytoscapePanel.searchStatusTitle, String.format(
               Gemma.HelpText.WidgetDefaults.CytoscapePanel.searchStatusTooManyReduce,
      ...
      updateSearchFormGenes : function( geneIds ) {
         // This collects all the query Genevalueobjects and fires an event to let the search form listening know that
         ...
         this.fireEvent( 'queryUpdateFromCoexpressionViz', genesToPreview, genesToPreviewIds, this.taxonId,
            this.taxonName );
      },

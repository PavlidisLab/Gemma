                              ...
                              if (form.isValid()) {
                                 form.submit({
                                       success : function(form, a) {
                                          var m = a.result;
                                          Ext.getCmp('messages').setText("File uploaded: " + m.originalFile + "; " + m.size + " bytes");
                                          this.fireEvent('finish', m);

                                       }.createDelegate(this),
                                       failure : function(form, a) {
                                          Ext.Msg.alert('Failure', 'Problem with processing of file on the server: ' + a.result.error);

...
/**
 * User interface for selecting experimental factors. Used if the user's browser cannot support canvas elements. (ex
 * IE8)
 * 
...
Gemma.ExperimentalFactorChooserPanel = Ext.extend(Ext.Window, {
      ...
      onHelp : function() {
         ...
         Ext.Msg.alert(Gemma.HelpText.WidgetDefaults.ExperimentalFactorChooserPanel.helpTitle, Gemma.HelpText.WidgetDefaults.ExperimentalFactorChooserPanel.helpText);
      ...
      returnFromGetFactors : function(results) {
         ...
         if (results.size() > 0) {
            ...
            this.loadMask.hide();
            Ext.Msg.alert(Gemma.HelpText.WidgetDefaults.ExperimentalFactorChooserPanel.noResultsTitle, Gemma.HelpText.WidgetDefaults.ExperimentalFactorChooserPanel.noResultsText);
         }
      }
   });
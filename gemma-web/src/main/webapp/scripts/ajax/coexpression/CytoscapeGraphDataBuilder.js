    ...
    constructGraphData: function (queryGeneIds, coexPairs) {
        ...
        function makeEdge(genePair) {
            ...
            return {
                ...
                nodeDegree: Gemma.CytoscapePanelUtil.decimalPlaceRounder(
                    Gemma.CytoscapePanelUtil.getMaxWithNull(
                        genePair.queryGene.nodeDegree,
                        genePair.foundGene.nodeDegree))
            };
        }

...
Gemma.GeneDetails = Ext.extend(Ext.Panel, {
      ...
      renderHomologues : function(homologues, mainGeneSymbol) {
         ...
         for (j = 0; j < homologues.length; j++) {
            ...
            homologueStr += "<a title=\"View this homologous gene in Gemma\" href=\"/Gemma/gene/showGene.html?id=" + homologue.id + "\">" + homologue.officialSymbol + "&nbsp;["
      ...
      renderPhenotypes : function(geneDetails) {
         if (geneDetails.phenotypes && geneDetails.phenotypes.length > 0) {
            ...
            for (i = 0; i < limit; i++) {
               text += '<a target="_blank" href="' + Gemma.LinkRoots.phenotypePage + phenotypes[i].urlId + '">' + phenotypes[i].value + '</a>';
               if ((i + 1) !== limit) {
                  text += ', ';
               }
            }
            ...
            text += "<img style='cursor:pointer' src='/Gemma/images/magnifier.png' ext:qtip='See all associated phenotypes'" + "onClick='Ext.getCmp(&#39;" + this.id
               + "&#39;).changeTab(&#39;phenotypes&#39;)'>";
            return text;
         } else {
            return "[ None ]";
         }
      ...
      initComponent : function() {
         ...
         this.on('afterrender', function() {
               ...
               GeneController.loadGeneDetails(this.geneId, function(geneDetails) {
                     ...
                     this.loadMask.hide();
                     this.add([{
                           html : '<div style="font-weight: bold; font-size:1.3em;">' + geneDetails.name + '<br />' + geneDetails.officialName + '<br/></div>'
                        }, {
                           layout : 'form',
                           flex : 1,
                           defaults : {
                           ...
                           items : [{
                                 ...
                                 html : geneDetails.ncbiId + ' <a target="_blank" title="NCBI Gene link"'
                                    + 'href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=gene&cmd=Retrieve&dopt=full_report&list_uids=' + geneDetails.ncbiId
                                 ...
                                 fieldLabel : 'Studies' + '&nbsp;<a class="helpLink" href="javascript: void(0)" onclick="showHelpTip(event, ' + '\''
                                    + Gemma.HelpText.WidgetDefaults.GeneDetails.assocExpTT + '\'); return false">' + '<img src="/Gemma/images/help.png" /> </a>',
                                 ...
                                 fieldLabel : 'Multifunc.' + '&nbsp;<a class="helpLink" href="javascript: void(0)" onclick="showHelpTip(event, ' + '\''
                                    + Gemma.HelpText.WidgetDefaults.GeneDetails.multifuncTT + '\'); return false">' + '<img src="/Gemma/images/help.png" /> </a>',
                                 ...
                                 fieldLabel : 'Hub score' + '&nbsp;<a class="helpLink" href="javascript: void(0)" onclick="showHelpTip(event, ' + '\''
                                    + Gemma.HelpText.WidgetDefaults.GeneDetails.nodeDegreeTT + '\'); return false">' + '<img src="/Gemma/images/help.png" /> </a>',
                                 ...
                                 fieldLabel : 'Phenotypes' + '&nbsp;<a class="helpLink" href="javascript: void(0)" onclick="showHelpTip(event, ' + '\''
                                    + Gemma.HelpText.WidgetDefaults.GeneDetails.phenotypeTT + '\'); return false">' + '<img src="/Gemma/images/help.png" /> </a>',
                                 ...
                                 fieldLabel : 'On platforms' + '&nbsp;<a class="helpLink" href="javascript: void(0)" onclick="showHelpTip(event, ' + '\''
                                    + Gemma.HelpText.WidgetDefaults.GeneDetails.probesTT + '\'); return false">' + '<img src="/Gemma/images/help.png" /> </a>',

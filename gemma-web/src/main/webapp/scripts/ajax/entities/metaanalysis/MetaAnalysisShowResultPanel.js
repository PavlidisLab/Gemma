                              ...
                              callParams.push({
                                    callback : function(taskId) {
                                       ...
                                       task.on('task-failed', function(data) {
                                             Ext.Msg.alert(Gemma.HelpText.WidgetDefaults.MetaAnalysisShowResultPanel.ErrorTitle.resultSetsNotSaved, data);
                                          }.createDelegate(this));
                                    }.createDelegate(this),
                  ...
                  callParams.push({
                        callback : function(taskId) {
                           ...
                           task.on('task-failed', function() {
                                 // Argument data is not used because data is Java exception class name which is not
                                 // useful to the user.

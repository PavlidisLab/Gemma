                  ...
                  PhenotypeController.makeDifferentialExpressionEvidencesFromDiffExpressionMetaAnalysis(this.metaAnalysisId, selectedPhenotypes, thresholdTextField.getValue(),
                     function(validateEvidenceValueObject) {
                        ...
                        if (validateEvidenceValueObject == null) {
                           ...
                           Ext.Msg.alert(Gemma.HelpText.WidgetDefaults.MetaAnalysisManagerGridPanel.ErrorTitle.saveMetaAnalysisAsEvidence, Gemma
                  ...
                  if (button === 'yes') {
                     ...
                     PhenotypeController.removeAllEvidenceFromMetaAnalysis(this.metaAnalysisId, function(validateEvidenceValueObject) {
                           ...
                           if (validateEvidenceValueObject == null) {
                              ...
                              Ext.Msg.alert(Gemma.HelpText.WidgetDefaults.MetaAnalysisEvidenceWindow.ErrorTitle.removeEvidence, Gemma
                                    .convertToEvidenceError(validateEvidenceValueObject).errorMessage, function() {
                                    if (validateEvidenceValueObject.userNotLoggedIn) {
                                       Gemma.AjaxLogin.showLoginWindowFn();
                                    }
                           ...
                           keyup : function(numberField, event) {
                              ...
                              if (currentThreshold != null && threshold != currentThreshold) {
                                 if (threshold > numberField.minValue && threshold <= numberField.maxValue) {
                                    ...
                                    thresholdErrorMessage = String.format(Gemma.HelpText.WidgetDefaults.MetaAnalysisEvidenceWindow.ErrorMessage.qvalueThresholdOutOfRange,

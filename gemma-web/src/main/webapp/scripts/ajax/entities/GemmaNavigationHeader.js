      ...
      .extend(
            Ext.Toolbar,
            {
               ...
               initComponent : function() {
                  ...
                  this.inMenuSearchField = new Ext.form.TextField({ flex : 1, enableKeyEvents : true,
                     emptyText : 'Search', minLength : 2, listeners : { specialkey : function(formField, e) {
                  ...
                  var menuDefaults = { cls : 'x-menu-item-large' };
                  var searchBtn = new Ext.Button({
                     ...
                     menu : new Ext.menu.Menu({
                        ...
                        items : [
                              ...
                              // style:'width:100%',
                              items : [ this.inMenuSearchField, { xtype : 'button', text : 'Go', handler : function() {
                                 this.doSearchQuery();
                              }, scope : this, flex : 0 } ] },
                              /*
                               * { text : 'Search Analyses', href : "/Gemma/analysesResultsSearch.html", tooltip :
                               * "Search for differential and coexpression patterns" }, '-',
                               */
                              ...
                              { text : 'Browse Phenotype Associations', href : "/Gemma/phenotypes.html",
                                 tooltip : "View the list of Gemma's phenotype-gene associations" },
                              { text : 'Browse Platforms', href : "/Gemma/arrays/showAllArrayDesigns.html",
                                 tooltip : "View the list of Gemma's platforms" },
                              { text : 'Search Annotated Papers', href : "/Gemma/bibRef/searchBibRefs.html",
                           ...
                           menu : new Ext.menu.Menu(
                                 {
                                    ...
                                    items : [// these items will render as dropdown menu items when the arrow is
                                          // clicked:
                                          { text : 'Load Data', href : "/Gemma/expressionExperiment/upload.html",
                                          ...
                                          '-',
                                          { text : 'User Groups', href : "/Gemma/manageGroups.html",
                                             tooltip : "Manage your user groups" },
                                          { text : 'Gene Groups', href : "/Gemma/geneGroupManager.html",
                                          ...
                                          '-',
                                          { text : 'Edit Profile', href : "/Gemma/userProfile.html",
                                             tooltip : "Edit your profile" } ], listeners : { mouseover : function() {
                           ...
                           menu : new Ext.menu.Menu(
                                 {
                                    ...
                                    style : 'background:white',
                                    items : [
                                          { text : 'About Gemma', handler : function(b, e) {
                                             this.showAbout();
                                          }, scope : this },
                                          {
                                             text : 'Help and Documentation&nbsp;<img src="/Gemma/images/icons/link_external_icon.gif"/>',
                                             href : "http://gemma-chibi-doc.sites.olt.ubc.ca/",
                                             tooltip : "Gemma overview and general help", hrefTarget : "_blank" },
                                          { text : 'Dataset citations', href : "/Gemma/bibRef/showAllEeBibRefs.html" },
                                          { text : 'QC updates', href : "/Gemma/expressionExperimentsWithQC.html" } ],
                                    listeners : { mouseover : function() {
                  ...
                  var helpBtn = new Ext.Button({
                     ...
                     menu : new Ext.menu.Menu({
                        ...
                        style : 'background:white',
                        items : [
                              { text : 'Wiki', href : "http://www.chibi.ubc.ca/faculty/pavlidis/wiki/display/gemma",
                                 tooltip : "Gemma wiki" },
                              { text : 'For Developers', href : "http://www.chibi.ubc.ca/Gemma/resources/",
                                 tooltip : "About the Gemma framework" },
                              { text : 'Contact Us', href : "/Gemma/contactUs.html", tooltip : "Contact Us" } ],
                        listeners : { mouseover : function() {
                           hideTaskHelp.cancel();
                        }, mouseout : function() {
                     ...
                     menu : new Ext.menu.Menu(
                           {
                              ...
                              items : [// these items will render as dropdown menu items when the arrow is clicked:
                                    { text : 'Add Data', href : "/Gemma/admin/loadExpressionExperiment.html",
                                       tooltip : "Import from GEO or ArrayExpress" },
                                    { text : 'Browse GEO', href : "/Gemma/admin/geoRecordBrowser.html",
                                       tooltip : "Browse data sets in GEO" },
                                    { text : 'Search Annotations', href : "/Gemma/characteristicBrowser.html",
                                       tooltip : "Search annotations" },
                                    '-',
                                    { text : 'Manage Users', href : "/Gemma/admin/userManager.html",
                                       tooltip : "Manage users" },
                                    { text : 'View Active Sessions', href : "/Gemma/admin/activeUsers.html",
                                       tooltip : "View active users" },
                                    { text : 'System Monitoring', href : "/Gemma/admin/systemStats.html" },
                                    { text : 'Manage Search Indexes', href : "/Gemma/admin/indexer.html" },
                                    { text : 'Manage Maintenance Mode', href : "/Gemma/admin/maintenanceMode.html" },
                                    { text : 'Update "What\'s New"', href : "/Gemma/whatsnew/generateCache.html" },
                                    { text : 'Widget Test Page', href : "/Gemma/admin/widgetTest.html" } ],
                              listeners : { mouseover : function() {
                  ...
                  var userBtn = new Ext.Button({
                     ...
                     menu : new Ext.menu.Menu({
                        ...
                        style : 'background:white',
                        items : [
                              { text : 'Edit your profile', href : "/Gemma/userProfile.html",
                                 tooltip : "Change your password" },
                              { text : 'Log out', handler : Gemma.AjaxLogin.logoutFn, tooltip : "Log out of Gemma" } ],
                        listeners : { mouseover : function() {
                           hideTaskUser.cancel();
                        }, mouseout : function() {
                  ...
                  this.loginBtn = new Ext.Button({ xtype : 'button', text : 'Log In', cls : 'mediumText',
                     hidden : userLoggedIn, handler : function() {
                  ...
                  /*
                   * this.userText = new Ext.Panel({ tpl:'Welcome <a href="/Gemma/userProfile.html">{userName}</a>',
                   * hidden: !userLoggedIn, data: {userName: loggedInAs}, border:false, style:'font-size:11px' });
                   */

                  /*
                   * these statements (along with mouseover and mouseout listeners) make each button's menu pop-up when
                   * the button is hovered over (instead of just when it's clicked)
                   * 
                   * from post #2 in:
                  ...
                  this
                        .add([
                              ...
                              {
                                 xtype : 'box',
                                 autoEl : { tag : 'img', src : '/Gemma/images/logo/phenocarta-45p.png',
                                    style : 'padding-left:10px', title : 'Previously known as Neurocarta',
                                    alt : 'Phenocarta' },
                              ...
                              '->',
                              {
                                 ...
                                 items : [
                                       ...
                                       { xtype : 'tbspacer', width : 15 },
                                       myGemmaBtn,
                                       { ref : 'myGemmaSpacer', xtype : 'tbspacer', width : 15, hidden : !userLoggedIn },
                                       adminBtn, ' ',
                                       { ref : 'adminSpacer', xtype : 'tbspacer', width : 15, hidden : !isAdmin }, '-',
                                       { xtype : 'tbspacer', width : 15 }, this.loginBtn, userBtn ]

                              },
                              {
                                 xtype : 'box',
                                 autoEl : { tag : 'a', href : 'http://www.ubc.ca/',

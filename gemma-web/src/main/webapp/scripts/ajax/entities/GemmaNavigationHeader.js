...
Gemma.GemmaNavigationHeader = Ext.extend(Ext.Toolbar, {
        ...
        var w = new Ext.Window({
            ...
            items : [{
                ...
                html : '<div style="margin:10px;padding:5px;"><p>Gemma is a web site, database and a set of tools for the meta-analysis, re-use and '
                        ...
                        + ' expression results</p><p>Gemma was developed by the Pavlidis group at UBC. '
                        + 'For more information see <a href="http://gemma-chibi-doc.sites.olt.ubc.ca/credits/" target="_blank">the credits page&nbsp;<img src="/Gemma/images/icons/link_external_icon.gif"/></a>'
                        + '</p></div>.'
            }],
            buttons : [{
    ...
    initComponent : function() {
        ...
        /*
         * this.logoutBtn = new Ext.Button({ xtype: 'button', text: 'Log out', cls:'smallText', hidden: !userLoggedIn,
         * handler: Gemma.AjaxLogin.logoutFn });
         */
        ...
        /*
         * these statements (along with mouseover and mouseout listeners) make each button's menu pop-up when the button
         * is hovered over (instead of just when it's clicked)
         * 
         * from post #2 in:

...
Gemma.TaxonCombo = Ext.extend(Gemma.StatefulRemoteCombo, {
      ...
      /*
       * this controls whether or not the entry 'All taxa' is added at the top of the list; this option must be handled
       * in the function that responds to the combo box's selection event for example, adding

/**
 * This panel contains one or more instances of a panel containing ExperimentTagCategoryComboBox and
      ...
      initComponent : function() {
            ...
            var experimentTagCategoryComboBox = new Gemma.PhenotypeAssociationForm.ExperimentTagCategoryComboBox({
                  listeners : {
                     blur : function(combo) {
                        ...
                        experimentTagValueComboBox.currentCategoryUri = (currentCategoryUri == '') ? null : currentCategoryUri;
                     },
                     scope : this
                  }
               });
            var experimentTagValueComboBox = new Gemma.PhenotypeAssociationForm.ExperimentTagValueComboBox({
                  currentCategoryUri : experimentTagSelection == null ? null : experimentTagSelection.categoryUri,
         ...
         var visiblityHandler = function(isVisible) {
            ...
            for (var i = 0; i < rowsPanel.items.length; i++) {
               ...
               // Make sure that if this panel is not visible, all fields' allowBlank properties are true and vice
               // versa.
         ...
         Ext.apply(this, {
               ...
               checkDuplicate : function() {
                  ...
                  for (var i = 0; i < rowsPanel.items.length; i++) {
                     ...
                     var currCategory = currCategoryRecord == null ? null : currCategoryRecord.category;

                     // Use getRawValue() instead of getValue() because getRawValue() returns whatever text typed by
                     // users.
                     ...
                     for (var j = i + 1; currCategory != null && currValue !== '' && j < rowsPanel.items.length; j++) {
                        ...
                        var currTestCategory = currTestCategoryRecord == null ? null : currTestCategoryRecord.category;
               ...
               isValid : function() {
                  for (var i = 0; i < rowsPanel.items.length; i++) {
                     ...
                     if (currRowPanel.getCategoryComboBox().getValue() === '' || currRowPanel.getValueComboBox().getRawValue() === '') {
                        return false;
                     }
                  }
                  return true;
               ...
               items : [rowsPanel, {
                     ...
                     layout : 'form',
                     hideLabel : true,
                     items : [addExperimentTagRowButton, {
                           xtype : 'displayfield',

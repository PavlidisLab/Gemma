...
Gemma.BibliographicReference.DetailsPanel = Ext.extend(Ext.Panel, {
      ...
      initComponent : function() {
         ...
         var getGenePhenotypeRow = function(bibliographicPhenotype) {
            ...
            genePhenotypeRow += '<a target="_blank" href="' + Gemma.LinkRoots.genePageNCBI + bibliographicPhenotype.geneNCBI + '">' + bibliographicPhenotype.geneName + '</a> '
            ...
            if (bibliographicPhenotype.evidenceId == currentEvidenceId) {
               genePhenotypeRow += '</b>' + ' <img height="12" src="/Gemma/images/icons/asterisk_black.png" ext:qtip="This is the annotation you are editing." /> ';
            }
         ...
         Ext.apply(this, {
               ...
               updateFields : function(bibRefRecord, evidenceId) {
                  ...
                  if (bibRefRecord.get('citation')) {
                     this.citation.setValue(bibRefRecord.get('citation').citation + ' ' + getPudmedAnchor(bibRefRecord.get('citation').pubmedURL));
                  }
                  ...
                  for (i = 0; i < bibRefRecord.get('experiments').length; i++) {
                     ...
                     allExperiments += '<a href="' + Gemma.LinkRoots.expressionExperimentPage + ee.id + '" target="_blank" >' + ee.shortName + '</a>' + " : ";

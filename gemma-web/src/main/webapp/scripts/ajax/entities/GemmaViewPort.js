...
/**
 * main panel should be set as config value: centerPanelConfig
 * ex: 	new Gemma.GemmaViewPort({
...
Gemma.GemmaViewPort = Ext.extend(Ext.Viewport,{
	layout: 'border',
	defaultCenter: {xtype:'panel',html:'must be set in config'},

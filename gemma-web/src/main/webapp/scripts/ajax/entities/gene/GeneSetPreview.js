...
Gemma.GeneSetPreview = Ext.extend(Gemma.SetPreview, {
   ...
   initComponent : function() {
      ...
      var withinSetGeneCombo = new Gemma.GeneAndGeneGroupCombo({ width : 300, style : 'margin:10px',
         hideTrigger : true, taxonId : this.taxonId, emptyText : 'Add genes to your group' });
      ...
      Ext.apply(this, {
         selectionEditor : new Gemma.GeneMembersSaveGrid({ name : 'geneSelectionEditor', hideHeaders : true,

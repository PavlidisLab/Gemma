 ...
 */
Gemma.GeneAndGeneGroupCombo = Ext
   .extend(
      Ext.form.ComboBox,
      {
         ...
         initComponent : function() {
            ...
            this.on('focus', function(field) {
               ...
               if ( this.getValue() === '' ) {
                  ...
                  /*
                   * GenePickerController.searchGenesAndGeneGroups("", this.getTaxonId(), function(records) {
                   * this.getStore().loadData(records); }.createDelegate(this) );
                   */
                  /*
                   * only allowing taxon searches for now else{ GenePickerController.searchGenesAndGeneGroups("", null,

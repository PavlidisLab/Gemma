...
Gemma.GeneGroupPanel = Ext.extend(Ext.grid.EditorGridPanel, {
      ...
      columns : [{
            ...
            renderer : function(value, metadata, record, rowIndex, colIndex, store) {
               return '<a target="_blank" title="Go to gene group page" ' + 'href="/Gemma/geneSet/showGeneSet.html?id=' + record.data.id
            ...
            width : 0.1,
            renderer : function(value, metadata, record, rowIndex, colIndex, store) {
               var result = Gemma.SecurityManager.getSecurityLink("ubic.gemma.model.genome.gene.GeneSetImpl", record.get('id'), record.get('isPublic'), record.get('isShared'),
                  record.get('userCanWrite'), null, null, null, record.get('usedOwned'));
               return result;
            },

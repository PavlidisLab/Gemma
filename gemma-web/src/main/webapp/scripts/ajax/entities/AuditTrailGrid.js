...
Gemma.AuditTrailGrid = Ext.extend(Ext.grid.GridPanel, {
      ...
      initComponent : function() {
         ...
         this.on('rowdblclick', function(grid, row, event) {
               ...
               var content = "Date: " + record.date + "<br />Performer: " + record.performer + "<br />Note: " + note + "<br />Details: " + detail;
...
Gemma.AddAuditEventDialog = Ext.extend(Ext.Window, {
      ...
      validate : function() {
         return this.auditEventTypeCombo.isValid() && this.auditEventCommentField.isValid() && this.auditEventDetailField.isValid();
      },
      ...
      initComponent : function() {
         ...
         this.auditEventTypeStore = new Ext.data.SimpleStore({
               ...
               data : [['CommentedEvent', 'Comment'], ['TroubleStatusFlagEvent', 'Other (generic) Trouble'], ['ExperimentalDesignTrouble', 'Experimental Design Trouble'],
                  ['OutlierSampleTrouble', 'Outlier sample'], ['OKStatusFlagEvent', 'OK flag (clear Trouble)'], ['ValidatedFlagEvent', 'Validated flag'],
                  ['ValidatedQualityControl', 'QC validated'], ['ValidatedAnnotations', 'Tags validated'], ['ValidatedExperimentalDesign', 'Experimental design validated']]
            });

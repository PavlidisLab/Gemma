...
Gemma.AuditTrailGrid = Ext.extend(Ext.grid.GridPanel, {
	...
	initComponent : function() {
		...
		this.on('rowdblclick', function(grid, row, event) {
			...
			var content = "Date: " + record.date + "<br />Performer: "
					+ record.performer + "<br />Note: " + note
					+ "<br />Details: " + detail;
				...
				Ext.Window,
				{
					...
					initComponent : function() {
						...
						this.auditEventTypeStore = new Ext.data.SimpleStore(
								{
									...
									data : [
											...
											[ 'TroubleStatusFlagEvent',
													'Trouble flag' ],
											[ 'OKStatusFlagEvent',
													'OK flag (clear Trouble flag)' ],
											[ 'ValidatedFlagEvent',
													'Validated flag' ] ]
								});
						...
						this.fs = new Ext.form.FieldSet( {
							items : [ this.auditEventTypeCombo,
									this.auditEventCommentField,
															...
															if (this.validate()) {
																...
																this
																		.fireEvent(
																				'commit',
																				{
																					comment : this.auditEventCommentField
																							.getValue(),
																					type : this.auditEventTypeCombo
																							.getValue(),
																					details : this.auditEventDetailField
																							.getValue()
																				});
															} else {
																Ext.Msg
						...
						Gemma.AddAuditEventDialog.superclass.initComponent
								.call(this);

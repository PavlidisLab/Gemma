...
Gemma.DatasetGroupEditor = Ext.extend(Ext.Panel, {
      ...
      name : 'datasetchooser',
      layout : 'border',
      title : "Dataset Group Editor <a href=\"javascript:void()\" style=\"float:right\" title=\"" + Gemma.HelpText.WidgetDefaults.DatasetGroupEditor.widgetTT + "\" "
      ...
      initComponent : function() {
         ...
         this.sourceDatasetsGrid.getStore().on('load', function(idsFound) {
               ...
               this.sourceDatasetsGrid.setTitle(this.sourceDatasetsGrid.title + ", " + this.sourceDatasetsGrid.getStore().getCount() + " addable");

...
Gemma.ExpressionExperimentSetSummary = Ext.extend(Ext.Panel, {
      ...
      renderStatus : function(e) {
         var statusString = "";
         if (!e.modifiable) {
            statusString += "<img src='/Gemma/images/icons/shield.png' height='16' width='16' " + "title='" + Gemma.HelpText.WidgetDefaults.DatasetGroupGridPanel.protectedTT
               + "' />&nbsp;";
         }
         var sl = Gemma.SecurityManager.getSecurityLink("ubic.gemma.model.analysis.expression.ExpressionExperimentSetImpl", e.id, e.isPublic, e.isShared, e.userCanWrite, null,
            null, null, e.userOwned);

...
Gemma.ExperimentSetPreview = Ext.extend(Gemma.SetPreview, {
       ...
       * public update the contents of the experiment preview box
       * 
       * @param {ExperimentValueObject[]}
       *           ees an array of ees to use to populate preview
       */
      ...
      updateTitle : function(name, size) {
         ...
         if (!name && this.selectedSetValueObject instanceof ExpressionExperimentSetValueObject) {
            ...
            if (!(this.selectedSetValueObject instanceof SessionBoundExpressionExperimentSetValueObject)) {
               ...
               name = '<a target="_blank" href="/Gemma/expressionExperimentSet/showExpressionExperimentSet.html?id=' + this.selectedSetValueObject.id + '">'
         ...
         this.previewContent.setTitle('<span style="font-size:1.2em">' + name + '</span> &nbsp;&nbsp;<span style="font-weight:normal">(' + this.totalCount

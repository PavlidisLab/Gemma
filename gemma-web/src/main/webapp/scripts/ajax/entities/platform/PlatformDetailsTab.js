   ...
   .extend(
      Ext.Panel,
      {
         ...
         renderReport : function( platformDetails ) {
            ...
            text = {
               tag : "ul",
               style : 'padding:4px;background:#DDDDDD;width:500px',
               children : [
                           {
                              tag : 'li',
                              html : 'Elements: ' + platformDetails.designElementCount,
                              style : platformDetails.dateCached === null ? 'hidden' : ''
                           },
                           {
                              tag : 'li',
                              html : 'With sequence: '
                              ...
                              style : platformDetails.numProbeSequences === null
                                 || platformDetails.technologyType == "NONE" ? 'hidden' : ''
                           },
                           {
                              tag : 'li',
                           ...
                           },
                           {
                              ...
                              style : platformDetails.numProbesToGenes === null ? 'hidden' : ''
                           },
                           {
                              tag : 'li',
                              html : 'Unique genes: '
                              ...
                              style : platformDetails.numGenes === null ? 'hidden' : ''
                           },
                           {
                              tag : 'li',
                              html : platformDetails.dateCached != null ? 'As of: ' + platformDetails.dateCached
                                 + "&nbsp;" + updateT : 'No report available'
                           } ]
            };

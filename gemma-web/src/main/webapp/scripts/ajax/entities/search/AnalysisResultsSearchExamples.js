...
/**
 * When the example queries are ready to run, 'examplesReady' event is fired with three param: taxonId, geneExampleRecord, experimentExampleRecord
 *  
 * @author thea
 * @version $Id: AnalysisResultsSearchExamples.js,v 1.0 2012/01/17 04:02:25 thea
 *          Exp $
 */
Gemma.AnalysisResultsSearchExamples = Ext.extend(Ext.Panel, {
	 ...
	 */
	getExperimentSet: function(setId){
		...
		ExpressionExperimentSetController.load(setId, function(eeSet){
			...
			myscope.fireEvent('eeExampleReady', record);
		});

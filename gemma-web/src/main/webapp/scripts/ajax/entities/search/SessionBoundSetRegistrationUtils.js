/**
 * Created with IntelliJ IDEA. User: anton Date: 20/03/13 Time: 4:39 PM To change this template use File | Settings |
 * File Templates.
 */
Ext.namespace('Gemma');
...
Gemma.SessionSetsUtils = {
   ...
   registerExperimentSetsIfNotRegistered : function(experimentSets) {
      ...
      if (experimentGroupsToRegister.length > 0) {
         ...
         ExpressionExperimentSetController.addSessionGroups(experimentGroupsToRegister, false, function(registeresDatasetSets) {

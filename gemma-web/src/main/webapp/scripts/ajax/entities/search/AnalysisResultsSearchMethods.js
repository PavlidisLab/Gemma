...
Ext.onReady(function() {
   Gemma.MAX_GENES_PER_CO_EX_VIZ_QUERY = Ext.get("coexpressionSearch.maxGenesPerQuery") ? Ext.get(
         "coexpressionSearch.maxGenesPerQuery").getValue() : 20;
});

// max suggested number of elements to use for a diff ex viz query
// FIXME get this from the enviornment. - add to userStatusVariables.jsp.
      ...
      .extend(
            Ext.util.Observable,
            {
               ...
               searchDifferentialExpression : function(geneSetValueObjects, experimentSetValueObjects) {
                  ...
                  /**
                   * Verify that experiments and genes are not empty. If there are too many experiments or genes, warn
                   * the user and offer to trim the sets.
                   */
                  ...
                  if ( geneCount > Gemma.MAX_GENES_PER_DIFF_EX_VIZ_QUERY
                     ...
                     Gemma.AnalysesSearchUtils.showTrimInputDialogWindow(Gemma.MAX_GENES_PER_DIFF_EX_VIZ_QUERY,
                           geneCount, geneSetValueObjects, Gemma.MAX_EXPERIMENTS_PER_DIFF_EX_VIZ_QUERY,
                           experimentCount, experimentSetValueObjects, this);
                  } else {
                     // skip trimming
               ...
               getCoexpressionSearchCommand : function(geneSetValueObjects, experimentSetValueObjects) {
                  ...
                  var coexpressionSearchCommand = { geneIds : geneIds, eeIds : eeIds,
                     stringency : this.DEFAULT_STRINGENCY, forceProbeLevelSearch : this.DEFAULT_forceProbeLevelSearch,
                     useMyDatasets : this.DEFAULT_useMyDatasets, queryGenesOnly : this.DEFAULT_queryGenesOnly,
                     taxonId : this.taxonId, eeSetName : null, eeSetId : null };
               ...
               getDataForDiffVisualization : function(geneSetValueObjects, experimentSetValueObjects) {
                  ...
                  var data = { experimentSetValueObjects : experimentSetValueObjects,
                     geneSetValueObjects : geneSetValueObjects, geneNames : geneNames, datasetNames : experimentNames,
                     taxonId : this.taxonId, taxonName : this.taxonName, pvalue : 0.01, datasetCount : experimentCount };
                  return data;
               },

...
var saveHandler = function(){
	...
	OntologyService.saveBioMaterialStatement(newVocabC, [bmId], refreshAnnotations);
	
}

var deleteHandler = function(){
		
	OntologyService.removeBioMaterialStatement(characteristicIdList, [bmId], refreshAnnotations)		

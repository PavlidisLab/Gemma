      ...
      initComponent : function() {
         ...
         if (this.deleteHandler) {
            this.deleteButton = new Ext.Toolbar.Button({
                  ...
                  handler : function() {
                     ...
                     this.annotationGrid.loadMask.show();
                     this.deleteHandler(this.annotationGrid.getSelectedIds(), this.annotationGrid.refresh.createDelegate(this.annotationGrid));
                  },
                  scope : this
               });
         ...
         if (this.saveHandler) {
            this.saveButton = new Ext.Toolbar.Button({
                  ...
                  handler : function() {
                     this.annotationGrid.loadMask.show();
                     this.saveHandler(this.annotationGrid.getEditedCharacteristics(), this.annotationGrid.refresh.createDelegate(this.annotationGrid));

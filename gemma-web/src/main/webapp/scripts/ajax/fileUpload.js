...
Ext.extend(FileUpload, Ext.util.Observable, {
	 ...
	 * 
	 * this.aform = new Ext.form.Form({ fileUpload: true, method: 'POST', name:
	 * 'upload-form', id: 'upload-form' , url: '/Gemma/uploadFile.html' });
	 * 
	 * this.aform.add(new Ext.form.TextField({msgTarget: 'side',
	 * allowBlank:false, id: 'file', inputType: 'file', name: 'file',
	 * fieldLabel: 'File', blankText: 'You must choose a file' }));
	...
	startUpload : function(divid) {
		// var successHandler = this.handleSuccess.createDelegate(this, [],
		// true);

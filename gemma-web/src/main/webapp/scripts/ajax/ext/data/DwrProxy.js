 ...
 * 
 * @param {Object}
 *            dwrCall The method that will be called
 * @param {Object}
 *            config consisting of: - {boolean} pagingAndSort - {Array}
 *            baseParams, which are sent in dwr method calls as the first
 *            parameters.
 */
Ext.data.DWRProxy = function(dwrCall, config) {
	...
	if (config !== undefined) {
		this.pagingAndSort = (config.pagingAndSort !== undefined
				? config.pagingAndSort
				: false);
...
Ext.extend(Ext.data.DWRProxy, Ext.data.DataProxy, {
	 ...
	 *            Array of parameters
	 * @param reader
	 *            Reader implmentation that will be used to create the callback
	 *            for DWR
	 * @param callback
	 *            optional
	 * @param scope
	 *            optional
	 * @param arg
	 *            array of arguments that will be passed to read method of the
	 *            Reader.
	 */
	load : function(params, reader, callback, scope, arg) {
		...
		if (this.fireEvent("beforeload", this, params) !== false) {
			var delegate = this.loadResponse.createDelegate(this, [reader,
					callback, scope, arg], true);
			var errorHandler = this.handleFailure
					.createDelegate(this, [], true);
			var callParams = [];

			if (params instanceof Array) {
				callParams = params;
			} else if (params && params.push === undefined
					&& this.pagingAndSort) {

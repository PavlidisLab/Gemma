...
/*
 * This method is used for client-side validation in the commons-validation
 * framework. The original version used an 'alert'. We changed this to update
 * style of the invalid field. FIXME replace with Ext form validation.
 */
function validateRequired(form) {
	...
	for (x in oRequired) {
		...
		if ((form[oRequired[x][0]].type == 'select-multiple'
				| form[oRequired[x][0]].type == 'file'

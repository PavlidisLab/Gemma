...
MiniPieLib.drawFilledRectangle = function (ctx, x, y, width, height, color) {
	ctx.save();
	ctx.fillStyle = color;
...
CanvasTextFunctions.drawRotatedText = function (ctx, x, y, ang, fontSize, fontColor, text)
{
    ...
    CanvasTextFunctions.draw (ctx,'',fontSize,0,0,text);
    ctx.restore();	
}
...
CanvasTextFunctions.enable = function( ctx)
{
    ...
    ctx.drawRotatedText = function(x, y, ang, fontSize, fontColor, text) { return CanvasTextFunctions.drawRotatedText( ctx, x, y, ang, fontSize, fontColor, text);};

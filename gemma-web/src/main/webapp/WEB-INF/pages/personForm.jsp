...
<title><fmt:message key="personDetail.title" />
</title>
<content tag="heading">
<h1>
...
<form method="post" action="">
	<table class="detail">
		<tr>
            ...
            --%>
					<input type="text" name="firstName" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}"/>" />
		...
		<tr>
			...
			<td>
                ...
                <span class="fieldError"><c:out value="${status.errorMessage}"/></span>
            --%>
					<input type="text" name="middleName" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}"/>" />
					<span class="fieldError"><c:out value="${status.errorMessage}" />
					</span>
				</spring:bind>
			</td>
		...
		<tr>
			...
			<td>
                ...
                <span class="fieldError"><c:out value="${status.errorMessage}"/></span>
            --%>
					<input type="text" name="lastName" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}"/>" />
					<span class="fieldError"><c:out value="${status.errorMessage}" />
					</span>
				</spring:bind>
			</td>

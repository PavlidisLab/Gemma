...
<%@ page import="ubic.gemma.web.controller.common.auditAndSecurity.FileUpload"%>
<%@ page session="false"%>
...
<table class="detail" cellpadding="5">
    ...
    <tr>
        ...
        <td class="buttonBar">
            ...
            <input type="button" name="upload" id="Upload" value="Upload Another"
                onclick="location.href='<c:url value="/selectFile.html"/>'" />
        </td>
    </tr>
</table>

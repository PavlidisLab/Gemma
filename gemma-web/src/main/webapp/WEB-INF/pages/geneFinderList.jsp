...
<html>
    ...
    <body>
	    ...
	    <display:table name="compassGenes" class="list" 
	    	requestURI="" 
	    	id="compassGenesList"
            decorator="ubic.gemma.web.taglib.displaytag.gene.GeneHitWrapper" 
            pagesize="20">	
			<display:column property="nameLink" sortable="true" titleKey="gene.officialSymbol" maxWords="20" />
			<display:column property="taxon" sortable="true" titleKey="taxon.title" maxWords="20" />
			<display:column property="officialName" sortable="true" titleKey="gene.officialName" maxWords="20" />						
			<display:column property="score" sortable="true" title="score" maxWords="20" />	
			<display:column property="resource" sortable="true" title="resource" maxWords="50" />			
			<display:column property="highlightedText" sortable="true" title="Hight Lighted Text" maxWords="20" />			

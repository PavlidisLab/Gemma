...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	<title>XML Grid Example</title>
   				...
   				<script src="<c:url value='/scripts/ext/adapter/yui/yui-utilities.js" type="text/javascript'/>"></script>
				<script src="<c:url value='/scripts/ext/adapter/yui/ext-yui-adapter.js" type="text/javascript'/>"></script>

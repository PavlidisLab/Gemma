...
<input type="hidden" name="expressionExperimentID"
	value="${expressionExperiment.id}" />
<input type="hidden" name="experimentalDesignID"
...
<div style="padding: 2px;"
	onclick="Effect.toggle('edDetail', 'blind', {duration:0.1})">
	<h2>
...
<div id="edDetail" style="display: none">
	<div>
		...
		<table cellspacing="10">
			...
			<tr>
				<td class="label">
					<b> <fmt:message key="experimentalDesign.replicateDescription" />
					</b>
				</td>
				<td>
					<%
					...
					%>
					<jsp:getProperty name="experimentalDesign"
						property="replicateDescription" />
					<%
					    } else {
			...
			<tr>
				<td class="label">
					<b> <fmt:message
							key="experimentalDesign.qualityControlDescription" /> </b>
				</td>
				<td>
					<%
					...
					%>
					<jsp:getProperty name="experimentalDesign"
						property="qualityControlDescription" />
					<%
					    } else {
			...
			<tr>
				<td class="label">
					<b> <fmt:message
							key="experimentalDesign.normalizationDescription" /> </b>
				</td>
				<td>
					<%
					...
					%>
					<jsp:getProperty name="experimentalDesign"
						property="normalizationDescription" />
					<%
					    } else {
...
<div style="padding: 2px;"
	onclick="Effect.toggle('eeDetail', 'blind', {duration:0.1})">
	<h2>
		<img src="/Gemma/images/plus.gif" />
			...
			<tr>
				...
				<td>
					...
					<div class="clob" style="width: 40%;">
						<jsp:getProperty name="expressionExperiment"

...
<form method="post" name="searchForm" action="<c:url value="/bibRefSearch.html"/>">
	<table>
		<tr>
			<td>
...
<p>
	<a href="<c:url value="/bibRef/showAllEeBibRefs.html" />">View all bibliographic references in Gemma</a>
</p>

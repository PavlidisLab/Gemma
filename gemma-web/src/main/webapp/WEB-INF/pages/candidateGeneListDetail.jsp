...
<%@ page import="ubic.gemma.model.genome.gene.CandidateGene"%>
		...
		<form name="dForm" id="dForm" method="POST"
			action="candidateGeneListDetail.htm">
			<input type="hidden" name="action" id="action" value="update">
			<input type="hidden" name="listID" id="listID"
				value="<%=request.getParameter( "listID" )%>">
			<%
			...
			<table width="100%" bgcolor="#eeeeee" cellpadding="1" cellspacing="2">
				<tr>
					<td colspan="2" nowrap="true" bgcolor="#eeeeee">
						<B>Candidate Gene List Details</B>
					</td>
				</tr>
				<tr>
					<td bgcolor="white">
					...
					<td bgcolor="white">
						<input type="text" size="100" name="listName" id="listName"
							value="<%=cgList.getName()%>">
					</td>
				</tr>
				<tr>
					<td bgcolor="white">
					...
					<td bgcolor="white">
						<input type="text" size="100" name="listDescription"
							id="listDescription" value="<%=desc%>">
					</td>
				</tr>
				<tr>
					<td valign="center" align="center" colspan="2" bgcolor="white">
				...
				<tr>
					<td width="10" bgcolor="white">
						...
						<form method="POST" action="candidateGeneListDetail.htm">
							...
							<input type="hidden" name="action" id="action"
								value="movecandidateuponcandidatelist">
						...
						<form method="POST" action="candidateGeneListDetail.htm">
							<input type="hidden" name="listID" id="listID"
								value="<%=request.getParameter( "listID" )%>">
							<input type="hidden" name="action" id="action"
								value="movecandidatedownoncandidatelist">
							<input type="hidden" name="geneID" id="geneID" value="<%=gID%>">
					...
					<form method="POST" action="candidateGeneListDetail.htm">
						<input type="hidden" name="listID" id="listID"
							value="<%=request.getParameter( "listID" )%>">
						<input type="hidden" name="action" id="action"
							value="updatecandidategene">
						<input type="hidden" name="geneID" id="geneID" value="<%=gID%>">
					<td width="350" bgcolor="white">
						<a href="geneDetail.htm?geneID=<%=g.getGene().getId()%>"><%=gSymbol%>
						</a>
						<BR>
						Notes:&nbsp;&nbsp;&nbsp;
						<input type="text" width="150" name="description" id="description"
							value="<%=desc%>">
					...
					<form method="POST" action="candidateGeneListDetail.htm">
						<input type="hidden" name="listID" id="listID"
							value="<%=request.getParameter( "listID" )%>">
						<input type="hidden" name="action" id="action"
							value="removegenefromcandidatelist">
						<input type="hidden" name="geneID" id="geneID" value="<%=gID%>">
			...
			<a href="geneFinder.htm?listID=<%=request.getParameter( "listID" )%>">Add
				New Candidate Gene to List</a>

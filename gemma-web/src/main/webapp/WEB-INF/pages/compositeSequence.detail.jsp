...
<head>
	<title><fmt:message key="compositeSequence.title" />   ${ compositeSequence.name}
	</title>
...
<body> 
				...
				<table >
					...
					<tr>
						<td valign="top">
							<b> Sequence name <a class="helpLink" href="#"
								onClick="return showHelpTip(event, 'Name of the sequence in our system.')"><img
										src="/Gemma/images/help.png" /> </a> </b>
						</td>
						<td>
									<c:choose><c:when test="${not empty compositeSequence.biologicalCharacteristic.name}">${ compositeSequence.biologicalCharacteristic.name}</c:when><c:otherwise>No name availaable</c:otherwise></c:choose>
					...
					<tr>
						...
						<c:choose><c:when test="${not empty compositeSequence.biologicalCharacteristic.description}">
					...
					<tr>
						<td valign="top">
							<b> Sequence accession <a class="helpLink" href="#"
								onClick="return showHelpTip(event, 'External accession for this sequence, if known')"><img src="/Gemma/images/help.png" /> </a> </b>
						</td>
					...
					<tr>
						...
						<td><c:choose><c:when test="${not empty compositeSequence.biologicalCharacteristic.sequence}">
						${fn:length(compositeSequence.biologicalCharacteristic.sequence)}
						</c:when><c:otherwise>No sequence available</c:otherwise>
						</c:choose></td>
					</tr>
				</table>

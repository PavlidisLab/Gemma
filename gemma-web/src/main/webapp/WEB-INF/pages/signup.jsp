...
<body id="signup">
    ...
    <form method="post" action="<c:url value="/signup.html"/>" name="signupForm" onsubmit="return validateUser(this)">
        <table class="detail">
            ...
            <tr>
                <th>
                    <Gemma:label key="user.firstName" />
                </th>
                <td>
            ...
            <tr>
                ...
                <td>
                    <spring:bind path="user.passwordHint">
                        <input type="text" name="passwordHint" value="<c:out value="${status.value}"/>"
                            id="passwordHint" size="50" />
                        <span class="fieldError">
                            <c:out value="${status.errorMessage}" />
                        </span>
                    </spring:bind>

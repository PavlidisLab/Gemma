...
<title><fmt:message
		key="expressionExperimentVisualization.title" />
</title>
...
<form method="post"
	...
	<table cellspacing="10">
		...
		<tr>
			...
			<td>
				<%
				    if ( diffExpressionSearchCommand.getGeneOfficialSymbol() != null ) {
				%>
				<jsp:getProperty name="diffExpressionSearchCommand"
					property="geneOfficialSymbol" />
				<%
				    } else {
	...
	<spring:bind path="diffExpressionCommand.geneId">

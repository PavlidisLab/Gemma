...
<c:set var="pageButtons">
	...
	<tr>
        <th>
            <Gemma:label key="expressionExperiment.source"/>
        </th>
        <td>
        		<c:out value="${expressionExperiment.source}"/>
    ...
    <tr>
        ...
        <td>
        		...
        		<input type="text" name="name" value="<c:out value="${expressionExperiment.name}"/>" id="name"/>
        </td>
    </tr>

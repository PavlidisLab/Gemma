...
<%
                ...
                %>
<spring:hasBindErrors name="expressionExperiment">
    ...
    <%
                ...
                if ( ee.getExperimentalDesigns().size() == 0 )
                    ...
                    for ( Iterator iter = ee.getExperimentalDesigns().iterator(); iter.hasNext(); ) {
                        ...
                        if ( normalization == null ) normalization = "Unknown";
                        if ( qualitycontrol == null ) qualitycontrol = "Unknown";
                        if ( replicates == null ) replicates = "Unknown";
...
String categoryName = "";
                        ...
                        if ( ed.getExperimentalFactors().size() == 0 )
                            ...
                            for ( Iterator iterFac = ed.getExperimentalFactors().iterator(); iterFac.hasNext(); ) {
                                ...
                                for ( Iterator iterFacValues = fac.getFactorValues().iterator(); iterFacValues
                                        .hasNext(); ) {
...
if ( ee.getBioAssays().size() == 0 ) {
                    ...
                    for ( Iterator iter = ee.getBioAssays().iterator(); iter.hasNext(); ) {
                        ...
                        if ( ba.getFactorValues().size() == 0 ) {
                            out.print( "No factor values<BR>" );
                        } else {
                            out.print( "Factor values:<BR>" );
                            for ( Iterator iterF = ba.getFactorValues().iterator(); iterF.hasNext(); ) {
                        ...
                        if ( ba.getArrayDesignsUsed().size() == 0 ) {
                            ...
                            for ( Iterator iterD = ba.getArrayDesignsUsed().iterator(); iterD.hasNext(); ) {
                                ...
                                if ( ad.getDescription() != null ) adDesc = ad.getDescription();
                                if ( ad.getName() != null ) adName = ad.getName();

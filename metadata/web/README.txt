A lot of configuration of the application is done using Xdoclet. The rest is accomplished with the files in this directory.
...
struts-resume. The file names are specified by XDoclet:

http://xdoclet.sourceforge.net/xdoclet/ant/xdoclet/modules/web/WebXmlSubTask.html
http://xdoclet.sourceforge.net/xdoclet/ant/xdoclet/modules/spring/SpringXmlSubTask.html
http://xdoclet.sourceforge.net/xdoclet/ant/xdoclet/modules/apache/struts/StrutsConfigXmlSubTask.html
http://xdoclet.sourceforge.net/xdoclet/ant/xdoclet/modules/spring/SpringValidationXmlSubTask.html

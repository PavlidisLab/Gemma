...
INSERT INTO acl_object_identity VALUES (1, 'edu.columbia.gemma.expression.arrayDesign.ArrayDesignImpl:1', null, 'net.sf.acegisecurity.acl.basic.SimpleAclEntry');
INSERT INTO acl_object_identity VALUES (2, 'edu.columbia.gemma.expression.arrayDesign.ArrayDesignImpl:2', null, 'net.sf.acegisecurity.acl.basic.SimpleAclEntry');

--- (id, acl object identity, recepient (principal username), mask)
---INSERT INTO acl_permission VALUES (null, 1, 'administrator', 1);
INSERT INTO acl_permission VALUES (null, 1, 'pavlab', 2);

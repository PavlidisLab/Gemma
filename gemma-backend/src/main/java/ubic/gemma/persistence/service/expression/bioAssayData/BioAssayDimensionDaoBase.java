 ...
 */
public abstract class BioAssayDimensionDaoBase extends HibernateDaoSupport implements BioAssayDimensionDao {

    /**
     * @see BioAssayDimensionDao#create(int, java.util.Collection)
     */
    @Override
    ...
    /**
     * @see BioAssayDimensionDao#create(int transform,
    ...
    /**
     * @see BioAssayDimensionDao#load(int, java.lang.Long)
     */
    ...
    /**
     * @see BioAssayDimensionDao#loadAll(int)
     */
    ...
    /**
     * @see BioAssayDimensionDao#remove(java.lang.Long)
     */
    ...
    /**
     * @see BioAssayDimensionDao#remove(ubic.gemma.model.expression.bioAssayData.BioAssayDimension)
     */
    @Override
    ...
    /**
     * @see BioAssayDimensionDao#update(ubic.gemma.model.expression.bioAssayData.BioAssayDimension)
     */
    @Override

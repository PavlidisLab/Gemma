...
public abstract class FactorValueDaoBase extends org.springframework.orm.hibernate3.support.HibernateDaoSupport
    ...
    /**
     * @see FactorValueDao#create(int, java.util.Collection)
     */
    @Override
    ...
    /**
     * @see FactorValueDao#create(int transform,
    ...
    /**
     * @see FactorValueDao#load(int, java.lang.Long)
     */
    @Override
    ...
    /**
     * @see FactorValueDao#loadAll(int)
     */
    @Override
    ...
    /**
     * @see FactorValueDao#update(java.util.Collection)
     */
    @Override
    ...
    /**
     * @see FactorValueDao#update(ubic.gemma.model.expression.experiment.FactorValue)
     */
    @Override

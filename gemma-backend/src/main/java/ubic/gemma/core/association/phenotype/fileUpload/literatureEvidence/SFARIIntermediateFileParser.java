...
public class SFARIIntermediateFileParser {
    ...
    public static void main( String[] args ) throws Exception {
        ...
        try (BufferedWriter outputSFARI = new BufferedWriter(
                new FileWriter(
                        "./gemma-backend/src/main/java/ubic/gemma/association/phenotype/fileUpload/literatureEvidence/outputSFARI.tsv" ) );) {

            try (BufferedReader br = new BufferedReader(
                    new FileReader(
                            "./gemma-backend/src/main/java/ubic/gemma/association/phenotype/fileUpload/literatureEvidence/autism-gene-dataset.csv" ) );) {

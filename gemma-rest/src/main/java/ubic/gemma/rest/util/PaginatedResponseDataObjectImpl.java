...
@Getter
public class PaginatedResponseDataObjectImpl<T> extends ResponseDataObjectImpl<List<T>> implements PaginatedResponseDataObject<List<T>> {
     ...
     */
    public PaginatedResponseDataObjectImpl( Slice<T> payload, String[] groupBy ) {
        super( payload );

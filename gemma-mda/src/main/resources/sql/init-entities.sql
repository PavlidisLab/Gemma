...
alter table USER_PROBE_CO_EXPRESSION add column FIRST_DESIGN_ELEMENT_FK bigint(20), add column SECOND_DESIGN_ELEMENT_FK bigint(20);
...
update USER_PROBE_CO_EXPRESSION p, PROCESSED_EXPRESSION_DATA_VECTOR dedvFirst, PROCESSED_EXPRESSION_DATA_VECTOR dedvSecond SET p.FIRST_DESIGN_ELEMENT_FK=dedvFirst.DESIGN_ELEMENT_FK, p.SECOND_DESIGN_ELEMENT_FK=dedvSecond.DESIGN_ELEMENT_FK WHERE p.FIRST_VECTOR_FK=dedvFirst.ID AND p.SECOND_VECTOR_FK=dedvSecond.ID;
...
alter table USER_PROBE_CO_EXPRESSION add index EEkey (EXPRESSION_EXPERIMENT_FK, FIRST_DESIGN_ELEMENT_FK);
...
alter table USER_PROBE_CO_EXPRESSION add index fdeskey (FIRST_DESIGN_ELEMENT_FK);

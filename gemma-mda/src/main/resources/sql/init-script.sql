...
update HUMAN_PROBE_CO_EXPRESSION p, DESIGN_ELEMENT_DATA_VECTOR dedvFirst, DESIGN_ELEMENT_DATA_VECTOR dedvSecond SET p.FIRST_DESIGN_ELEMENT_FK=dedvFirst.DESIGN_ELEMENT_FK, p.SECOND_DESIGN_ELEMENT_FK=dedvSecond.DESIGN_ELEMENT_FK WHERE p.FIRST_VECTOR_FK=dedvFirst.ID AND p.SECOND_VECTOR_FK=dedvSecond.ID;
update MOUSE_PROBE_CO_EXPRESSION p, DESIGN_ELEMENT_DATA_VECTOR dedvFirst, DESIGN_ELEMENT_DATA_VECTOR dedvSecond SET p.FIRST_DESIGN_ELEMENT_FK=dedvFirst.DESIGN_ELEMENT_FK, p.SECOND_DESIGN_ELEMENT_FK=dedvSecond.DESIGN_ELEMENT_FK WHERE p.FIRST_VECTOR_FK=dedvFirst.ID AND p.SECOND_VECTOR_FK=dedvSecond.ID;
update RAT_PROBE_CO_EXPRESSION p, DESIGN_ELEMENT_DATA_VECTOR dedvFirst, DESIGN_ELEMENT_DATA_VECTOR dedvSecond SET p.FIRST_DESIGN_ELEMENT_FK=dedvFirst.DESIGN_ELEMENT_FK, p.SECOND_DESIGN_ELEMENT_FK=dedvSecond.DESIGN_ELEMENT_FK WHERE p.FIRST_VECTOR_FK=dedvFirst.ID AND p.SECOND_VECTOR_FK=dedvSecond.ID;
update OTHER_PROBE_CO_EXPRESSION p, DESIGN_ELEMENT_DATA_VECTOR dedvFirst, DESIGN_ELEMENT_DATA_VECTOR dedvSecond SET p.FIRST_DESIGN_ELEMENT_FK=dedvFirst.DESIGN_ELEMENT_FK, p.SECOND_DESIGN_ELEMENT_FK=dedvSecond.DESIGN_ELEMENT_FK WHERE p.FIRST_VECTOR_FK=dedvFirst.ID AND p.SECOND_VECTOR_FK=dedvSecond.ID;

alter table HUMAN_PROBE_CO_EXPRESSION add index EEkey (EXPRESSION_BIO_ASSAY_SET_FK, FIRST_DESIGN_ELEMENT_FK);
alter table MOUSE_PROBE_CO_EXPRESSION add index EEkey (EXPRESSION_BIO_ASSAY_SET_FK, FIRST_DESIGN_ELEMENT_FK);
alter table RAT_PROBE_CO_EXPRESSION add index EEkey (EXPRESSION_BIO_ASSAY_SET_FK, FIRST_DESIGN_ELEMENT_FK);
alter table OTHER_PROBE_CO_EXPRESSION add index EEkey (EXPRESSION_BIO_ASSAY_SET_FK, FIRST_DESIGN_ELEMENT_FK);

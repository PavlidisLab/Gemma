...
alter table HUMAN_PROBE_CO_EXPRESSION add index firstToSecondElement (FIRST_DESIGN_ELEMENT_FK,SECOND_DESIGN_ELEMENT_FK,EXPRESSION_EXPERIMENT_FK,QUANTITATION_TYPE_FK), add index EEkey (EXPRESSION_EXPERIMENT_FK);
alter table MOUSE_PROBE_CO_EXPRESSION add index firstToSecondElement (FIRST_DESIGN_ELEMENT_FK,SECOND_DESIGN_ELEMENT_FK,EXPRESSION_EXPERIMENT_FK,QUANTITATION_TYPE_FK), add index EEkey (EXPRESSION_EXPERIMENT_FK);
alter table RAT_PROBE_CO_EXPRESSION add index firstToSecondElement (FIRST_DESIGN_ELEMENT_FK,SECOND_DESIGN_ELEMENT_FK,EXPRESSION_EXPERIMENT_FK,QUANTITATION_TYPE_FK), add index EEkey (EXPRESSION_EXPERIMENT_FK);
alter table OTHER_PROBE_CO_EXPRESSION add index firstToSecondElement (FIRST_DESIGN_ELEMENT_FK,SECOND_DESIGN_ELEMENT_FK,EXPRESSION_EXPERIMENT_FK,QUANTITATION_TYPE_FK), add index EEkey (EXPRESSION_EXPERIMENT_FK);

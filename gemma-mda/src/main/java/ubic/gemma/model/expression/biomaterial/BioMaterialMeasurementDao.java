...
public interface BioMaterialMeasurementDao extends ubic.gemma.model.common.DescribableDao {
    ...
    /**
     * Creates a new instance of ubic.gemma.model.expression.biomaterial.BioMaterialMeasurement and adds from the passed
     * in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.expression.biomaterial.BioMaterialMeasurement instances to
     *        create.
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.biomaterial.BioMaterialMeasurement having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.biomaterial.BioMaterialMeasurement from the persistent store.
     */
    ...
    /**
     * Updates the <code>bioMaterialMeasurement</code> instance in the persistent store.
     */

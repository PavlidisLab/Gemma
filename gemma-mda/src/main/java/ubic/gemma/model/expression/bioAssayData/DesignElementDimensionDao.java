 ...
 */
public interface DesignElementDimensionDao extends BaseDao<DesignElementDimension> {
    /**
     * <p>
     * Does the same thing as {@link #find(boolean, ubic.gemma.model.expression.bioAssayData.DesignElementDimension)}
    ...
    /**
     * <p>
     * Does the same thing as {@link #find(ubic.gemma.model.expression.bioAssayData.DesignElementDimension)} with an
     ...
     * {@link #find(ubic.gemma.model.expression.bioAssayData.DesignElementDimension)}.
     * </p>
     */
    public ubic.gemma.model.expression.bioAssayData.DesignElementDimension find( String queryString,
            ubic.gemma.model.expression.bioAssayData.DesignElementDimension designElementDimension );
     ...
     * {@link #findOrCreate(boolean, ubic.gemma.model.expression.bioAssayData.DesignElementDimension)} with an
     * additional argument called <code>queryString</code>. This <code>queryString</code> argument allows you to
    ...
    /**
     * <p>
     * Does the same thing as {@link #findOrCreate(ubic.gemma.model.expression.bioAssayData.DesignElementDimension)}
     ...
     * </p>
     */
    public ubic.gemma.model.expression.bioAssayData.DesignElementDimension findOrCreate( String queryString,
            ubic.gemma.model.expression.bioAssayData.DesignElementDimension designElementDimension );

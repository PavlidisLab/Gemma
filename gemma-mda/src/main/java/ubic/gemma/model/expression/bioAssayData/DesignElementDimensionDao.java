 ...
 */
public interface DesignElementDimensionDao extends ubic.gemma.model.common.AuditableDao {
    /**
     * Loads an instance of ubic.gemma.model.expression.bioAssayData.DesignElementDimension from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.expression.bioAssayData.DesignElementDimension}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.expression.bioAssayData.DesignElementDimension and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.expression.bioAssayData.DesignElementDimension)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.expression.bioAssayData.DesignElementDimension and adds from the
     * passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.expression.bioAssayData.DesignElementDimension instances to
     *        create.
    ...
    /**
     * Updates the <code>designElementDimension</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.bioAssayData.DesignElementDimension from the persistent
     * store.
     */
    public void remove( ubic.gemma.model.expression.bioAssayData.DesignElementDimension designElementDimension );

    /**
     * Removes the instance of ubic.gemma.model.expression.bioAssayData.DesignElementDimension having the given
     ...
     * {@link #findOrCreate(int, ubic.gemma.model.expression.bioAssayData.DesignElementDimension designElementDimension)}.
     * </p>
     */
     ...
     * with an additional argument called <code>queryString</code>. This <code>queryString</code> argument allows
     * you to override the query string defined in
     * {@link #find(int, ubic.gemma.model.expression.bioAssayData.DesignElementDimension designElementDimension)}.
     * </p>
     */

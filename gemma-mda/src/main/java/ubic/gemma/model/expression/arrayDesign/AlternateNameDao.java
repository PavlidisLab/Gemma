...
public interface AlternateNameDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.expression.arrayDesign.AlternateName)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.expression.arrayDesign.AlternateName alternateName );

    /**
     * Creates a new instance of ubic.gemma.model.expression.arrayDesign.AlternateName and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.expression.arrayDesign.AlternateName instances to create.
     * @return the created instances.
     */
    public java.util.Collection create( java.util.Collection entities );

    /**
     * Creates an instance of ubic.gemma.model.expression.arrayDesign.AlternateName and adds it to the persistent store.
     */
    ...
    /**
     * Loads an instance of ubic.gemma.model.expression.arrayDesign.AlternateName from the persistent store.
     */
    public ubic.gemma.model.expression.arrayDesign.AlternateName load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.expression.arrayDesign.AlternateName}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.arrayDesign.AlternateName having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.arrayDesign.AlternateName from the persistent store.
     */
    ...
    /**
     * Updates the <code>alternateName</code> instance in the persistent store.
     */

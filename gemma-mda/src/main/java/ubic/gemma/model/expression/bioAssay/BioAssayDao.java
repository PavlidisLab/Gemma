...
public interface BioAssayDao extends ubic.gemma.model.common.AuditableDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.expression.bioAssay.BioAssay)} with an additional flag
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.expression.bioAssay.BioAssay bioAssay );

    /**
     * Creates a new instance of ubic.gemma.model.expression.bioAssay.BioAssay and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.expression.bioAssay.BioAssay instances to create.
    ...
    /**
     * Updates the <code>bioAssay</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.bioAssay.BioAssay from the persistent store.
     */
    public void remove( ubic.gemma.model.expression.bioAssay.BioAssay bioAssay );

    /**
     * Removes the instance of ubic.gemma.model.expression.bioAssay.BioAssay having the given <code>identifier</code>
     ...
     * query string defined in {@link #findOrCreate(ubic.gemma.model.expression.bioAssay.BioAssay)}.
     * </p>
     */
     ...
     * </p>
     */
    public Object findOrCreate( int transform, ubic.gemma.model.expression.bioAssay.BioAssay bioAssay );
     ...
     * {@link #findOrCreate(int, ubic.gemma.model.expression.bioAssay.BioAssay bioAssay)}.
     * </p>
     */
     ...
     * string defined in {@link #find(ubic.gemma.model.expression.bioAssay.BioAssay)}.
     * </p>
     */
     ...
     * </p>
     */
    public Object find( int transform, ubic.gemma.model.expression.bioAssay.BioAssay bioAssay );

    /**
     * <p>
     * Does the same thing as {@link #find(boolean, ubic.gemma.model.expression.bioAssay.BioAssay)} with an additional
     * argument called <code>queryString</code>. This <code>queryString</code> argument allows you to override the
     * query string defined in {@link #find(int, ubic.gemma.model.expression.bioAssay.BioAssay bioAssay)}.
     * </p>
     */
    public Object find( int transform, String queryString, ubic.gemma.model.expression.bioAssay.BioAssay bioAssay );
     ...
     * </p>
     */
    public java.util.Collection findBioAssayDimensions( String queryString,
            ubic.gemma.model.expression.bioAssay.BioAssay bioAssay );
     ...
     * </p>
     */
    public java.util.Collection findBioAssayDimensions( int transform,
            ubic.gemma.model.expression.bioAssay.BioAssay bioAssay );
     ...
     * {@link #findBioAssayDimensions(int, ubic.gemma.model.expression.bioAssay.BioAssay bioAssay)}.
     * </p>
     */
    public java.util.Collection findBioAssayDimensions( int transform, String queryString,
            ubic.gemma.model.expression.bioAssay.BioAssay bioAssay );

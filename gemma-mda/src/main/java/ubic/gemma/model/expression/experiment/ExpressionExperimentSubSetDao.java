 ...
 */
public interface ExpressionExperimentSubSetDao extends ubic.gemma.model.expression.experiment.BioAssaySetDao {
    /**
     * Loads an instance of ubic.gemma.model.expression.experiment.ExpressionExperimentSubSet from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.expression.experiment.ExpressionExperimentSubSet}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.expression.experiment.ExpressionExperimentSubSet and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.expression.experiment.ExpressionExperimentSubSet)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.expression.experiment.ExpressionExperimentSubSet and adds from the
     * passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.expression.experiment.ExpressionExperimentSubSet instances to
     *        create.
    ...
    /**
     * Updates the <code>expressionExperimentSubSet</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.experiment.ExpressionExperimentSubSet from the persistent
     * store.
     */
    public void remove( ubic.gemma.model.expression.experiment.ExpressionExperimentSubSet expressionExperimentSubSet );

    /**
     * Removes the instance of ubic.gemma.model.expression.experiment.ExpressionExperimentSubSet having the given

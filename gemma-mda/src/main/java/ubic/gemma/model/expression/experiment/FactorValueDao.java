 ...
 */
public interface FactorValueDao {
    /**
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.expression.experiment.FactorValue)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.expression.experiment.FactorValue factorValue );

    /**
     * Creates a new instance of ubic.gemma.model.expression.experiment.FactorValue and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.expression.experiment.FactorValue instances to create.
     * @return the created instances.
     */
    public java.util.Collection create( java.util.Collection entities );

    /**
     * Creates an instance of ubic.gemma.model.expression.experiment.FactorValue and adds it to the persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #find(boolean, ubic.gemma.model.expression.experiment.FactorValue)} with an
     * additional argument called <code>queryString</code>. This <code>queryString</code> argument allows you to
     * override the query string defined in {@link #find(int, ubic.gemma.model.expression.experiment.FactorValue
     * factorValue)}.
     * </p>
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #find(ubic.gemma.model.expression.experiment.FactorValue)} with an additional flag
     ...
     * </p>
     */
    public Object find( int transform, ubic.gemma.model.expression.experiment.FactorValue factorValue );

    /**
     * <p>
     * Does the same thing as {@link #find(ubic.gemma.model.expression.experiment.FactorValue)} with an additional
     * argument called <code>queryString</code>. This <code>queryString</code> argument allows you to override the query
     * string defined in {@link #find(ubic.gemma.model.expression.experiment.FactorValue)}.
     * </p>
     */
    public ubic.gemma.model.expression.experiment.FactorValue find( String queryString,
            ubic.gemma.model.expression.experiment.FactorValue factorValue );
    ...
    /**
     * <p>
     * Does the same thing as {@link #findOrCreate(boolean, ubic.gemma.model.expression.experiment.FactorValue)} with an
     * additional argument called <code>queryString</code>. This <code>queryString</code> argument allows you to
     * override the query string defined in {@link #findOrCreate(int, ubic.gemma.model.expression.experiment.FactorValue
     * factorValue)}.
     * </p>
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #findOrCreate(ubic.gemma.model.expression.experiment.FactorValue)} with an
     ...
     * </p>
     */
    public Object findOrCreate( int transform, ubic.gemma.model.expression.experiment.FactorValue factorValue );

    /**
     * <p>
     * Does the same thing as {@link #findOrCreate(ubic.gemma.model.expression.experiment.FactorValue)} with an
     * additional argument called <code>queryString</code>. This <code>queryString</code> argument allows you to
     * override the query string defined in {@link #findOrCreate(ubic.gemma.model.expression.experiment.FactorValue)}.
     * </p>
     */
    public ubic.gemma.model.expression.experiment.FactorValue findOrCreate( String queryString,
            ubic.gemma.model.expression.experiment.FactorValue factorValue );
    ...
    /**
     * Loads an instance of ubic.gemma.model.expression.experiment.FactorValue from the persistent store.
     */
    public ubic.gemma.model.expression.experiment.FactorValue load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.expression.experiment.FactorValue}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.experiment.FactorValue having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.experiment.FactorValue from the persistent store.
     */
    ...
    /**
     * Updates the <code>factorValue</code> instance in the persistent store.
     */

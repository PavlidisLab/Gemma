...
public interface CompositeSequenceDao extends ubic.gemma.model.expression.designElement.DesignElementDao {
     ...
     * {@link #findOrCreate(int, ubic.gemma.model.expression.designElement.CompositeSequence compositeSequence)}.
     * </p>
     */
     ...
     * override the query string defined in
     * {@link #find(int, ubic.gemma.model.expression.designElement.CompositeSequence compositeSequence)}.
     * </p>
     */
     ...
     * additional argument called <code>queryString</code>. This <code>queryString</code> argument allows you to
     * override the query string defined in
     * {@link #findByName(int, ubic.gemma.model.expression.arrayDesign.ArrayDesign arrayDesign, java.lang.String name)}.
     * </p>
     */
     ...
     * <code>queryString</code>. This <code>queryString</code> argument allows you to override the query string
     * defined in {@link #findByGene(ubic.gemma.model.genome.Gene)}.
     * </p>
     */
     ...
     * string defined in {@link #findByGene(int, ubic.gemma.model.genome.Gene gene)}.
     * </p>
     */
     ...
     * with an additional argument called <code>queryString</code>. This <code>queryString</code> argument allows
     * you to override the query string defined in
     * {@link #findByGene(int, ubic.gemma.model.genome.Gene gene, ubic.gemma.model.expression.arrayDesign.ArrayDesign arrayDesign)}.
     * </p>
     */
    public java.util.Collection findByGene( int transform, String queryString, ubic.gemma.model.genome.Gene gene,
            ubic.gemma.model.expression.arrayDesign.ArrayDesign arrayDesign );

 ...
 * @author pavlidis
 * @version $Id$
 * @see ubic.gemma.model.expression.bioMaterialData.BioMaterialDimension
 */
public class BioMaterialDimensionDaoImpl extends ubic.gemma.model.expression.bioAssayData.BioMaterialDimensionDaoBase {

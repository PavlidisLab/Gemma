 ...
 */
public interface ExperimentalDesignDao extends ubic.gemma.model.common.AuditableDao {
    /**
     * Loads an instance of ubic.gemma.model.expression.experiment.ExperimentalDesign from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.expression.experiment.ExperimentalDesign}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.expression.experiment.ExperimentalDesign and adds it to the persistent
     * store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.expression.experiment.ExperimentalDesign)} with an
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.expression.experiment.ExperimentalDesign experimentalDesign );

    /**
     * Creates a new instance of ubic.gemma.model.expression.experiment.ExperimentalDesign and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.expression.experiment.ExperimentalDesign instances to create.
    ...
    /**
     * Updates the <code>experimentalDesign</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.experiment.ExperimentalDesign from the persistent store.
     */
    public void remove( ubic.gemma.model.expression.experiment.ExperimentalDesign experimentalDesign );

    /**
     * Removes the instance of ubic.gemma.model.expression.experiment.ExperimentalDesign having the given
     ...
     * {@link #findOrCreate(int, ubic.gemma.model.expression.experiment.ExperimentalDesign experimentalDesign)}.
     * </p>
     */
     ...
     * additional argument called <code>queryString</code>. This <code>queryString</code> argument allows you to
     * override the query string defined in
     * {@link #find(int, ubic.gemma.model.expression.experiment.ExperimentalDesign experimentalDesign)}.
     * </p>
     */

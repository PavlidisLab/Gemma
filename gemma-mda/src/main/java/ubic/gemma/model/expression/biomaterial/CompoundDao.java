 ...
 */
public interface CompoundDao extends ubic.gemma.model.common.DescribableDao {
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.expression.biomaterial.Compound)} with an additional flag
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.expression.biomaterial.Compound compound );

    /**
     * Creates a new instance of ubic.gemma.model.expression.biomaterial.Compound and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.expression.biomaterial.Compound instances to create.
     * @return the created instances.
     */
    public java.util.Collection create( java.util.Collection entities );

    /**
     * Creates an instance of ubic.gemma.model.expression.biomaterial.Compound and adds it to the persistent store.
     */
     ...
     * </p>
     */
    public Object find( int transform, String queryString, ubic.gemma.model.expression.biomaterial.Compound compound );
     ...
     * </p>
     */
    public Object find( int transform, ubic.gemma.model.expression.biomaterial.Compound compound );
     ...
     * </p>
     */
    public Object findOrCreate( int transform, ubic.gemma.model.expression.biomaterial.Compound compound );
    ...
    /**
     * Loads an instance of ubic.gemma.model.expression.biomaterial.Compound from the persistent store.
     */
    public ubic.gemma.model.common.Securable load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.expression.biomaterial.Compound}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.biomaterial.Compound having the given <code>identifier</code>
    ...
    /**
     * Removes the instance of ubic.gemma.model.expression.biomaterial.Compound from the persistent store.
     */
    ...
    /**
     * Updates the <code>compound</code> instance in the persistent store.
     */

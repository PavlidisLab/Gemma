 ...
 */
public interface BioSequence2GeneProductDao extends ubic.gemma.model.association.RelationshipDao {
    /**
     * <p>
    ...
    /**
     * Loads an instance of ubic.gemma.model.association.BioSequence2GeneProduct from the persistent store.
     */
    public ubic.gemma.model.association.Relationship load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.association.BioSequence2GeneProduct}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.BioSequence2GeneProduct having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.BioSequence2GeneProduct from the persistent store.
     */
    ...
    /**
     * Updates the <code>bioSequence2GeneProduct</code> instance in the persistent store.
     */

...
public class Probe2ProbeCoexpressionDaoImpl extends
    ...
    // private Collection getLinks(ExpressionExperiment expressionExperiment, String taxon, String tableName) throws
    // Exception{
    // String baseQueryString = "SELECT FIRST_DESIGN_ELEMENT_FK, SECOND_DESIGN_ELEMENT_FK FROM " + getTableName(taxon,
    // false) + " WHERE EXPRESSION_EXPERIMENT_FK = " + ee.getId() + " limit ";
    ...
    private void saveLinks( Collection<Link> links, ExpressionExperiment ee, String tableName ) throws Exception {
        ...
        for ( Link link : links ) {
            ...
            if ( count == CHUNK_LIMIT || total == 0 ) {
                ...
                // values = values + ",";
                // }
                // queryString = "INSERT INTO " + tableName + "(FIRST_DESIGN_ELEMENT_FK, SECOND_DESIGN_ELEMENT_FK,
                // EXPRESSION_EXPERIMENT_FK) " + " VALUES " + values+";";

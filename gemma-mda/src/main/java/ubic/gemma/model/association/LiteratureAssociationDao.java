 ...
 */
public interface LiteratureAssociationDao extends ubic.gemma.model.association.Gene2GeneAssociationDao {
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.association.LiteratureAssociation)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.association.LiteratureAssociation literatureAssociation );

    /**
     * Creates a new instance of ubic.gemma.model.association.LiteratureAssociation and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.association.LiteratureAssociation instances to create.
     * @return the created instances.
     */
    public java.util.Collection create( java.util.Collection entities );

    /**
     * Creates an instance of ubic.gemma.model.association.LiteratureAssociation and adds it to the persistent store.
     */
    ...
    /**
     * Loads an instance of ubic.gemma.model.association.LiteratureAssociation from the persistent store.
     */
    public ubic.gemma.model.association.Relationship load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.association.LiteratureAssociation}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.LiteratureAssociation having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.LiteratureAssociation from the persistent store.
     */
    ...
    /**
     * Updates the <code>literatureAssociation</code> instance in the persistent store.
     */

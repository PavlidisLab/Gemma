 ...
 */
public interface RatGeneCoExpressionDao extends ubic.gemma.model.association.coexpression.Gene2GeneCoexpressionDao {
    /**
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.association.coexpression.RatGeneCoExpression}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.association.coexpression.RatGeneCoExpression and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.association.coexpression.RatGeneCoExpression)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.association.coexpression.RatGeneCoExpression and adds from the passed
     * in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.association.coexpression.RatGeneCoExpression instances to
     *        create.
    ...
    /**
     * Updates the <code>ratGeneCoExpression</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.RatGeneCoExpression from the persistent store.
     */
    public void remove( ubic.gemma.model.association.coexpression.RatGeneCoExpression ratGeneCoExpression );

    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.RatGeneCoExpression having the given

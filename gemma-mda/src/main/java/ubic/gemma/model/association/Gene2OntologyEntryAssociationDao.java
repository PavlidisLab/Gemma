 ...
 */
public interface Gene2OntologyEntryAssociationDao extends ubic.gemma.model.association.RelationshipDao {
    /**
     * <p>
    ...
    /**
     * Loads an instance of ubic.gemma.model.association.Gene2OntologyEntryAssociation from the persistent store.
     */
    public ubic.gemma.model.association.Relationship load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.association.Gene2OntologyEntryAssociation}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.Gene2OntologyEntryAssociation having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.Gene2OntologyEntryAssociation from the persistent store.
     */
    ...
    /**
     * Updates the <code>gene2OntologyEntryAssociation</code> instance in the persistent store.
     */

 ...
 */
public interface MouseProbeCoExpressionDao extends ubic.gemma.model.association.coexpression.Probe2ProbeCoexpressionDao {
    /**
     * Loads an instance of ubic.gemma.model.association.coexpression.MouseProbeCoExpression from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.association.coexpression.MouseProbeCoExpression}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.association.coexpression.MouseProbeCoExpression and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.association.coexpression.MouseProbeCoExpression)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.association.coexpression.MouseProbeCoExpression and adds from the
     * passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.association.coexpression.MouseProbeCoExpression instances to
     *        create.
    ...
    /**
     * Updates the <code>mouseProbeCoExpression</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.MouseProbeCoExpression from the persistent
     * store.
     */
    public void remove( ubic.gemma.model.association.coexpression.MouseProbeCoExpression mouseProbeCoExpression );

    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.MouseProbeCoExpression having the given

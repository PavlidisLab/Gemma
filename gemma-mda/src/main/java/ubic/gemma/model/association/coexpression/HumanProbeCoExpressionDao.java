 ...
 */
public interface HumanProbeCoExpressionDao extends ubic.gemma.model.association.coexpression.Probe2ProbeCoexpressionDao {
    /**
     * Loads an instance of ubic.gemma.model.association.coexpression.HumanProbeCoExpression from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.association.coexpression.HumanProbeCoExpression}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.association.coexpression.HumanProbeCoExpression and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.association.coexpression.HumanProbeCoExpression)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.association.coexpression.HumanProbeCoExpression and adds from the
     * passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.association.coexpression.HumanProbeCoExpression instances to
     *        create.
    ...
    /**
     * Updates the <code>humanProbeCoExpression</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.HumanProbeCoExpression from the persistent
     * store.
     */
    public void remove( ubic.gemma.model.association.coexpression.HumanProbeCoExpression humanProbeCoExpression );

    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.HumanProbeCoExpression having the given

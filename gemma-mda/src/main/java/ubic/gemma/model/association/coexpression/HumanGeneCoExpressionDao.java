 ...
 */
public interface HumanGeneCoExpressionDao extends ubic.gemma.model.association.coexpression.Gene2GeneCoexpressionDao {
    /**
     * Loads an instance of ubic.gemma.model.association.coexpression.HumanGeneCoExpression from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.association.coexpression.HumanGeneCoExpression}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.association.coexpression.HumanGeneCoExpression and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.association.coexpression.HumanGeneCoExpression)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.association.coexpression.HumanGeneCoExpression and adds from the
     * passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.association.coexpression.HumanGeneCoExpression instances to
     *        create.
    ...
    /**
     * Updates the <code>humanGeneCoExpression</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.HumanGeneCoExpression from the persistent
     * store.
     */
    public void remove( ubic.gemma.model.association.coexpression.HumanGeneCoExpression humanGeneCoExpression );

    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.HumanGeneCoExpression having the given

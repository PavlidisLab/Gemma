 ...
 */
public interface MouseGeneCoExpressionDao extends ubic.gemma.model.association.coexpression.Gene2GeneCoexpressionDao {
    /**
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.association.coexpression.MouseGeneCoExpression}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.association.coexpression.MouseGeneCoExpression and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.association.coexpression.MouseGeneCoExpression)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.association.coexpression.MouseGeneCoExpression and adds from the
     * passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.association.coexpression.MouseGeneCoExpression instances to
     *        create.
    ...
    /**
     * Updates the <code>mouseGeneCoExpression</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.MouseGeneCoExpression from the persistent
     * store.
     */
    public void remove( ubic.gemma.model.association.coexpression.MouseGeneCoExpression mouseGeneCoExpression );

    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.MouseGeneCoExpression having the given

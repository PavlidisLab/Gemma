 ...
 */
public interface RatProbeCoExpressionDao extends ubic.gemma.model.association.coexpression.Probe2ProbeCoexpressionDao {
    /**
     * Loads an instance of ubic.gemma.model.association.coexpression.RatProbeCoExpression from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.association.coexpression.RatProbeCoExpression}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.association.coexpression.RatProbeCoExpression and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.association.coexpression.RatProbeCoExpression)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.association.coexpression.RatProbeCoExpression and adds from the passed
     * in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.association.coexpression.RatProbeCoExpression instances to
     *        create.
    ...
    /**
     * Updates the <code>ratProbeCoExpression</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.RatProbeCoExpression from the persistent store.
     */
    public void remove( ubic.gemma.model.association.coexpression.RatProbeCoExpression ratProbeCoExpression );

    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.RatProbeCoExpression having the given

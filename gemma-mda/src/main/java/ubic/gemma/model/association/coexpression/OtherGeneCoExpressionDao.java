 ...
 */
public interface OtherGeneCoExpressionDao extends ubic.gemma.model.association.coexpression.Gene2GeneCoexpressionDao {
    /**
     * Loads an instance of ubic.gemma.model.association.coexpression.OtherGeneCoExpression from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.association.coexpression.OtherGeneCoExpression}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.association.coexpression.OtherGeneCoExpression and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.association.coexpression.OtherGeneCoExpression)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.association.coexpression.OtherGeneCoExpression and adds from the
     * passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.association.coexpression.OtherGeneCoExpression instances to
     *        create.
    ...
    /**
     * Updates the <code>otherGeneCoExpression</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.OtherGeneCoExpression from the persistent
     * store.
     */
    public void remove( ubic.gemma.model.association.coexpression.OtherGeneCoExpression otherGeneCoExpression );

    /**
     * Removes the instance of ubic.gemma.model.association.coexpression.OtherGeneCoExpression having the given

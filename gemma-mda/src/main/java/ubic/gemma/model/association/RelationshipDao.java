...
public interface RelationshipDao {
    ...
    /**
     * Loads an instance of ubic.gemma.model.association.Relationship from the persistent store.
     */
    public ubic.gemma.model.association.Relationship load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.association.Relationship}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.Relationship having the given <code>identifier</code> from
    ...
    /**
     * Removes the instance of ubic.gemma.model.association.Relationship from the persistent store.
     */
    ...
    /**
     * Updates the <code>relationship</code> instance in the persistent store.
     */

 ...
 */
public interface ArrayDesignSubsumeCheckEventDao extends
        ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignAnalysisEventDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSubsumeCheckEvent from the
     * persistent store.
     */
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSubsumeCheckEvent and adds
     ...
     * {@link #create(ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSubsumeCheckEvent)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSubsumeCheckEvent and
     * adds from the passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSubsumeCheckEvent
     *        instances to create.
    ...
    /**
     * Updates the <code>arrayDesignSubsumeCheckEvent</code> instance in the persistent store.
     */
    public void update(
            ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSubsumeCheckEvent arrayDesignSubsumeCheckEvent );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSubsumeCheckEvent from the
     * persistent store.
     */
    public void remove(
            ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSubsumeCheckEvent arrayDesignSubsumeCheckEvent );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSubsumeCheckEvent having

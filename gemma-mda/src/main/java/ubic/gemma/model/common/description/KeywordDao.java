...
public interface KeywordDao extends ubic.gemma.model.common.description.BibRefAnnotationDao {
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.description.Keyword and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.description.Keyword instances to create.

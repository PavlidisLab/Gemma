 ...
 */
public abstract class UserDaoBase extends ubic.gemma.model.common.auditAndSecurity.PersonDaoImpl implements
    ...
    public Object load( final int transform, final java.lang.Long id ) {
        ...
        final Object entity = this.getHibernateTemplate().get( ubic.gemma.model.common.auditAndSecurity.UserImpl.class,
                id );
        return transformEntity( transform, ( ubic.gemma.model.common.auditAndSecurity.User ) entity );
    }
    ...
    public ubic.gemma.model.common.Securable load( java.lang.Long id ) {
        return ( ubic.gemma.model.common.auditAndSecurity.User ) this.load( TRANSFORM_NONE, id );
    }
     ...
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.auditAndSecurity.User user ) {
    ...
    public void remove( java.lang.Long id ) {
        ...
        ubic.gemma.model.common.auditAndSecurity.User entity = ( ubic.gemma.model.common.auditAndSecurity.User ) this
                .load( id );
        if ( entity != null ) {
            this.remove( entity );
        }
     ...
     */
    @SuppressWarnings( { "unchecked" })
    public Object findByUserName( final int transform, final java.lang.String queryString,
            final java.lang.String userName ) {
    ...
    public Object findOrCreate( final int transform, final java.lang.String queryString,
        ...
        if ( results != null ) {
            if ( results.size() > 1 ) {
                ...
                result = ( ubic.gemma.model.common.auditAndSecurity.User ) results.iterator().next();
            }
        }
        result = transformEntity( transform, ( ubic.gemma.model.common.auditAndSecurity.User ) result );
        return result;
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getRecipient(java.lang.Long)
     */
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getRecipient(java.lang.String, java.lang.Long)
     */
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getRecipient(int, java.lang.Long)
     */
    @SuppressWarnings( { "unchecked" })
    public Object getRecipient( final int transform, final java.lang.Long id ) {
        return this.getRecipient( transform,
                "from ubic.gemma.model.common.auditAndSecurity.User as user where user.id = :id", id );
    }

    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getRecipient(int, java.lang.String, java.lang.Long)
     */
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getAclObjectIdentityId(ubic.gemma.model.common.Securable)
     */
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getAclObjectIdentityId(java.lang.String,
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getAclObjectIdentityId(int,
     *      ubic.gemma.model.common.Securable)
     */
    @SuppressWarnings( { "unchecked" })
    public Object getAclObjectIdentityId( final int transform, final ubic.gemma.model.common.Securable securable ) {
        return this.getAclObjectIdentityId( transform,
                "from ubic.gemma.model.common.auditAndSecurity.User as user where user.securable = :securable",
                securable );
    }

    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getAclObjectIdentityId(int, java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getMask(ubic.gemma.model.common.Securable)
     */
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getMask(java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getMask(int, ubic.gemma.model.common.Securable)
     */
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getMask(int, java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getMasks(java.util.Collection)
     */
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getMasks(java.lang.String, java.util.Collection)
     */
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getMasks(int, java.util.Collection)
     */
    @SuppressWarnings( { "unchecked" })
    public Object getMasks( final int transform, final java.util.Collection securables ) {
        return this.getMasks( transform,
                "from ubic.gemma.model.common.auditAndSecurity.User as user where user.securables = :securables",
                securables );
    }

    /**
     * @see ubic.gemma.model.common.auditAndSecurity.UserDao#getMasks(int, java.lang.String, java.util.Collection)
     */
    @SuppressWarnings( { "unchecked" })

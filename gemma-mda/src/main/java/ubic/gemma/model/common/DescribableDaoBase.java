 ...
 * <code>ubic.gemma.model.common.Describable</code>.
 * </p>
 * 
 * @see ubic.gemma.model.common.Describable
 */
public abstract class DescribableDaoBase extends ubic.gemma.model.common.SecurableDaoImpl implements
    ...
    public Object load( final int transform, final java.lang.Long id ) {
        if ( id == null ) {
            throw new IllegalArgumentException( "Describable.load - 'id' can not be null" );
        }
        final Object entity = this.getHibernateTemplate().get( ubic.gemma.model.common.DescribableImpl.class, id );
        return transformEntity( transform, ( ubic.gemma.model.common.Describable ) entity );
    }

    /**
     * @see ubic.gemma.model.common.DescribableDao#load(java.lang.Long)
     */
    @Override
    public ubic.gemma.model.common.Securable load( java.lang.Long id ) {
        return ( ubic.gemma.model.common.Describable ) this.load( TRANSFORM_NONE, id );
    }

    /**
     * @see ubic.gemma.model.common.DescribableDao#loadAll()
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.DescribableDao#loadAll(int)
     */
    @Override
    public java.util.Collection loadAll( final int transform ) {
        final java.util.Collection results = this.getHibernateTemplate().loadAll(
                ubic.gemma.model.common.DescribableImpl.class );
    ...
    public void remove( java.lang.Long id ) {
        if ( id == null ) {
            throw new IllegalArgumentException( "Describable.remove - 'id' can not be null" );
        }
        ubic.gemma.model.common.Describable entity = ( ubic.gemma.model.common.Describable ) this.load( id );
        if ( entity != null ) {
            this.remove( entity );
        }
    }
    ...
    public void remove( java.util.Collection entities ) {
        if ( entities == null ) {
            throw new IllegalArgumentException( "Describable.remove - 'entities' can not be null" );
        }
     ...
     * <code>ubic.gemma.model.common.DescribableDao</code>, please note that the {@link #TRANSFORM_NONE} constant
     ...
     * 
     * @param transform one of the constants declared in {@link ubic.gemma.model.common.DescribableDao}
     * @param entity an entity that was found
     * @return the transformed entity (i.e. new value object, etc)
     * @see #transformEntities(int,java.util.Collection)
     */
    protected Object transformEntity( final int transform, final ubic.gemma.model.common.Describable entity ) {
        Object target = null;
        if ( entity != null ) {
            switch ( transform ) {

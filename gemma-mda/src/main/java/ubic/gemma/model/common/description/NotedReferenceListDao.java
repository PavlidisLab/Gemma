 ...
 */
public interface NotedReferenceListDao extends ubic.gemma.model.common.AuditableDao {
    /**
     * Loads an instance of ubic.gemma.model.common.description.NotedReferenceList from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.description.NotedReferenceList}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.description.NotedReferenceList and adds it to the persistent
     * store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.description.NotedReferenceList)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.description.NotedReferenceList notedReferenceList );

    /**
     * Creates a new instance of ubic.gemma.model.common.description.NotedReferenceList and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.description.NotedReferenceList instances to create.
    ...
    /**
     * Updates the <code>notedReferenceList</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.NotedReferenceList from the persistent store.
     */
    public void remove( ubic.gemma.model.common.description.NotedReferenceList notedReferenceList );

    /**
     * Removes the instance of ubic.gemma.model.common.description.NotedReferenceList having the given

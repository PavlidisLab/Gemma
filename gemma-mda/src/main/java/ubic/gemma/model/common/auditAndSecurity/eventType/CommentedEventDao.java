 ...
 */
public interface CommentedEventDao extends ubic.gemma.model.common.auditAndSecurity.eventType.AuditEventTypeDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.eventType.CommentedEvent from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.auditAndSecurity.eventType.CommentedEvent}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.eventType.CommentedEvent and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.auditAndSecurity.eventType.CommentedEvent)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.eventType.CommentedEvent and adds from the
     * passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.auditAndSecurity.eventType.CommentedEvent instances to
     *        create.
    ...
    /**
     * Updates the <code>commentedEvent</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.CommentedEvent from the persistent
     * store.
     */
    public void remove( ubic.gemma.model.common.auditAndSecurity.eventType.CommentedEvent commentedEvent );

    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.CommentedEvent having the given

 ...
 */
public interface ParameterDao extends ubic.gemma.model.common.DescribableDao {
    /**
     * Loads an instance of ubic.gemma.model.common.protocol.Parameter from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.protocol.Parameter}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.protocol.Parameter and adds it to the persistent store.
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.protocol.Parameter parameter );

    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.protocol.Parameter)} with an additional flag called
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.protocol.Parameter parameter );

    /**
     * Creates a new instance of ubic.gemma.model.common.protocol.Parameter and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.protocol.Parameter instances to create.
    ...
    /**
     * Updates the <code>parameter</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.protocol.Parameter from the persistent store.
     */
    public void remove( ubic.gemma.model.common.protocol.Parameter parameter );

    /**
     * Removes the instance of ubic.gemma.model.common.protocol.Parameter having the given <code>identifier</code>

 ...
 */
public interface CharacteristicDao extends ubic.gemma.model.common.AuditableDao {
    /**
     * Loads an instance of ubic.gemma.model.common.description.Characteristic from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.description.Characteristic}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.description.Characteristic and adds it to the persistent store.
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.description.Characteristic characteristic );

    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.description.Characteristic)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.description.Characteristic characteristic );

    /**
     * Creates a new instance of ubic.gemma.model.common.description.Characteristic and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.description.Characteristic instances to create.
    ...
    /**
     * Updates the <code>characteristic</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.Characteristic from the persistent store.
     */
    public void remove( ubic.gemma.model.common.description.Characteristic characteristic );

    /**
     * Removes the instance of ubic.gemma.model.common.description.Characteristic having the given
     ...
     * </p>
     */
    public java.util.Map getParents( java.lang.Class parentClass, java.util.Collection characteristics );

    /**
     * 
     */
    public java.util.Collection findByUri( java.lang.String searchString );

 ...
 */
public interface UserDao extends ubic.gemma.model.common.auditAndSecurity.PersonDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.User from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.auditAndSecurity.User}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.User and adds it to the persistent store.
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.auditAndSecurity.User user );

    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.auditAndSecurity.User)} with an additional flag
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.auditAndSecurity.User user );

    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.User and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.auditAndSecurity.User instances to create.
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.User from the persistent store.
     */
    public void remove( ubic.gemma.model.common.auditAndSecurity.User user );

    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.User having the given <code>identifier</code>
     ...
     * defined in {@link #findByUserName(java.lang.String)}.
     * </p>
     */
     ...
     * </p>
     */
    public Object findByUserName( int transform, java.lang.String userName );

    /**
     * <p>
     * Does the same thing as {@link #findByUserName(boolean, java.lang.String)} with an additional argument called
     * <code>queryString</code>. This <code>queryString</code> argument allows you to override the query string
     * defined in {@link #findByUserName(int, java.lang.String userName)}.
     * </p>
     */
    public Object findByUserName( int transform, String queryString, java.lang.String userName );

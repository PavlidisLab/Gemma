 ...
 */
public interface DifferentialExpressionTroubleDao extends
        ubic.gemma.model.common.auditAndSecurity.eventType.TroubleStatusFlagEventDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.eventType.DifferentialExpressionTrouble from the
     * persistent store.
     */
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.eventType.DifferentialExpressionTrouble and adds
     ...
     * {@link #create(ubic.gemma.model.common.auditAndSecurity.eventType.DifferentialExpressionTrouble)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.eventType.DifferentialExpressionTrouble and
     * adds from the passed in <code>entities</code> collection
     * 
     * @param entities the collection of
     *        ubic.gemma.model.common.auditAndSecurity.eventType.DifferentialExpressionTrouble instances to create.
    ...
    /**
     * Updates the <code>differentialExpressionTrouble</code> instance in the persistent store.
     */
    public void update(
            ubic.gemma.model.common.auditAndSecurity.eventType.DifferentialExpressionTrouble differentialExpressionTrouble );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.DifferentialExpressionTrouble from the
     * persistent store.
     */
    public void remove(
            ubic.gemma.model.common.auditAndSecurity.eventType.DifferentialExpressionTrouble differentialExpressionTrouble );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.DifferentialExpressionTrouble having

 ...
 */
public abstract class HardwareApplicationDaoBase extends
    ...
    public ubic.gemma.model.common.Securable create(
            ubic.gemma.model.common.protocol.HardwareApplication hardwareApplication ) {
        ...
        this.getHibernateTemplate().execute( new org.springframework.orm.hibernate3.HibernateCallback() {
            public Object doInHibernate( org.hibernate.Session session ) throws org.hibernate.HibernateException {
                for ( java.util.Iterator entityIterator = entities.iterator(); entityIterator.hasNext(); ) {
                    create( transform, ( ubic.gemma.model.common.protocol.HardwareApplication ) entityIterator.next() );
                }
                return null;
            }
        }, true );
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getRecipient(java.lang.Long)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getRecipient(java.lang.String, java.lang.Long)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getRecipient(int, java.lang.Long)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getRecipient( final int transform, final java.lang.Long id ) {
        return this
                .getRecipient(
                        transform,
                        "from ubic.gemma.model.common.protocol.HardwareApplication as hardwareApplication where hardwareApplication.id = :id",
                        id );
    }

    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getRecipient(int, java.lang.String, java.lang.Long)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getRecipient( final int transform, final java.lang.String queryString, final java.lang.Long id ) {
        ...
        result = transformEntity( transform, ( ubic.gemma.model.common.protocol.HardwareApplication ) result );
        return result;
    }

    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getAclObjectIdentityId(ubic.gemma.model.common.Securable)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getAclObjectIdentityId(java.lang.String,
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getAclObjectIdentityId(int,
     *      ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getAclObjectIdentityId( final int transform, final ubic.gemma.model.common.Securable securable ) {
        return this
                .getAclObjectIdentityId(
                        transform,
                        "from ubic.gemma.model.common.protocol.HardwareApplication as hardwareApplication where hardwareApplication.securable = :securable",
                        securable );
    }

    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getAclObjectIdentityId(int, java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getMask(ubic.gemma.model.common.Securable)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getMask(java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getMask(int, ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getMask(int, java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getMasks(java.util.Collection)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getMasks(java.lang.String, java.util.Collection)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getMasks(int, java.util.Collection)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getMasks( final int transform, final java.util.Collection securables ) {
        return this
                .getMasks(
                        transform,
                        "from ubic.gemma.model.common.protocol.HardwareApplication as hardwareApplication where hardwareApplication.securables = :securables",
                        securables );
    }

    /**
     * @see ubic.gemma.model.common.protocol.HardwareApplicationDao#getMasks(int, java.lang.String,

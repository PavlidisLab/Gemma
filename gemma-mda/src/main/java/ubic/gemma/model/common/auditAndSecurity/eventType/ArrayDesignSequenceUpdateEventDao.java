 ...
 */
public interface ArrayDesignSequenceUpdateEventDao extends
        ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignAnalysisEventDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSequenceUpdateEvent from the
     * persistent store.
     */
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSequenceUpdateEvent and adds
     ...
     * {@link #create(ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSequenceUpdateEvent)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSequenceUpdateEvent and
     * adds from the passed in <code>entities</code> collection
     * 
     * @param entities the collection of
     *        ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSequenceUpdateEvent instances to create.
    ...
    /**
     * Updates the <code>arrayDesignSequenceUpdateEvent</code> instance in the persistent store.
     */
    public void update(
            ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSequenceUpdateEvent arrayDesignSequenceUpdateEvent );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSequenceUpdateEvent from
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignSequenceUpdateEvent having

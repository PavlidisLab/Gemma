 ...
 */
public interface ProtocolDao extends ubic.gemma.model.common.protocol.ParameterizableDao {
    /**
     * Loads an instance of ubic.gemma.model.common.protocol.Protocol from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.protocol.Protocol}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.protocol.Protocol and adds it to the persistent store.
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.protocol.Protocol protocol );

    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.protocol.Protocol)} with an additional flag called
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.protocol.Protocol protocol );

    /**
     * Creates a new instance of ubic.gemma.model.common.protocol.Protocol and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.protocol.Protocol instances to create.
    ...
    /**
     * Updates the <code>protocol</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.protocol.Protocol from the persistent store.
     */
    public void remove( ubic.gemma.model.common.protocol.Protocol protocol );

    /**
     * Removes the instance of ubic.gemma.model.common.protocol.Protocol having the given <code>identifier</code> from
     ...
     * query string defined in {@link #findOrCreate(ubic.gemma.model.common.protocol.Protocol)}.
     * </p>
     */
     ...
     * </p>
     */
    public Object findOrCreate( int transform, ubic.gemma.model.common.protocol.Protocol protocol );
     ...
     * {@link #findOrCreate(int, ubic.gemma.model.common.protocol.Protocol protocol)}.
     * </p>
     */
    public Object findOrCreate( int transform, String queryString, ubic.gemma.model.common.protocol.Protocol protocol );
     ...
     * string defined in {@link #find(ubic.gemma.model.common.protocol.Protocol)}.
     * </p>
     */
     ...
     * </p>
     */
    public Object find( int transform, ubic.gemma.model.common.protocol.Protocol protocol );

    /**
     * <p>
     * Does the same thing as {@link #find(boolean, ubic.gemma.model.common.protocol.Protocol)} with an additional
     * argument called <code>queryString</code>. This <code>queryString</code> argument allows you to override the
     * query string defined in {@link #find(int, ubic.gemma.model.common.protocol.Protocol protocol)}.
     * </p>
     */
    public Object find( int transform, String queryString, ubic.gemma.model.common.protocol.Protocol protocol );

 ...
 */
public interface ArrayDesignProbeRenamingEventDao extends
        ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignAnalysisEventDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignProbeRenamingEvent from the
     * persistent store.
     */
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignProbeRenamingEvent and adds
     ...
     * {@link #create(ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignProbeRenamingEvent)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignProbeRenamingEvent and
     * adds from the passed in <code>entities</code> collection
     * 
     * @param entities the collection of
     *        ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignProbeRenamingEvent instances to create.
    ...
    /**
     * Updates the <code>arrayDesignProbeRenamingEvent</code> instance in the persistent store.
     */
    public void update(
            ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignProbeRenamingEvent arrayDesignProbeRenamingEvent );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignProbeRenamingEvent from the
     * persistent store.
     */
    public void remove(
            ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignProbeRenamingEvent arrayDesignProbeRenamingEvent );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.ArrayDesignProbeRenamingEvent having

...
public interface SecurableDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #getAclObjectIdentityId(ubic.gemma.model.common.Securable)} with an additional flag
     ...
     * </p>
     */
    public Object getAclObjectIdentityId( int transform, ubic.gemma.model.common.Securable securable );
    ...
    /**
     * <p>
     * Does the same thing as {@link #getMask(ubic.gemma.model.common.Securable)} with an additional flag called
     ...
     * </p>
     */
    public Object getMask( int transform, ubic.gemma.model.common.Securable securable );
    ...
    /**
     * <p>
     * Does the same thing as {@link #getMasks(java.util.Collection)} with an additional flag called
     * <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then finder results will
     * <strong>NOT</strong> be transformed during retrieval. If this flag is any of the other constants defined here
     * then finder results <strong>WILL BE</strong> passed through an operation which can optionally transform the
     * entities (into value objects for example). By default, transformation does not occur.
     * </p>
     */
    public Object getMasks( int transform, java.util.Collection securables );

 ...
 */
public interface ProtocolApplicationDao extends ubic.gemma.model.common.protocol.ParameterizableApplicationDao {
    /**
     * Loads an instance of ubic.gemma.model.common.protocol.ProtocolApplication from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.protocol.ProtocolApplication}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.protocol.ProtocolApplication and adds it to the persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.protocol.ProtocolApplication)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.protocol.ProtocolApplication protocolApplication );

    /**
     * Creates a new instance of ubic.gemma.model.common.protocol.ProtocolApplication and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.protocol.ProtocolApplication instances to create.
    ...
    /**
     * Updates the <code>protocolApplication</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.protocol.ProtocolApplication from the persistent store.
     */
    public void remove( ubic.gemma.model.common.protocol.ProtocolApplication protocolApplication );

    /**
     * Removes the instance of ubic.gemma.model.common.protocol.ProtocolApplication having the given

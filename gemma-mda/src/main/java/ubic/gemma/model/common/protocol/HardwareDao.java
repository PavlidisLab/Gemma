 ...
 */
public interface HardwareDao extends ubic.gemma.model.common.protocol.ParameterizableDao {
    /**
     * Loads an instance of ubic.gemma.model.common.protocol.Hardware from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.protocol.Hardware}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.protocol.Hardware and adds it to the persistent store.
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.protocol.Hardware hardware );

    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.protocol.Hardware)} with an additional flag called
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.protocol.Hardware hardware );

    /**
     * Creates a new instance of ubic.gemma.model.common.protocol.Hardware and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.protocol.Hardware instances to create.
    ...
    /**
     * Updates the <code>hardware</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.protocol.Hardware from the persistent store.
     */
    public void remove( ubic.gemma.model.common.protocol.Hardware hardware );

    /**
     * Removes the instance of ubic.gemma.model.common.protocol.Hardware having the given <code>identifier</code> from
     ...
     * query string defined in {@link #findOrCreate(ubic.gemma.model.common.protocol.Hardware)}.
     * </p>
     */
     ...
     * {@link #findOrCreate(int, ubic.gemma.model.common.protocol.Hardware hardware)}.
     * </p>
     */
     ...
     * string defined in {@link #find(ubic.gemma.model.common.protocol.Hardware)}.
     * </p>
     */
     ...
     * argument called <code>queryString</code>. This <code>queryString</code> argument allows you to override the
     * query string defined in {@link #find(int, ubic.gemma.model.common.protocol.Hardware hardware)}.
     * </p>
     */

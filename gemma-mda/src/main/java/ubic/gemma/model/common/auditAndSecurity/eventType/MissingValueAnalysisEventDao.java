 ...
 */
public interface MissingValueAnalysisEventDao extends
        ubic.gemma.model.common.auditAndSecurity.eventType.ExpressionExperimentAnalysisEventDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.eventType.MissingValueAnalysisEvent from the
     * persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.auditAndSecurity.eventType.MissingValueAnalysisEvent}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.eventType.MissingValueAnalysisEvent and adds it
     ...
     * {@link #create(ubic.gemma.model.common.auditAndSecurity.eventType.MissingValueAnalysisEvent)} with an additional
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.eventType.MissingValueAnalysisEvent and adds
     * from the passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.auditAndSecurity.eventType.MissingValueAnalysisEvent
     *        instances to create.
    ...
    /**
     * Updates the <code>missingValueAnalysisEvent</code> instance in the persistent store.
     */
    public void update(
            ubic.gemma.model.common.auditAndSecurity.eventType.MissingValueAnalysisEvent missingValueAnalysisEvent );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.MissingValueAnalysisEvent from the
     * persistent store.
     */
    public void remove(
            ubic.gemma.model.common.auditAndSecurity.eventType.MissingValueAnalysisEvent missingValueAnalysisEvent );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.MissingValueAnalysisEvent having the

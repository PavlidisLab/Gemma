 ...
 */
public interface NotedReferenceDao {
    /**
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.description.NotedReference)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.description.NotedReference notedReference );

    /**
     * Creates a new instance of ubic.gemma.model.common.description.NotedReference and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.description.NotedReference instances to create.
     * @return the created instances.
     */
    public java.util.Collection create( java.util.Collection entities );

    /**
     * Creates an instance of ubic.gemma.model.common.description.NotedReference and adds it to the persistent store.
     */
    ...
    /**
     * Loads an instance of ubic.gemma.model.common.description.NotedReference from the persistent store.
     */
    public ubic.gemma.model.common.description.NotedReference load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.common.description.NotedReference}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.NotedReference having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.NotedReference from the persistent store.
     */
    ...
    /**
     * Updates the <code>notedReference</code> instance in the persistent store.
     */

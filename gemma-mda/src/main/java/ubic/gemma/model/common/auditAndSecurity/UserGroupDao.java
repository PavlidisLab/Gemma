 ...
 */
public interface UserGroupDao extends ubic.gemma.model.common.AuditableDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.UserGroup from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.auditAndSecurity.UserGroup}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.UserGroup and adds it to the persistent store.
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.auditAndSecurity.UserGroup userGroup );

    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.auditAndSecurity.UserGroup)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.auditAndSecurity.UserGroup userGroup );

    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.UserGroup and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.auditAndSecurity.UserGroup instances to create.
    ...
    /**
     * Updates the <code>userGroup</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.UserGroup from the persistent store.
     */
    public void remove( ubic.gemma.model.common.auditAndSecurity.UserGroup userGroup );

    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.UserGroup having the given
     ...
     * defined in {@link #findByUserGroupName(java.lang.String)}.
     * </p>
     */
     ...
     * <code>queryString</code>. This <code>queryString</code> argument allows you to override the query string
     * defined in {@link #findByUserGroupName(int, java.lang.String name)}.
     * </p>
     */

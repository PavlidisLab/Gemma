 ...
 */
public interface OrganizationDao extends ubic.gemma.model.common.auditAndSecurity.ContactDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.Organization from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.auditAndSecurity.Organization}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.Organization and adds it to the persistent store.
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.auditAndSecurity.Organization organization );

    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.auditAndSecurity.Organization)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.auditAndSecurity.Organization organization );

    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.Organization and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.auditAndSecurity.Organization instances to create.
    ...
    /**
     * Updates the <code>organization</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.Organization from the persistent store.
     */
    public void remove( ubic.gemma.model.common.auditAndSecurity.Organization organization );

    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.Organization having the given

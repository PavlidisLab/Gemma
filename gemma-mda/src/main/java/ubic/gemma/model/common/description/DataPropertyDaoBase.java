 ...
 */
public abstract class DataPropertyDaoBase extends ubic.gemma.model.common.description.CharacteristicPropertyDaoImpl
        implements ubic.gemma.model.common.description.DataPropertyDao {
     ...
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.description.DataProperty dataProperty ) {
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getRecipient(java.lang.Long)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getRecipient(java.lang.String, java.lang.Long)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getRecipient(int, java.lang.Long)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getRecipient( final int transform, final java.lang.Long id ) {
        return this
                .getRecipient(
                        transform,
                        "from ubic.gemma.model.common.description.DataProperty as dataProperty where dataProperty.id = :id",
                        id );
    }

    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getRecipient(int, java.lang.String, java.lang.Long)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getRecipient( final int transform, final java.lang.String queryString, final java.lang.Long id ) {
        ...
        result = transformEntity( transform, ( ubic.gemma.model.common.description.DataProperty ) result );
        return result;
    }

    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getAclObjectIdentityId(ubic.gemma.model.common.Securable)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getAclObjectIdentityId(java.lang.String,
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getAclObjectIdentityId(int,
     *      ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getAclObjectIdentityId( final int transform, final ubic.gemma.model.common.Securable securable ) {
        return this
                .getAclObjectIdentityId(
                        transform,
                        "from ubic.gemma.model.common.description.DataProperty as dataProperty where dataProperty.securable = :securable",
                        securable );
    }

    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getAclObjectIdentityId(int, java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getMask(ubic.gemma.model.common.Securable)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getMask(java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getMask(int, ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getMask(int, java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getMasks(java.util.Collection)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getMasks(java.lang.String, java.util.Collection)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getMasks(int, java.util.Collection)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getMasks( final int transform, final java.util.Collection securables ) {
        return this
                .getMasks(
                        transform,
                        "from ubic.gemma.model.common.description.DataProperty as dataProperty where dataProperty.securables = :securables",
                        securables );
    }

    /**
     * @see ubic.gemma.model.common.description.DataPropertyDao#getMasks(int, java.lang.String, java.util.Collection)
     */
    @Override
    @SuppressWarnings( { "unchecked" })

 ...
 */
public interface BibRefAnnotationDao {
    /**
    ...
    /**
     * Loads an instance of ubic.gemma.model.common.description.BibRefAnnotation from the persistent store.
     */
    public ubic.gemma.model.common.description.BibRefAnnotation load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.common.description.BibRefAnnotation}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.BibRefAnnotation having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.BibRefAnnotation from the persistent store.
     */
    ...
    /**
     * Updates the <code>bibRefAnnotation</code> instance in the persistent store.
     */

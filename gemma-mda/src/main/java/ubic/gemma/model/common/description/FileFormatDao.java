...
public interface FileFormatDao {
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.description.FileFormat and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.description.FileFormat instances to create.
    ...
    /**
     * <p>
     * Does the same thing as {@link #findByFormatIdentifier(java.lang.String)} with an additional flag called
     ...
     * </p>
     */
    public Object findByFormatIdentifier( int transform, java.lang.String formatIdentifier );

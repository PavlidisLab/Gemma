...
public interface PublicationTypeDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.description.PublicationType)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.description.PublicationType publicationType );

    /**
     * Creates a new instance of ubic.gemma.model.common.description.PublicationType and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.description.PublicationType instances to create.
     * @return the created instances.
     */
    public java.util.Collection create( java.util.Collection entities );

    /**
     * Creates an instance of ubic.gemma.model.common.description.PublicationType and adds it to the persistent store.
     */
    ...
    /**
     * Loads an instance of ubic.gemma.model.common.description.PublicationType from the persistent store.
     */
    public ubic.gemma.model.common.description.PublicationType load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.common.description.PublicationType}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.PublicationType having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.PublicationType from the persistent store.
     */
    ...
    /**
     * Updates the <code>publicationType</code> instance in the persistent store.
     */

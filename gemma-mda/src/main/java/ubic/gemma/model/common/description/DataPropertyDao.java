 ...
 */
public interface DataPropertyDao extends ubic.gemma.model.common.description.CharacteristicPropertyDao {
    /**
     * Loads an instance of ubic.gemma.model.common.description.DataProperty from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.description.DataProperty}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.description.DataProperty and adds it to the persistent store.
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.description.DataProperty dataProperty );

    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.description.DataProperty)} with an additional flag
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.description.DataProperty dataProperty );

    /**
     * Creates a new instance of ubic.gemma.model.common.description.DataProperty and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.description.DataProperty instances to create.
    ...
    /**
     * Updates the <code>dataProperty</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.DataProperty from the persistent store.
     */
    public void remove( ubic.gemma.model.common.description.DataProperty dataProperty );

    /**
     * Removes the instance of ubic.gemma.model.common.description.DataProperty having the given <code>identifier</code>

 ...
 */
public interface OKStatusFlagEventDao extends ubic.gemma.model.common.auditAndSecurity.eventType.StatusFlagEventDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.eventType.OKStatusFlagEvent from the persistent
     * store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.auditAndSecurity.eventType.OKStatusFlagEvent}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.eventType.OKStatusFlagEvent and adds it to the
     * persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.auditAndSecurity.eventType.OKStatusFlagEvent)} with
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.eventType.OKStatusFlagEvent and adds from the
     * passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.auditAndSecurity.eventType.OKStatusFlagEvent instances
     *        to create.
    ...
    /**
     * Updates the <code>oKStatusFlagEvent</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.OKStatusFlagEvent from the persistent
     * store.
     */
    public void remove( ubic.gemma.model.common.auditAndSecurity.eventType.OKStatusFlagEvent oKStatusFlagEvent );

    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.OKStatusFlagEvent having the given

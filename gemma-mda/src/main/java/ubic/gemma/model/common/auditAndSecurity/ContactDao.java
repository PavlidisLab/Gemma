 ...
 */
public interface ContactDao extends ubic.gemma.model.common.AuditableDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.Contact from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.auditAndSecurity.Contact}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.Contact and adds it to the persistent store.
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.auditAndSecurity.Contact contact );

    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.auditAndSecurity.Contact)} with an additional flag
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.auditAndSecurity.Contact contact );

    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.Contact and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.auditAndSecurity.Contact instances to create.
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.Contact from the persistent store.
     */
    public void remove( ubic.gemma.model.common.auditAndSecurity.Contact contact );

    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.Contact having the given <code>identifier</code>
     ...
     * query string defined in {@link #findOrCreate(ubic.gemma.model.common.auditAndSecurity.Contact)}.
     * </p>
     */
     ...
     * {@link #findOrCreate(int, ubic.gemma.model.common.auditAndSecurity.Contact contact)}.
     * </p>
     */
     ...
     * argument called <code>queryString</code>. This <code>queryString</code> argument allows you to override the
     * query string defined in {@link #find(ubic.gemma.model.common.auditAndSecurity.Contact)}.
     * </p>
     */
     ...
     * defined in {@link #findByEmail(java.lang.String)}.
     * </p>
     */
     ...
     * <code>queryString</code>. This <code>queryString</code> argument allows you to override the query string
     * defined in {@link #findByEmail(int, java.lang.String email)}.
     * </p>
     */

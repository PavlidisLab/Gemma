 ...
 */
public interface FailedLinkAnalysisEventDao extends
        ubic.gemma.model.common.auditAndSecurity.eventType.LinkAnalysisEventDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.eventType.FailedLinkAnalysisEvent from the
     * persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.auditAndSecurity.eventType.FailedLinkAnalysisEvent}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.eventType.FailedLinkAnalysisEvent and adds it to
     ...
     * {@link #create(ubic.gemma.model.common.auditAndSecurity.eventType.FailedLinkAnalysisEvent)} with an additional
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.eventType.FailedLinkAnalysisEvent and adds
     * from the passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.auditAndSecurity.eventType.FailedLinkAnalysisEvent
     *        instances to create.
    ...
    /**
     * Updates the <code>failedLinkAnalysisEvent</code> instance in the persistent store.
     */
    public void update(
            ubic.gemma.model.common.auditAndSecurity.eventType.FailedLinkAnalysisEvent failedLinkAnalysisEvent );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.FailedLinkAnalysisEvent from the
     * persistent store.
     */
    public void remove(
            ubic.gemma.model.common.auditAndSecurity.eventType.FailedLinkAnalysisEvent failedLinkAnalysisEvent );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.FailedLinkAnalysisEvent having the

 ...
 */
public interface ParameterizableDao extends ubic.gemma.model.common.AuditableDao {
    /**
     * Loads an instance of ubic.gemma.model.common.protocol.Parameterizable from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.protocol.Parameterizable}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.protocol.Parameterizable and adds it to the persistent store.
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.protocol.Parameterizable parameterizable );

    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.protocol.Parameterizable)} with an additional flag
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.protocol.Parameterizable parameterizable );

    /**
     * Creates a new instance of ubic.gemma.model.common.protocol.Parameterizable and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.protocol.Parameterizable instances to create.
    ...
    /**
     * Updates the <code>parameterizable</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.protocol.Parameterizable from the persistent store.
     */
    public void remove( ubic.gemma.model.common.protocol.Parameterizable parameterizable );

    /**
     * Removes the instance of ubic.gemma.model.common.protocol.Parameterizable having the given <code>identifier</code>

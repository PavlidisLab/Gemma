 ...
 */
public abstract class ParameterDaoBase extends ubic.gemma.model.common.DescribableDaoImpl implements
     ...
     */
    public ubic.gemma.model.common.Securable create( ubic.gemma.model.common.protocol.Parameter parameter ) {
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getRecipient(java.lang.Long)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getRecipient(java.lang.String, java.lang.Long)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getRecipient(int, java.lang.Long)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getRecipient( final int transform, final java.lang.Long id ) {
        return this.getRecipient( transform,
                "from ubic.gemma.model.common.protocol.Parameter as parameter where parameter.id = :id", id );
    }

    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getRecipient(int, java.lang.String, java.lang.Long)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getRecipient( final int transform, final java.lang.String queryString, final java.lang.Long id ) {
        ...
        result = transformEntity( transform, ( ubic.gemma.model.common.protocol.Parameter ) result );
        return result;
    }

    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getAclObjectIdentityId(ubic.gemma.model.common.Securable)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getAclObjectIdentityId(java.lang.String,
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getAclObjectIdentityId(int, ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getAclObjectIdentityId( final int transform, final ubic.gemma.model.common.Securable securable ) {
        return this.getAclObjectIdentityId( transform,
                "from ubic.gemma.model.common.protocol.Parameter as parameter where parameter.securable = :securable",
                securable );
    }

    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getAclObjectIdentityId(int, java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getMask(ubic.gemma.model.common.Securable)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getMask(java.lang.String, ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getMask(int, ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getMask(int, java.lang.String,
     *      ubic.gemma.model.common.Securable)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getMasks(java.util.Collection)
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getMasks(java.lang.String, java.util.Collection)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getMasks(int, java.util.Collection)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
    public Object getMasks( final int transform, final java.util.Collection securables ) {
        return this
                .getMasks(
                        transform,
                        "from ubic.gemma.model.common.protocol.Parameter as parameter where parameter.securables = :securables",
                        securables );
    }

    /**
     * @see ubic.gemma.model.common.protocol.ParameterDao#getMasks(int, java.lang.String, java.util.Collection)
     */
    @Override
    @SuppressWarnings( { "unchecked" })
     ...
     * <code>ubic.gemma.model.common.protocol.ParameterDao</code>, please note that the {@link #TRANSFORM_NONE}

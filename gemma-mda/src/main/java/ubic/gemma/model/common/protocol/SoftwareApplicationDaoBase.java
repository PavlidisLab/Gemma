...
public abstract class SoftwareApplicationDaoBase extends
    ...
    public Collection<? extends SoftwareApplication > load( Collection<Long> ids ) {
        return this.getHibernateTemplate().findByNamedParam( "from SoftwareApplicationImpl where id in (:ids)", "ids", ids );
    }

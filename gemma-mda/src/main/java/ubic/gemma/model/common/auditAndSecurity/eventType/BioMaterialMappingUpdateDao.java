 ...
 */
public interface BioMaterialMappingUpdateDao extends
        ubic.gemma.model.common.auditAndSecurity.eventType.ExpressionExperimentAnalysisEventDao {
    /**
     * Loads an instance of ubic.gemma.model.common.auditAndSecurity.eventType.BioMaterialMappingUpdate from the
     * persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.auditAndSecurity.eventType.BioMaterialMappingUpdate}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.auditAndSecurity.eventType.BioMaterialMappingUpdate and adds it to
     ...
     * {@link #create(ubic.gemma.model.common.auditAndSecurity.eventType.BioMaterialMappingUpdate)} with an additional
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.auditAndSecurity.eventType.BioMaterialMappingUpdate and adds
     * from the passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.auditAndSecurity.eventType.BioMaterialMappingUpdate
     *        instances to create.
    ...
    /**
     * Updates the <code>bioMaterialMappingUpdate</code> instance in the persistent store.
     */
    public void update(
            ubic.gemma.model.common.auditAndSecurity.eventType.BioMaterialMappingUpdate bioMaterialMappingUpdate );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.BioMaterialMappingUpdate from the
     * persistent store.
     */
    public void remove(
            ubic.gemma.model.common.auditAndSecurity.eventType.BioMaterialMappingUpdate bioMaterialMappingUpdate );
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.auditAndSecurity.eventType.BioMaterialMappingUpdate having the

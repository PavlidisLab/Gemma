 ...
 */
public interface ParameterizableApplicationDao extends ubic.gemma.model.common.DescribableDao {
    /**
     * Loads an instance of ubic.gemma.model.common.protocol.ParameterizableApplication from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.protocol.ParameterizableApplication}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.protocol.ParameterizableApplication and adds it to the persistent
     * store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.protocol.ParameterizableApplication)} with an
    ...
    /**
     * Creates a new instance of ubic.gemma.model.common.protocol.ParameterizableApplication and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.protocol.ParameterizableApplication instances to
     *        create.
    ...
    /**
     * Updates the <code>parameterizableApplication</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.protocol.ParameterizableApplication from the persistent store.
     */
    public void remove( ubic.gemma.model.common.protocol.ParameterizableApplication parameterizableApplication );

    /**
     * Removes the instance of ubic.gemma.model.common.protocol.ParameterizableApplication having the given

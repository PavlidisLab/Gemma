 ...
 * <code>ubic.gemma.model.common.protocol.ProtocolApplication</code>.
 * </p>
 * 
...
public abstract class ProtocolApplicationDaoBase extends HibernateDaoSupport implements
                ...
                new org.springframework.orm.hibernate3.HibernateCallback<Object>() {
                    public Object doInHibernate( org.hibernate.Session session )
                        ...
                        for ( java.util.Iterator entityIterator = entities.iterator(); entityIterator.hasNext(); ) {
                            create( transform, ( ubic.gemma.model.common.protocol.ProtocolApplication ) entityIterator
                                    .next() );
                        }
                        return null;
                    }
    ...
    /**
     * @see ubic.gemma.model.common.protocol.ProtocolApplicationDao#create(int transform,
     *      ubic.gemma.model.common.protocol.ProtocolApplication)
     */
    public Object create( final int transform,
            final ubic.gemma.model.common.protocol.ProtocolApplication protocolApplication ) {
        if ( protocolApplication == null ) {
            throw new IllegalArgumentException( "ProtocolApplication.create - 'protocolApplication' can not be null" );
        }
        this.getHibernateTemplate().save( protocolApplication );
        return this.transformEntity( transform, protocolApplication );
    }
    ...
    public ProtocolApplication load( final int transform, final java.lang.Long id ) {
        ...
        return ( ProtocolApplication ) transformEntity( transform,
                ( ubic.gemma.model.common.protocol.ProtocolApplication ) entity );
    }
        ...
        this.getHibernateTemplate().executeWithNativeSession(
                new org.springframework.orm.hibernate3.HibernateCallback<Object>() {
                    public Object doInHibernate( org.hibernate.Session session )
                            throws org.hibernate.HibernateException {
                        for ( java.util.Iterator entityIterator = entities.iterator(); entityIterator.hasNext(); ) {
                            update( ( ubic.gemma.model.common.protocol.ProtocolApplication ) entityIterator.next() );
                        }
                        return null;
                    }
                } );
     ...
     * <code>ubic.gemma.model.common.protocol.ProtocolApplicationDao</code>, please note that the
     ...
     * 
     * @param transform one of the constants declared in {@link ubic.gemma.model.common.protocol.ProtocolApplicationDao}
     * @param entity an entity that was found
     * @return the transformed entity (i.e. new value object, etc)
     * @see #transformEntities(int,java.util.Collection)
     */
    protected Object transformEntity( final int transform,
            final ubic.gemma.model.common.protocol.ProtocolApplication entity ) {
        Object target = null;
        if ( entity != null ) {
            switch ( transform ) {
                case TRANSFORM_NONE: // fall-through

 ...
 */
public interface MedicalSubjectHeadingDao extends ubic.gemma.model.common.description.BibRefAnnotationDao {
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.description.MedicalSubjectHeading)} with an
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.description.MedicalSubjectHeading medicalSubjectHeading );

    /**
     * Creates a new instance of ubic.gemma.model.common.description.MedicalSubjectHeading and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.description.MedicalSubjectHeading instances to create.
     * @return the created instances.
     */
    public java.util.Collection create( java.util.Collection entities );

    /**
     * Creates an instance of ubic.gemma.model.common.description.MedicalSubjectHeading and adds it to the persistent
     * store.
     */
    ...
    /**
     * Loads an instance of ubic.gemma.model.common.description.MedicalSubjectHeading from the persistent store.
     */
    public ubic.gemma.model.common.description.BibRefAnnotation load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.common.description.MedicalSubjectHeading}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.MedicalSubjectHeading having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.description.MedicalSubjectHeading from the persistent store.
     */
    ...
    /**
     * Updates the <code>medicalSubjectHeading</code> instance in the persistent store.
     */

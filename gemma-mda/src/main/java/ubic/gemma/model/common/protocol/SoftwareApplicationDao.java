 ...
 */
public interface SoftwareApplicationDao extends ubic.gemma.model.common.protocol.ParameterizableApplicationDao {
    /**
     * Loads an instance of ubic.gemma.model.common.protocol.SoftwareApplication from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.common.protocol.SoftwareApplication}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.common.protocol.SoftwareApplication and adds it to the persistent store.
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.common.protocol.SoftwareApplication)} with an additional
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.common.protocol.SoftwareApplication softwareApplication );

    /**
     * Creates a new instance of ubic.gemma.model.common.protocol.SoftwareApplication and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.common.protocol.SoftwareApplication instances to create.
    ...
    /**
     * Updates the <code>softwareApplication</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.common.protocol.SoftwareApplication from the persistent store.
     */
    public void remove( ubic.gemma.model.common.protocol.SoftwareApplication softwareApplication );

    /**
     * Removes the instance of ubic.gemma.model.common.protocol.SoftwareApplication having the given

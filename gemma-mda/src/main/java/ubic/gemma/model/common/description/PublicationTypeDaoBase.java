 ...
 * <code>ubic.gemma.model.common.description.PublicationType</code>.
 * </p>
 * 
 * @see ubic.gemma.model.common.description.PublicationType
 */
public abstract class PublicationTypeDaoBase extends org.springframework.orm.hibernate3.support.HibernateDaoSupport
                ...
                new org.springframework.orm.hibernate3.HibernateCallback<Object>() {
                    public Object doInHibernate( org.hibernate.Session session )
                        ...
                        for ( java.util.Iterator entityIterator = entities.iterator(); entityIterator.hasNext(); ) {
                            create( transform, ( ubic.gemma.model.common.description.PublicationType ) entityIterator
                                    .next() );
                        }
                        return null;
                    }
    ...
    public Object load( final int transform, final java.lang.Long id ) {
        if ( id == null ) {
            throw new IllegalArgumentException( "PublicationType.load - 'id' can not be null" );
        }
        final Object entity = this.getHibernateTemplate().get(
                ubic.gemma.model.common.description.PublicationTypeImpl.class, id );
        return transformEntity( transform, ( ubic.gemma.model.common.description.PublicationType ) entity );
    }

    /**
     * @see ubic.gemma.model.common.description.PublicationTypeDao#load(java.lang.Long)
     */
    public ubic.gemma.model.common.description.PublicationType load( java.lang.Long id ) {
        return ( ubic.gemma.model.common.description.PublicationType ) this.load( TRANSFORM_NONE, id );
    }
    ...
    /**
     * @see ubic.gemma.model.common.description.PublicationTypeDao#loadAll(int)
     */
    public java.util.Collection loadAll( final int transform ) {
        final java.util.Collection results = this.getHibernateTemplate().loadAll(
                ubic.gemma.model.common.description.PublicationTypeImpl.class );
    ...
    public void remove( java.lang.Long id ) {
        if ( id == null ) {
            throw new IllegalArgumentException( "PublicationType.remove - 'id' can not be null" );
        }
        ubic.gemma.model.common.description.PublicationType entity = this.load( id );
        if ( entity != null ) {
            this.remove( entity );
        }
    }
    ...
    /**
     * @see ubic.gemma.model.common.description.PublicationTypeDao#remove(java.util.Collection)
     */
    public void remove( java.util.Collection entities ) {
        if ( entities == null ) {
            throw new IllegalArgumentException( "PublicationType.remove - 'entities' can not be null" );
        }
    ...
    protected Object transformEntity( final int transform,
            final ubic.gemma.model.common.description.PublicationType entity ) {
        Object target = null;
        if ( entity != null ) {
            switch ( transform ) {
                case TRANSFORM_NONE: // fall-through

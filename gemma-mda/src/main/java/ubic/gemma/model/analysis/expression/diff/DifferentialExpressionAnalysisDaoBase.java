...
public abstract class DifferentialExpressionAnalysisDaoBase extends
    ...
    public java.util.Collection find( final ubic.gemma.model.genome.Gene gene,
        ...
        try {
            ...
            throw new java.lang.RuntimeException(
                    "Error performing 'ubic.gemma.model.analysis.expression.diff.DifferentialExpressionAnalysisDao.find(ubic.gemma.model.genome.Gene gene, ubic.gemma.model.expression.experiment.ExpressionExperiment experimentAnalyzed)' --> "
                            + th, th );
        }
    }

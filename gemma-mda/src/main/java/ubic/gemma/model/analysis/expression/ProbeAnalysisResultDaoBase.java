 ...
 * <code>ubic.gemma.model.analysis.expression.ProbeAnalysisResult</code>.
 * </p>
 * 
 * @see ubic.gemma.model.analysis.expression.ProbeAnalysisResult
 */
public abstract class ProbeAnalysisResultDaoBase extends
        ubic.gemma.model.analysis.expression.diff.DifferentialExpressionAnalysisResultDaoImpl implements
    ...
    public Object load( final int transform, final java.lang.Long id ) {
        ...
        return transformEntity( transform, ( ubic.gemma.model.analysis.expression.ProbeAnalysisResult ) entity );
    }

    /**
     * @see ubic.gemma.model.analysis.expression.ProbeAnalysisResultDao#load(java.lang.Long)
     */
    @Override
    public ubic.gemma.model.analysis.AnalysisResult load( java.lang.Long id ) {
        return ( ubic.gemma.model.analysis.expression.ProbeAnalysisResult ) this.load( TRANSFORM_NONE, id );
    }

    /**
     * @see ubic.gemma.model.analysis.expression.ProbeAnalysisResultDao#loadAll()
     */
    @Override
    ...
    /**
     * @see ubic.gemma.model.analysis.expression.ProbeAnalysisResultDao#loadAll(int)
     */
    @Override
    public java.util.Collection loadAll( final int transform ) {
        final java.util.Collection results = this.getHibernateTemplate().loadAll(
                ubic.gemma.model.analysis.expression.ProbeAnalysisResultImpl.class );
    ...
    public void remove( java.lang.Long id ) {
        ...
        ubic.gemma.model.analysis.expression.ProbeAnalysisResult entity = ( ubic.gemma.model.analysis.expression.ProbeAnalysisResult ) this
                .load( id );
        if ( entity != null ) {
            this.remove( entity );
        }
     ...
     *        {@link ubic.gemma.model.analysis.expression.ProbeAnalysisResultDao}
     * @param entity an entity that was found
     * @return the transformed entity (i.e. new value object, etc)
     * @see #transformEntities(int,java.util.Collection)
     */
    protected Object transformEntity( final int transform,
            final ubic.gemma.model.analysis.expression.ProbeAnalysisResult entity ) {
        Object target = null;
        if ( entity != null ) {
            switch ( transform ) {

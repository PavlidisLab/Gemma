 ...
 */
public interface ExpressionAnalysisDao extends ubic.gemma.model.analysis.AnalysisDao {
    /**
     * Loads an instance of ubic.gemma.model.analysis.expression.ExpressionAnalysis from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.analysis.expression.ExpressionAnalysis}.
     * 
    ...
    /**
     * Updates the <code>expressionAnalysis</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of ubic.gemma.model.analysis.expression.ExpressionAnalysis from the persistent store.
     */
    public void remove( ubic.gemma.model.analysis.expression.ExpressionAnalysis expressionAnalysis );

    /**
     * Removes the instance of ubic.gemma.model.analysis.expression.ExpressionAnalysis having the given

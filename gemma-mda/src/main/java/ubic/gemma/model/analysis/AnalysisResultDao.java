...
public interface AnalysisResultDao {
    ...
    /**
     * Loads an instance of ubic.gemma.model.analysis.AnalysisResult from the persistent store.
     */
    public ubic.gemma.model.analysis.AnalysisResult load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.analysis.AnalysisResult}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.analysis.AnalysisResult having the given <code>identifier</code> from
    ...
    /**
     * Removes the instance of ubic.gemma.model.analysis.AnalysisResult from the persistent store.
     */
    ...
    /**
     * Updates the <code>analysisResult</code> instance in the persistent store.
     */

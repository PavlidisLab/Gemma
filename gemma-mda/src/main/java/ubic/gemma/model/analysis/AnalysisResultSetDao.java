 ...
 */
public interface AnalysisResultSetDao {
    /**
    ...
    /**
     * Loads an instance of ubic.gemma.model.analysis.AnalysisResultSet from the persistent store.
     */
    public ubic.gemma.model.analysis.AnalysisResultSet load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.analysis.AnalysisResultSet}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.analysis.AnalysisResultSet having the given <code>identifier</code> from
    ...
    /**
     * Removes the instance of ubic.gemma.model.analysis.AnalysisResultSet from the persistent store.
     */
    ...
    /**
     * Updates the <code>analysisResultSet</code> instance in the persistent store.
     */

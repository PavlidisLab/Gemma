...
public abstract class GeneCoexpressionAnalysisDaoBase extends
    ...
    public void remove( java.lang.Long id ) {
        ...
        ubic.gemma.model.analysis.expression.coexpression.GeneCoexpressionAnalysis entity = ( ubic.gemma.model.analysis.expression.coexpression.GeneCoexpressionAnalysis ) this
                .load( id );
        if ( entity != null ) {
            this.remove( entity );
        }

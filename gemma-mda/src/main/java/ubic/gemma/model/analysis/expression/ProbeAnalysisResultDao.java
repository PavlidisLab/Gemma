 ...
 */
public interface ProbeAnalysisResultDao extends
        ubic.gemma.model.analysis.expression.diff.DifferentialExpressionAnalysisResultDao {
    /**
     * <p>
     * Does the same thing as {@link #create(ubic.gemma.model.analysis.expression.ProbeAnalysisResult)} with an
     ...
     * </p>
     */
    public Object create( int transform, ubic.gemma.model.analysis.expression.ProbeAnalysisResult probeAnalysisResult );

    /**
     * Creates a new instance of ubic.gemma.model.analysis.expression.ProbeAnalysisResult and adds from the passed in
     * <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.analysis.expression.ProbeAnalysisResult instances to create.
     * @return the created instances.
     */
    public java.util.Collection create( java.util.Collection entities );

    /**
     * Creates an instance of ubic.gemma.model.analysis.expression.ProbeAnalysisResult and adds it to the persistent
     * store.
     */
    ...
    /**
     * Loads an instance of ubic.gemma.model.analysis.expression.ProbeAnalysisResult from the persistent store.
     */
    public ubic.gemma.model.analysis.AnalysisResult load( java.lang.Long id );

    /**
     * Loads all entities of type {@link ubic.gemma.model.analysis.expression.ProbeAnalysisResult}.
     * 
    ...
    /**
     * Removes the instance of ubic.gemma.model.analysis.expression.ProbeAnalysisResult having the given
    ...
    /**
     * Removes the instance of ubic.gemma.model.analysis.expression.ProbeAnalysisResult from the persistent store.
     */
    ...
    /**
     * Updates the <code>probeAnalysisResult</code> instance in the persistent store.
     */

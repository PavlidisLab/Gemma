...
public interface ProbeCoexpressionAnalysisDao extends
    ...
    /**
     * Loads an instance of ubic.gemma.model.analysis.expression.coexpression.ProbeCoexpressionAnalysis from the
     * persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link ubic.gemma.model.analysis.expression.coexpression.ProbeCoexpressionAnalysis}.
     * 
    ...
    /**
     * Creates an instance of ubic.gemma.model.analysis.expression.coexpression.ProbeCoexpressionAnalysis and adds it to
     ...
     * {@link #create(ubic.gemma.model.analysis.expression.coexpression.ProbeCoexpressionAnalysis)} with an additional
    ...
    /**
     * Creates a new instance of ubic.gemma.model.analysis.expression.coexpression.ProbeCoexpressionAnalysis and adds
     * from the passed in <code>entities</code> collection
     * 
     * @param entities the collection of ubic.gemma.model.analysis.expression.coexpression.ProbeCoexpressionAnalysis
     *        instances to create.
    ...
    /**
     * Updates the <code>probeCoexpressionAnalysis</code> instance in the persistent store.
     */
    public void update(
            ubic.gemma.model.analysis.expression.coexpression.ProbeCoexpressionAnalysis probeCoexpressionAnalysis );
    ...
    /**
     * Removes the instance of ubic.gemma.model.analysis.expression.coexpression.ProbeCoexpressionAnalysis from the
     * persistent store.
     */
    public void remove(
            ubic.gemma.model.analysis.expression.coexpression.ProbeCoexpressionAnalysis probeCoexpressionAnalysis );
    ...
    /**
     * Removes the instance of ubic.gemma.model.analysis.expression.coexpression.ProbeCoexpressionAnalysis having the

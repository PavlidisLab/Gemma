 ...
 * @version $Id$
 */
public class AuditTrailServiceImpl extends edu.columbia.gemma.common.auditAndSecurity.AuditTrailServiceBase {

    private static Log log = LogFactory.getLog( AuditTrailServiceImpl.class.getName() );

    /**
     * @see edu.columbia.gemma.common.auditAndSecurity.AuditTrailService#audit(edu.columbia.gemma.common.Describable,

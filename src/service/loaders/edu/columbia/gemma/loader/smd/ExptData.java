...
import edu.columbia.gemma.loader.smd.model.SMDPerson;
import edu.columbia.gemma.loader.smd.model.SMDQuantitationType;

/**
 * Parse a SMD data file (for one microarray assay) to get out information about the BioAssay, and optionally get the data into a String matrix format.
 ...
 * </ul>
 * <p>We're not much interested in the sequence annotations contained in the files, we do our own.
 * 
 * <p>
 ...
 * 
 * <h2>Column Header</h2>
 * <p>This is a single line.
 * <p>
 * According to {@link http://genome-www5.stanford.edu/help/FAQ.shtml#Column%20Names}. (the
 * software used is listed in the file). Here are the headings from a test file (and their interpretations). We should
 * not assume these are always the same...but for now we will. 'blank' means it is blank in files we looked at. See also
...
public class ExptData {
   ...
   public ExptData( SMDBioAssay exp ) {
      contact = new SMDPerson();
      bioAssay = exp;
      qTypes = new HashSet();
   }
   ...
   public void read( String fileName ) throws IOException {
      ...
      if ( fileName.endsWith( ".gz" ) ) {
         stream = new GZIPInputStream( new FileInputStream( infile ) );
      } else {
   ...
   public void read( InputStream stream ) throws IOException {
      ...
      String[] headings;
      int limit = 0; // how many fields there are.
      String[] data;

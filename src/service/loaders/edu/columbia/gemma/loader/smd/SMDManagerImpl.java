...
import edu.columbia.common.auditAndSecurity.PersonDao;
import edu.columbia.common.bqs.BibliographicReference;
import edu.columbia.common.bqs.BibliographicReferenceDao;
import edu.columbia.common.description.DescriptionDao;
import edu.columbia.common.description.File;
import edu.columbia.common.description.FileDao;
import edu.columbia.common.description.FileFormatDao;
import edu.columbia.expression.bioAssay.BioAssay;
import edu.columbia.expression.bioAssay.BioAssayDao;
import edu.columbia.expression.experiment.ExpressionExperiment;
import edu.columbia.expression.experiment.ExpressionExperimentDao;
...
public class SMDManagerImpl implements SMDManager {
    ...
    * (non-Javadoc)
    * 
    * @see edu.columbia.gemma.loader.smd.SMDManager#getPublications(edu.columbia.sequence.gene.Taxon)
    */
    ...
    * (non-Javadoc)
    * 
    * @see edu.columbia.gemma.loader.smd.SMDManager#getNewPublications(edu.columbia.sequence.gene.Taxon)
    */
    ...
    * (non-Javadoc)
    * 
    * @see edu.columbia.gemma.loader.smd.SMDManager#getExperiment(edu.columbia.expression.experiment.Experiment)
    */
    ...
    * (non-Javadoc)
    * 
    * @see edu.columbia.gemma.loader.smd.SMDManager#getExperiments(edu.columbia.sequence.gene.Taxon)
    */
    ...
    * (non-Javadoc)
    * 
    * @see edu.columbia.gemma.loader.smd.SMDManager#getNewExperiments(edu.columbia.sequence.gene.Taxon)
    */
    ...
    * (non-Javadoc)
    * 
    * @see edu.columbia.gemma.loader.smd.SMDManager#getExperiment(edu.columbia.common.bqs.BibliographicReference)
    */
    ...
    * (non-Javadoc)
    * 
    * @see edu.columbia.gemma.loader.smd.SMDManager#getBioAssays(edu.columbia.expression.experiment.Experiment)
    */
    ...
    * (non-Javadoc)
    * 
    * @see edu.columbia.gemma.loader.smd.SMDManager#getBioAssay(edu.columbia.expression.bioAssay.BioAssay)
    */
   ...
   /* (non-Javadoc)
    * @see edu.columbia.gemma.loader.smd.SMDManager#fetchPublications(edu.columbia.sequence.gene.Taxon)
    */
   ...
   /* (non-Javadoc)
    * @see edu.columbia.gemma.loader.smd.SMDManager#fetchNewPublications(edu.columbia.sequence.gene.Taxon)
    */
   ...
   /* (non-Javadoc)
    * @see edu.columbia.gemma.loader.smd.SMDManager#fetchExperiment(edu.columbia.expression.experiment.ExpressionExperiment)
    */
   ...
   /* (non-Javadoc)
    * @see edu.columbia.gemma.loader.smd.SMDManager#fetchExperiments(edu.columbia.sequence.gene.Taxon)
    */
   ...
   /* (non-Javadoc)
    * @see edu.columbia.gemma.loader.smd.SMDManager#fetchNewExperiments(edu.columbia.sequence.gene.Taxon)
    */
   ...
   /* (non-Javadoc)
    * @see edu.columbia.gemma.loader.smd.SMDManager#fetchExperiment(edu.columbia.common.bqs.BibliographicReference)
    */
   ...
   /* (non-Javadoc)
    * @see edu.columbia.gemma.loader.smd.SMDManager#fetchBioAssays(edu.columbia.expression.experiment.ExpressionExperiment)
    */
   ...
   /* (non-Javadoc)
    * @see edu.columbia.gemma.loader.smd.SMDManager#fetchBioAssay(edu.columbia.expression.bioAssay.BioAssay)
    */

...
Gemma.Metaheatmap.ColorLegend = Ext.extend( Ext.Window,
   {
      ...
      /**
       * @memberOf Gemma.Metaheatmap.ColorLegend
       */
      ...
      drawCell_ : function( x, y, size, color, transparency ) {
         ...
         this.ctx.fillRect( x + size / 2 - innerBoxSize / 2, y + size / 2 - innerBoxSize / 2, innerBoxSize,
            innerBoxSize );
      },
      ...
      drawTestedButNotSignificant_ : function( x, y, size ) {
         ...
         this.ctx.strokeRect( x + size / 2 - innerBoxWidth / 2, y + size / 2 - innerBoxHeight / 2, innerBoxWidth,
            innerBoxHeight );
      }

...
Gemma.ExpressionExperimentsSummaryPanel = Ext
   .extend(
      Ext.Panel,
      {
         ...
         /*
          * tpl: new Ext.XTemplate( '<table>', '<tr><td></td><td>Total</td><td>Updated</td><td>New</td></tr>', '<tr><td><a
          * href="/Gemma/expressionExperiment/showAllExpressionExperiments.html">', 'Expression Experiments</a></td><td><b>{expressionExperimentCount}</td>', '<td>{updatedExpressionExperimentCount}</td>', '<td>{newExpressionExperimentCount}</b></td></tr>', '<tpl
          * for="sortedCountsPerTaxon">', '<tr><td><a
          * href="/Gemma/expressionExperiment/showAllExpressionExperiments.html?taxonId={taxonId}">', '{taxonName}</a></td><td>{totalCount}</td><td>{updatedCount}</td><td>{newCount}</td></tr>', '</tpl>', '</table>'),
          */
         ...
         tpl : new Ext.XTemplate(
            '<div id="dataSummaryTable">'
               ...
               + '<a href="/Gemma/arrays/showAllArrayDesigns.html">' + '<b>{arrayDesignCount}</b></a>' + '</td>'

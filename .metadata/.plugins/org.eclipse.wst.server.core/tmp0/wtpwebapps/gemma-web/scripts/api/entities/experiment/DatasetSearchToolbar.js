...
Gemma.DatasetSearchToolBar = Ext.extend( Ext.Toolbar, {
   ...
   /**
    * @memberOf Gemma.DatasetSearchToolBar
    */
...
Gemma.DataSetSearchAndGrabToolbar = Ext.extend( Gemma.DatasetSearchToolBar, {
   ...
   addSelections : function( sels ) {
      if ( sels.length > 0 ) {
         ...
         /*
          * This doesn't handle the case where the currently selected EESet taxon doesn't match this one - we're just
          * matching on what is already in the targetGrid.
          */

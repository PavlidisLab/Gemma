...
Gemma.MetaAnalysisShowResultPanel = Ext
   .extend(
      Gemma.WizardTabPanelItemPanel,
      {
         ...
         initComponent : function() {
            ...
            var thisPanelItems = [ resultPanel ];

            // If this panel is not for showing meta-analysis, add buttons to the bottom panel for working on
            // meta-analysis.
                                       ...
                                       .push( {
                                          callback : function( taskId ) {
                                             ...
                                             task
                                                .on(
                                                   'task-completed',
                                                   function( metaAnalysisReturned ) {
                                                      // Assume if it is null, saving result is NOT successful.
                                                      if ( metaAnalysisReturned === null ) {
                                                         Ext.Msg
                                                            .alert(
                                                               Gemma.HelpText.WidgetDefaults.MetaAnalysisShowResultPanel.ErrorTitle.resultSetsNotSaved,
                        ...
                        callParams
                           .push( {
                              callback : function( taskId ) {
                                 ...
                                 task
                                    .on(
                                       'task-failed',
                                       function() {
                                          // Argument data is not used because data is Java exception class name which
                                          // is not
                                          // useful to the user.
                                          resultPanel
                                             .clear( Gemma.HelpText.WidgetDefaults.MetaAnalysisShowResultPanel.ErrorMessage.resultSetsNotAnalyzed );
                              ...
                              errorHandler : function( error ) {
                                 Ext.Msg
                                    .alert(
                                       Gemma.HelpText.WidgetDefaults.MetaAnalysisShowResultPanel.ErrorTitle.resultSetsNotAnalyzed,
                                       error );
                              }.createDelegate( this )
                           } );

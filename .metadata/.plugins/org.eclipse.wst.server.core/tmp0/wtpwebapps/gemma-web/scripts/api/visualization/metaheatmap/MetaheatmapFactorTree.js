...
/**
 * 
 * The list of factors that shows up in the Control Panel.
 * 
 * 
 * 
 * 
 * 
 */
Gemma.Metaheatmap.FactorTree = Ext
   .extend(
      Ext.tree.TreePanel,
      {

         /**
          * @memberOf Gemma.Metaheatmap.FactorTree
          */
                     ...
                     initializeFromSortedTree : function() {
                        ...
                        for (var i = 0; i < categoryNodes.length; i++) {
                           ...
                           var ftCategoryNode = new Ext.tree.TreeNode(
                              {
                                 ...
                                 text : (sftCategoryNode.groupName && sftCategoryNode.groupName !== null && sftCategoryNode.groupName !== "null") ? sftCategoryNode.groupName
                                    : "No category",
                                 checked : true,
                                 iconCls : '',
                                 cls : ''
                           ...
                           for (var j = 0; j < factorNodes.length; j++) {
                              ...
                              var baselines = [];
                              for (var k = 0; k < sftFactorNode.items.length; k++) {
                              ...
                              var ftFactorNode = new Ext.tree.TreeNode(
                                 {
                                    ...
                                    text : (sftFactorNode.groupName && sftFactorNode.groupName !== null && sftFactorNode.groupName !== "null") ? sftFactorNode.groupName
                                       + "<span style=\"color:grey\"> vs " + baselines.join( ',' ) + '</span>'
                                       : "No value",
                                    checked : true,
                                    cls : '',
                                    iconCls : ''

...
Gemma.ExperimentalFactorChooserPanel = Ext.extend( Ext.Window, {
   ...
   /**
    * @memberOf Gemma.ExperimentalFactorChooserPanel
    */
   onCommit : function() {
   ...
   onHelp : function() {
      ...
      Ext.Msg.alert( Gemma.HelpText.WidgetDefaults.ExperimentalFactorChooserPanel.helpTitle,
   ...
   returnFromGetFactors : function( results ) {
      ...
      if ( results.size() > 0 ) {
         ...
         this.loadMask.hide();
         Ext.Msg.alert( Gemma.HelpText.WidgetDefaults.ExperimentalFactorChooserPanel.noResultsTitle,

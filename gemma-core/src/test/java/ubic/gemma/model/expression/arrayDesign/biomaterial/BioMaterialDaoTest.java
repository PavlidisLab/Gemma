 ...
 *
 */
package ubic.gemma.model.expression.arrayDesign.biomaterial;
...
/**
 * @author Kiran Keshav $Id: BioMaterialDaoTest.java,v 1.1.2.1 2006/04/30
 *         02:44:24 kkeshav Exp $
 */
public class BioMaterialDaoTest extends BaseTransactionalSpringContextTest {
	...
	public void testSetExternalAccession() throws Exception {
		...
		ExternalDatabaseDao edd = (ExternalDatabaseDao) this
				.getBean("externalDatabaseDao");

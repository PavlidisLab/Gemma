...
public class DifferentialExpressionResultDaoTest extends BaseDatabaseTest {
    ...
    public void testFindByGeneAndExperimentAnalyzedGroupingBySourceExperiment() {
        ...
        sessionFactory.getCurrentSession().createSQLQuery( "insert into GENE2CS (GENE, CS, AD) values (?, ?, ?)" )
                ...
                .executeUpdate();
        differentialExpressionResultDao.findByGeneAndExperimentAnalyzed( gene, Collections.singleton( 1L ), true, null, 1.0, false );
        differentialExpressionResultDao.findByGeneAndExperimentAnalyzed( gene, Collections.singleton( 1L ), true, null, 1.0, false );
        differentialExpressionResultDao.findByGeneAndExperimentAnalyzed( gene, Collections.singleton( 1L ), false, null, 1.0, false );
        differentialExpressionResultDao.findByGeneAndExperimentAnalyzed( gene, Collections.singleton( 1L ), false, null, 1.0, false );
        assertThatThrownBy( () -> differentialExpressionResultDao.findByGeneAndExperimentAnalyzed( gene, Collections.singleton( 1L ), true, null, 1.2, false ) )
                .isInstanceOf( IllegalArgumentException.class );
        assertThatThrownBy( () -> differentialExpressionResultDao.findByGeneAndExperimentAnalyzed( gene, Collections.singleton( 1L ), true, null, -1, false ) )
                .isInstanceOf( IllegalArgumentException.class );
    }

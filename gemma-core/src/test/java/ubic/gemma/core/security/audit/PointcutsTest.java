...
public class PointcutsTest extends AbstractJUnit4SpringContextTests {
    ...
    static class MyAspect {
        ...
        @Before("ubic.gemma.core.util.Pointcuts.loader()")
        ...
        @Before("ubic.gemma.core.util.Pointcuts.transactionalMethod()")
        public void doTransactionalAdvice( JoinPoint jp ) {
        }

        @Before("ubic.gemma.core.util.Pointcuts.retryableOrTransactionalServiceMethod()")

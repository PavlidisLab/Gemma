...
public class OntologyServiceTest extends BaseTest {
    ...
    public void testFindTermInexact() throws OntologySearchException, SearchException {
        ...
        verify( characteristicService ).findByValueUriOrValueLike( eq( "9-chloro-5-phenyl-3-prop-2-enyl-1,2,4,5-tetrahydro-3-benzazepine-7,8-diol" ), eq( Arrays.asList( ExpressionExperiment.class, ExperimentalDesign.class, FactorValue.class, BioMaterial.class ) ), eq( false ) );

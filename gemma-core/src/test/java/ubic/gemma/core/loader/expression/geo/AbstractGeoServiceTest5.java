 ...
 * @author pavlidis
 */
public abstract class AbstractGeoServiceTest5 extends BaseSpringContextTest5 {
    ...
    protected String getTestFileBasePath() throws URISyntaxException {
        ...
        return FileTools.resourceToPath( AbstractGeoServiceTest5.GEO_TEST_DATA_ROOT );

    }

    protected String getTestFileBasePath( String subPath ) throws URISyntaxException {

        return FileTools.resourceToPath( AbstractGeoServiceTest5.GEO_TEST_DATA_ROOT + subPath );

...
public class GeoConverterTest extends BaseIntegrationTest {
    ...
    public final void test5C() {
        ...
        Collection<ExpressionExperiment> r = this.gc
                .convert( series );
    ...
    public void testConvertDataDoubles() {
        ...
        Object[] data = gc.convertData( testList.toArray( new String[1] ), qt );
        assertNotNull( data );
        byte[] actualResult = objectArrayToBytes( data );
        double[] revertedResult = byteArrayToDoubles( actualResult );
        assertEquals( 1.1, revertedResult[0], 0.00001 );
        assertEquals( 2929202e-4, revertedResult[1], 0.00001 );
        assertEquals( -394949.44422, revertedResult[2], 0.00001 );
    }
    ...
    public void testConvertDataIntegers() {
        ...
        Object[] data = gc.convertData( testList.toArray( new String[0] ), qt );
        assertNotNull( data );
        byte[] actualResult = objectArrayToBytes( data );
    ...
    public void testConvertGenePix() throws Exception {
        ...
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE2221" );
    ...
    public void testConvertGSE106() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE106" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Object result = this.gc.convert( series );
    ...
    public void testConvertGSE18Stress() throws Exception {
        ...
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE18" );
    ...
    public void testConvertGSE2122SAGE() throws Exception {
        ...
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE2122" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<ExpressionExperiment> result = this.gc.convert( series );
        assertTrue( result.isEmpty() ); // SAGE, rejected
    }
    ...
    public void testConvertGSE29014() throws Exception {
        ...
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<ExpressionExperiment> ees = this.gc.convert( series );
    ...
    public void testConvertGSE2982() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE2982" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<ExpressionExperiment> ees = this.gc.convert( series );
    ...
    public void testConvertGSE360() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE360" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Object result = this.gc.convert( series );
    ...
    public void testConvertGSE3791() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE3791" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<ExpressionExperiment> result = this.gc.convert( series );
    ...
    public void testConvertGSE404() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE404" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<ExpressionExperiment> result = this.gc.convert( series );
    ...
    public void testConvertGSE4229IMAGE() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE4229" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<ExpressionExperiment> result = this.gc.convert( series );
    ...
    public void testConvertGse59() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE59" );
        DatasetCombiner datasetCombiner = new DatasetCombiner( false );
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
    ...
    public void testConvertGSE60() throws Exception {
        ...
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE60" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<ExpressionExperiment> result = this.gc.convert( series );
    ...
    public void testConvertGSE235534() throws Exception {
        ...
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE235534" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<ExpressionExperiment> result = this.gc.convert( series );
    ...
    public void testConvertMultiSeriesPerSample() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE3193" );
        DatasetCombiner datasetCombiner = new DatasetCombiner( false );
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<?> result = this.gc.convert( series );
        assertNotNull( result );
        ExpressionExperiment ee = ( ExpressionExperiment ) result.iterator().next();
    ...
    public void testConvertMultiTaxonDatasetGSE7540() throws Exception {
        ...
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE7540" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<ExpressionExperiment> result = this.gc.convert( series );
    ...
    public void testConvertWithLotsOfPlatforms() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE3500" );
        DatasetCombiner datasetCombiner = new DatasetCombiner( false );
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Object result = this.gc.convert( series );
    ...
    public void testFetchAndLoadGSE8294() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE8294" );
        DatasetCombiner datasetCombiner = new DatasetCombiner( false );
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
    ...
    public void testGPL6096ExonArray() throws Exception {
        ...
        GeoPlatform platform = parser.getResults().iterator().next().getPlatformMap()
                .get( "GPL6096" );

        gc.setElementLimitForStrictness( 500 );
        ArrayDesign result = this.gc.convert( platform );
        assertNotNull( result );
    }
    ...
    public final void testGSE8872() throws Exception {
        ...
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE8872" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<ExpressionExperiment> result = this.gc.convert( series );
    ...
    public void testIllegalArgumentExceptionMultipleTaxaOnArrayWithNoOrganismColumn() throws Exception {
        try {
            ...
            ArrayDesign ad = this.gc.convert( platform );
            assertNotNull( ad );
    ...
    public void testParseGSE44625() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoParseResult result = parser.getResults().iterator().next();
        ...
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
        Collection<?> convert = this.gc.convert( series );
        ExpressionExperiment ee = ( ExpressionExperiment ) convert.iterator().next();
        ...
        for ( BioAssay ba : ee.getBioAssays() ) {
            for ( Characteristic c : ba.getSampleUsed().getCharacteristics() ) {
                ...
                if ( !category.equals( "strain" ) )
                    assertFalse( c.getValue().contains( ":" ) ); // this is actually allowed if there's : in the value itself...Crl:CD1(ICR)
    ...
    public void testSplitByPlatform() throws Exception {
        ...
        GeoFamilyParser parser = new GeoFamilyParser();
        parser.parse( is );
        GeoSeries series = parser.getResults().iterator().next().getSeriesMap().get( "GSE493" );
        DatasetCombiner datasetCombiner = new DatasetCombiner();
        GeoSampleCorrespondence correspondence = datasetCombiner.findGSECorrespondence( series );
        series.setSampleCorrespondence( correspondence );
    ...
    public void testParseValue() {
        Assertions.assertThat( gc.parseValue( null, ( PrimitiveType.DOUBLE ) ) ).isNull();
        Assertions.assertThat( gc.parseValue( "", ( PrimitiveType.DOUBLE ) ) ).isNull();
        Assertions.assertThat( gc.parseValue( "  ", ( PrimitiveType.DOUBLE ) ) ).isNull();

        Assertions.assertThat( gc.parseValue( "4.0", ( PrimitiveType.DOUBLE ) ) ).isEqualTo( 4.0 );
        Assertions.assertThat( gc.parseValue( "4", ( PrimitiveType.DOUBLE ) ) ).isEqualTo( 4.0 );
        Assertions.assertThat( gc.parseValue( " 4 ", ( PrimitiveType.DOUBLE ) ) ).isEqualTo( 4.0 );
        Assertions.assertThatThrownBy( () -> gc.parseValue( "abc", ( PrimitiveType.DOUBLE ) ) )
                .isInstanceOf( IllegalArgumentException.class );

        Assertions.assertThat( gc.parseValue( "4.0", ( PrimitiveType.FLOAT ) ) ).isEqualTo( 4.0f );
        Assertions.assertThat( gc.parseValue( "4", ( PrimitiveType.FLOAT ) ) ).isEqualTo( 4.0f );
        Assertions.assertThat( gc.parseValue( " 4 ", ( PrimitiveType.FLOAT ) ) ).isEqualTo( 4.0f );

        assertThatThrownBy( () -> gc.parseValue( "4.0", ( PrimitiveType.INT ) ) )
                .isInstanceOf( IllegalArgumentException.class );
        Assertions.assertThat( gc.parseValue( "4", ( PrimitiveType.INT ) ) ).isEqualTo( 4 );
        Assertions.assertThat( gc.parseValue( " 4 ", ( PrimitiveType.INT ) ) ).isEqualTo( 4 );

        Assertions.assertThat( gc.parseValue( "a", ( PrimitiveType.CHAR ) ) ).isEqualTo( 'a' );
        Assertions.assertThat( gc.parseValue( " a ", ( PrimitiveType.CHAR ) ) ).isEqualTo( 'a' );
        assertThatThrownBy( () -> gc.parseValue( "ab", ( PrimitiveType.CHAR ) ) )
                .isInstanceOf( IllegalArgumentException.class );

        Assertions.assertThat( gc.parseValue( "true", ( PrimitiveType.BOOLEAN ) ) ).isEqualTo( true );
        Assertions.assertThat( gc.parseValue( "1", ( PrimitiveType.BOOLEAN ) ) ).isEqualTo( true );
        Assertions.assertThat( gc.parseValue( "TRUE", ( PrimitiveType.BOOLEAN ) ) ).isEqualTo( true );
        Assertions.assertThat( gc.parseValue( "false", ( PrimitiveType.BOOLEAN ) ) ).isEqualTo( false );
        Assertions.assertThat( gc.parseValue( "FALSE", ( PrimitiveType.BOOLEAN ) ) ).isEqualTo( false );
        Assertions.assertThat( gc.parseValue( "0", ( PrimitiveType.BOOLEAN ) ) ).isEqualTo( false );
        assertThatThrownBy( () -> gc.parseValue( "ketchup", ( PrimitiveType.BOOLEAN ) ) )
                .isInstanceOf( IllegalArgumentException.class );
    }
}

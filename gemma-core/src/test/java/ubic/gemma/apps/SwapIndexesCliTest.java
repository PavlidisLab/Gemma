...
/**
 * Simple command line to test the swapping of two different indexes on the same
 * database.
 * 
 * @author klc
 * @version $Id$
 */
public class SwapIndexesCliTest extends AbstractSpringAwareCLI {
	...
	public static void main(String[] args) {
		SwapIndexesCliTest p = new SwapIndexesCliTest();
	...
	protected Exception doWork(String[] args) {
		...
		IndexService indexS = (IndexService) this.getBean("indexService");

		try {

			testSearch();

			indexS.replaceExperimentIndex(ConfigUtils.getString("gemma.home")
					+ "/expression22/index/");

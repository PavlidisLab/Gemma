 ...
 */
@Component
public class SpaceMonitorImpl extends AbstractTaskService implements SpaceMonitor {
    ...
    public SpaceMonitorImpl() {
        this.setBusinessInterface( MonitorTask.class );
    }

    /* (non-Javadoc)
     * @see ubic.gemma.job.grid.util.SpaceMonitor#disable()
     */
    @Override
    public void disable() {
        this.enabled = false;
    ...
    /* (non-Javadoc)
     * @see ubic.gemma.job.grid.util.SpaceMonitor#getLastStatusMessage()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ubic.gemma.job.grid.util.SpaceMonitor#getLastStatusWasOK()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ubic.gemma.job.grid.util.SpaceMonitor#getNumberOfPings()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ubic.gemma.job.grid.util.SpaceMonitor#getNumberOfBadPings()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ubic.gemma.job.grid.util.SpaceMonitor#ping()
     */
    @Override
    public boolean ping() {
        if ( !enabled ) {

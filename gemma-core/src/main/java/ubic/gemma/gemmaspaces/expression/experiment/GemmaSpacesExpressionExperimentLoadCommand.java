 ...
 * @version $Id$
 */
public class GemmaSpacesExpressionExperimentLoadCommand extends GemmaSpacesCommand implements Serializable {
     ...
     */
    public GemmaSpacesExpressionExperimentLoadCommand( String taskId, boolean loadPlatformOnly,

...
public class PazarConverterImpl implements PazarConverter {
     ...
     * (non-Javadoc)
     * 
     * @see ubic.gemma.core.loader.pazar.PazarConverter#convert(java.util.Collection)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see ubic.gemma.core.loader.pazar.PazarConverter#convert(ubic.gemma.core.loader.pazar.model.PazarRecord)
     */
    @Override

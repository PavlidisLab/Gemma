    ...
    private Characteristic convertSeriesType( GeoSeries series, GeoSeriesType seriesType ) {
        switch ( seriesType ) {
            case EXPRESSION_PROFILING_BY_RT_PRC:
                return Characteristic.Factory.newInstance( Categories.ASSAY, "transcription profiling by RT-PCR assay", "http://purl.obolibrary.org/obo/OBI_0001361" );
            case EXPRESSION_PROFILING_BY_MPSS:
                return Characteristic.Factory.newInstance( Categories.ASSAY, "transcription profiling by MPSS assay", "http://purl.obolibrary.org/obo/OBI_0002015" );
            case EXPRESSION_PROFILING_BY_TILING_ARRAY:
                return Characteristic.Factory.newInstance( Categories.ASSAY, "transcription profiling by tiling array assay", "http://purl.obolibrary.org/obo/OBI_0001235" );
            case EXPRESSION_PROFILING_BY_ARRAY:
            case EXPRESSION_PROFILING_BY_SNP_ARRAY:
            case NON_CODING_RNA_PROFILING_BY_ARRAY:
                return Characteristic.Factory.newInstance( Categories.ASSAY, "transcription profiling by array assay", "http://purl.obolibrary.org/obo/OBI_0001463" );
            case METHYLATION_PROFILING_BY_HIGH_THROUGHPUT_SEQUENCING:
                return Characteristic.Factory.newInstance( Categories.ASSAY, "DNA methylation profiling by high throughput sequencing assay", "http://purl.obolibrary.org/obo/OBI_0001266" );
            case METHYLATION_PROFILING_BY_GENOME_TILING_ARRAY:
                return Characteristic.Factory.newInstance( Categories.ASSAY, "DNA methylation profiling by array assay", "http://purl.obolibrary.org/obo/OBI_0001332" );
            case EXPRESSION_PROFILING_BY_SAGE:
                return Characteristic.Factory.newInstance( Categories.ASSAY, "serial analysis of gene expression assay", "http://purl.obolibrary.org/obo/OBI_0002029" );

...
public enum GeoSeriesType {
    ...
    GENOME_BINDING_PROFILING_BY_SNP_ARRAY( "Genome binding/occupancy profiling by SNP array" ),
    GENOME_BINDING_PROFILING_BY_TILING_ARRAY( "Genome binding/occupancy profiling by genome tiling array" ),
    GENOME_BINDING_PROFILING_BY_ARRAY( "Genome binding/occupancy profiling by array" ),

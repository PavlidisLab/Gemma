...
public class GenericMetadataSingleCellDataLoaderConfigurer implements SingleCellDataLoaderConfigurer<GenericMetadataSingleCellDataLoader> {
    ...
    public GenericMetadataSingleCellDataLoader configureLoader( SingleCellDataLoaderConfig config ) {
        ...
        GenericMetadataSingleCellDataLoader loader = new GenericMetadataSingleCellDataLoader( delegate.configureLoader( config ), config.getCellTypeAssignmentFile(), config.getOtherCellLevelCharacteristicsFile(), config.getOtherCellLevelMeasurementsFile() );

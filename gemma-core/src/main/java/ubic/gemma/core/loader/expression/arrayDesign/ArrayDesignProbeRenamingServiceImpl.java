...
public class ArrayDesignProbeRenamingServiceImpl implements ArrayDesignProbeRenamingService {
     ...
     * (non-Javadoc)
     * 
     * @see ubic.gemma.core.loader.expression.arrayDesign.ArrayDesignProbeRenamingService#reName(ubic.gemma.model.expression.
     ...
     * 
     * @see
     * ubic.gemma.core.loader.expression.arrayDesign.ArrayDesignProbeRenamingService#setArrayDesignService(ubic.gemma.model

            ...
            for ( CSVRecord record : reader ) {
                ...
                if ( cellType != null ) {
                    ...
                    if ( cellTypesToId.containsKey( c ) ) {
                        ...
                        log.info( "New cell type detected: " + c + ", it will be coded as " + k + "." );
                    }
                    assignedBioAssays.add( ba );
                } else {
                    // indicate a missing cell type
                    log.warn( sample + "[" + cellId + "]: Both cell_type and cell_type_uri columns are blank, will be treated as unassigned." );
                    k = -1;
                }

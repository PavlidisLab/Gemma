...
public abstract class SymbolChangeAndLoggingAbstract extends AbstractCLIContextCLI {
    ...
    static Gene populateRatGene( String officialSymbol, Collection<Gene> genesFound ) {
        ...
        if ( officialSymbol.equalsIgnoreCase( "Itga2b" ) ) {
            theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "685269", genesFound );
        }
        // Tcf7l2 => 679869
        else if ( officialSymbol.equalsIgnoreCase( "Tcf7l2" ) ) {
            theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "679869", genesFound );
        }
        // Pkd2 => 498328
        else if ( officialSymbol.equalsIgnoreCase( "Pkd2" ) ) {
            theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "498328", genesFound );
        }
        // Mthfd2 => 680308
        else if ( officialSymbol.equalsIgnoreCase( "Mthfd2" ) ) {
            theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "680308", genesFound );
        }
        // Mthfd2 => 680308
        else if ( officialSymbol.equalsIgnoreCase( "Mef2a" ) ) {
            theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "309957", genesFound );
        }
        // Mmp1 => 432357
        else if ( officialSymbol.equalsIgnoreCase( "Mmp1" ) ) {
            theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "300339", genesFound );
        }
    ...
    static Gene populateMouseGene( String officialSymbol, Collection<Gene> genesFound ) {
        ...
        if ( officialSymbol.equalsIgnoreCase( "H2-Ea-ps" ) ) {
            theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "100504404", genesFound );
        }
        // Ccl21b => 100504404
        else if ( officialSymbol.equalsIgnoreCase( "Ccl21b" ) ) {
            theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "100042493", genesFound );
        }
        return theChosenGene;
    }

    private static Gene findCorrectGene( String ncbiId, Collection<Gene> genesFound ) {
    ...
    void writeError( String errorMessage ) {
        AbstractCLI.log.error( errorMessage );
    ...
    private Gene checkForSymbolChange( String officialSymbol, String evidenceTaxon ) throws IOException {
        ...
        if ( newOfficialSymbol != null ) {
            return this.findGeneUsingSymbolandTaxon( newOfficialSymbol, evidenceTaxon );
        }

        this.writeError( "Symbol: " + officialSymbol + "   Taxon:" + evidenceTaxon
    ...
    private Gene treatGemmaMultipleGeneSpeacialCases( String officialSymbol, Collection<Gene> genesFound,
        ...
        if ( evidenceTaxon.equalsIgnoreCase( "human" ) ) {
            ...
            if ( officialSymbol.equalsIgnoreCase( "HLA-DRB1" ) ) {
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "3123", genesFound );
            }
            // CCR2 => 729230
            else if ( officialSymbol.equalsIgnoreCase( "CCR2" ) ) {
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "729230", genesFound );
            }
            // NPC1 => 4864
            else if ( officialSymbol.equalsIgnoreCase( "NPC1" ) ) {
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "4864", genesFound );
            }
            // PRG4 => 10216
            else if ( officialSymbol.equalsIgnoreCase( "PRG4" ) ) {
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "10216", genesFound );
            }
            // TTC34 => 100287898
            else if ( officialSymbol.equalsIgnoreCase( "TTC34" ) ) {
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "100287898", genesFound );
            }
            // DNAH12 => 201625
            else if ( officialSymbol.equalsIgnoreCase( "DNAH12" ) ) {
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "201625", genesFound );
            }
            // PSORS1C3 => 100130889
            else if ( officialSymbol.equalsIgnoreCase( "PSORS1C3" ) ) {
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "100130889", genesFound );
            }
            // MICA => 100507436
            else if ( officialSymbol.equalsIgnoreCase( "MICA" ) ) {
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "100507436", genesFound );
            }
            ...
            // ADH5P2 => 343296
                ...
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "343296", genesFound );
            }

            // RPL15P3 => 653232
            else if ( officialSymbol.equalsIgnoreCase( "RPL15P3" ) ) {
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "653232", genesFound );
            }

            // DCDC5 => 100506627
            else if ( officialSymbol.equalsIgnoreCase( "DCDC5" ) ) {
                theChosenGene = SymbolChangeAndLoggingAbstract.findCorrectGene( "100506627", genesFound );
            }

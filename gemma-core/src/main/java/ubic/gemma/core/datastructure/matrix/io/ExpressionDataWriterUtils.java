...
public class ExpressionDataWriterUtils {
     ...
     * @param experiment ee
     */
    public static void appendBaseHeader( ExpressionExperiment experiment, boolean design, String gemmaHostUrl, StringBuffer buf ) {
        String fileType = "data";
        if ( design )
            fileType = "design";
        appendBaseHeader( experiment, "Expression " + fileType, gemmaHostUrl, buf );
    }
     ...
     */
    public static void appendBaseHeader( @Nullable ExpressionExperiment experiment, String fileTypeStr, String gemmaHostUrl, StringBuffer buf ) {
        ...
        if ( experiment != null ) {
            ...
            buf.append( "# Experiment details: " ).append( gemmaHostUrl )

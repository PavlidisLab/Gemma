 ...
 *
 */
package ubic.gemma.core.security.gsec;

import ubic.gemma.core.security.gsec.acl.domain.AclService;
import org.springframework.security.acls.domain.GrantedAuthoritySid;
import org.springframework.security.acls.domain.PrincipalSid;
import ubic.gemma.core.security.gsec.authentication.GroupManager;
import ubic.gemma.core.security.gsec.authentication.UserDetailsManager;
import ubic.gemma.core.security.gsec.authentication.UserService;
...
public class SecurityServiceImpl implements SecurityService {
    ...
    public boolean isOwnedByCurrentUser( Securable s ) {
        ...
        try {
             ...
             * owner.
             */
            String ownerAuthority = ubic.gemma.core.security.gsec.acl.domain.Sids.grantedAuthority( owner );
            ...
            String ownerName = ubic.gemma.core.security.gsec.acl.domain.Sids.principalName( owner );
            if ( ownerName != null ) {
    ...
    public void makeOwnedByUser( Securable s, String userName ) {
        ...
        String ownerName = ubic.gemma.core.security.gsec.acl.domain.Sids.principalName( acl.getOwner() );
    ...
    private int removeOneGrantedAuthority( Securable object, Permission permission, String authority ) {
        ...
        for ( int i = 0; i < acl.getEntries().size(); i++ ) {
            ...
            String ga = ubic.gemma.core.security.gsec.acl.domain.Sids.grantedAuthority( sid );

...
public class GemmaAclConfiguration {
    ...
    static class GsecAclServiceAdapter implements AclService {
         ...
         * from DB rows; callers passing in gsec's {@link ubic.gemma.core.security.acl.domain.AclObjectIdentity} get
         ...
         * {@link ubic.gemma.core.security.acl.domain.AclObjectIdentity}: ObjectIdentityImpl#equals does an

...
import ubic.gemma.core.security.acl.voter.AclEntryCollectionVoter;
...
public interface SecurityService {
     ...
     *
     * @see ubic.gemma.core.security.util.SecurityUtil#isPublic(Acl)
     */
     ...
     *
     * @see ubic.gemma.core.security.util.SecurityUtil#isShared(Acl)
     */
     ...
     * @see ubic.gemma.core.security.util.SecurityUtil#isPrivate(Acl)
     */

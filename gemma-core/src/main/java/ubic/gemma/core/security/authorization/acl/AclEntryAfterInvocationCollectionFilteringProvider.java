 ...
 * {@code ubic.gemma.core.security.acl.afterinvocation.AclEntryAfterInvocationCollectionFilteringProvider}
    ...
    protected final boolean hasPermission( Authentication authentication, Object domainObject ) {
        ...
        if ( domainObjectsWithPermission.get() != null ) {
            ...
            try {
                ...
                // object instead of aborting the entire filter pass. Mirrors the
                // sibling fix in the legacy ubic.gemma.core.security.acl.afterinvocation
                // package (commit e94a2fe3e1).

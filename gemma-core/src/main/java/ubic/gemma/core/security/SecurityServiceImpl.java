...
public class SecurityServiceImpl implements SecurityService {
    ...
    public SecurityServiceImpl( AclService aclService, SessionRegistry sessionRegistry, ObjectIdentityRetrievalStrategy objectIdentityRetrievalStrategy, SidRetrievalStrategy sidRetrievalStrategy, UserDetailsManager userDetailsManager, GroupManager groupManager, BaseUserService userService ) {
    ...
    public boolean isOwnedByCurrentUser( Securable s ) {
        ...
        try {
             ...
             * owner.
             */
            String ownerAuthority = ubic.gemma.core.security.acl.domain.Sids.grantedAuthority( owner );
    ...
    private int removeOneGrantedAuthority( Securable object, Permission permission, String authority ) {
        ...
        for ( int i = 0; i < acl.getEntries().size(); i++ ) {
            ...
            String ga = ubic.gemma.core.security.acl.domain.Sids.grantedAuthority( sid );

...
import ubic.gemma.core.security.gsec.acl.voter.AclEntryCollectionVoter;
...
public interface SecurityService {
     ...
     *
     * @see ubic.gemma.core.security.gsec.util.SecurityUtil#isPublic(Acl)
     */
     ...
     *
     * @see ubic.gemma.core.security.gsec.util.SecurityUtil#isShared(Acl)
     */
     ...
     * @see ubic.gemma.core.security.gsec.util.SecurityUtil#isPrivate(Acl)
     */

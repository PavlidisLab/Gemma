...
import static ubic.gemma.core.security.acl.afterinvocation.AclEntryAfterInvocationValueObjectProvider.populateValueObject;
        ...
        for ( ObjectIdentity oi : ois ) {
            ...
            if ( acl != null ) {
                try {
                    ...
                    // than aborting the entire filter pass with an exception.

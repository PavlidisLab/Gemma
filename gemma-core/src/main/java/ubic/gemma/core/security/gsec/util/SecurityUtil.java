 ...
 */
package ubic.gemma.core.security.gsec.util;

import ubic.gemma.core.security.gsec.AuthorityConstants;
import ubic.gemma.core.security.gsec.acl.domain.AclGrantedAuthoritySid;
import ubic.gemma.core.security.gsec.acl.domain.AclPrincipalSid;
...
public class SecurityUtil {
    ...
    public static boolean isPrivate( Acl acl ) {
        ...
        for ( AccessControlEntry ace : acl.getEntries() ) {
            ...
            String grantedAuthority = ubic.gemma.core.security.gsec.acl.domain.Sids.grantedAuthority( ace.getSid() );

...
public interface SingleCellExpressionExperimentAggregatorService {
     ...
     * @param adjustLibrarySizes perform adjustment of library sizes to better reflect the number of reads in the source
     *                           sample
    ...
    QuantitationType aggregateVectors( ExpressionExperiment ee, QuantitationType qt, List<BioAssay> cellBAs, boolean makePreferred, boolean adjustLibrarySizes ) throws UnsupportedScaleTypeForAggregationException;

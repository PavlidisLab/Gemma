...
public interface ExpressionDataFileService {
     ...
     * @param scaleType            a scale type to use or null to leave the data untransformed
     * @param onlyIncludeBioAssays
     * @param useBioAssayIds       whether to use bioassay and biomaterial IDs instead of names or short names
     * @param useRawColumnNames    whether to use raw column names instead of R-friendly ones
     * @param writer               the destination for the raw expression data
     * @throws IOException if operations with the writer fails
     */
    int writeRawExpressionData( ExpressionExperiment ee, QuantitationType qt, @Nullable ScaleType scaleType, boolean onlyIncludeBioAssays, boolean useBioAssayIds, boolean useRawColumnNames, Writer writer, boolean autoFlush ) throws IOException;

    int writeRawExpressionData( ExpressionExperiment ee, List<BioAssay> samples, QuantitationType qt, @Nullable ScaleType scaleType, boolean onlyIncludeBioAssays, boolean useBioAssayIds, boolean useRawColumnNames, Writer writer, boolean autoFlush ) throws IOException;
     ...
     * @throws IOException if operations with the writer fails
     */
    int writeProcessedExpressionData( ExpressionExperiment ee, boolean filtered, @Nullable ScaleType scaleType, boolean onlyIncludeBioAssays, boolean useBioAssayIds, boolean useRawColumnNames, Writer writer, boolean autoFlush ) throws FilteringException, IOException;

    int writeProcessedExpressionData( ExpressionExperiment ee, List<BioAssay> samples, boolean filtered, @Nullable ScaleType scaleType, boolean onlyIncludeBioAssays, boolean useBioAssayIds, boolean useRawColumnNames, Writer writer, boolean autoFlush ) throws FilteringException, IOException;

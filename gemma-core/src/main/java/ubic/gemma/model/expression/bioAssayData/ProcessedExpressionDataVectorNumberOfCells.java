...
@Setter
@Entity
@Table(name = "PROCESSED_EXPRESSION_DATA_VECTOR_NUMBER_OF_CELLS")
class ProcessedExpressionDataVectorNumberOfCells extends BulkExpressionDataVectorNumberOfCells {
    ...
    @JoinColumn(name = "ID", columnDefinition = "BIGINT",
            foreignKey = @ForeignKey(name = "PROCESSED_EXPRESSION_DATA_VECTOR_FKC"))
    private ProcessedExpressionDataVector vector;

...
public final class FactorTypeEnum extends FactorType implements org.hibernate.usertype.EnhancedUserType {
    ...
    public String objectToSQLString( Object object ) {
        return String.valueOf( ( ( ubic.gemma.model.expression.experiment.FactorType ) object ).getValue() );
    }
    ...
    public Object fromXMLString( String string ) {
        return ubic.gemma.model.expression.experiment.FactorType.fromString( String.valueOf( string ) );
    }
    ...
    @Override
    public int[] sqlTypes() {
        return FactorTypeEnum.SQL_TYPES;
    }

...
public final class GeneralTypeEnum extends GeneralType implements org.hibernate.usertype.EnhancedUserType {
    ...
    public String objectToSQLString( Object object ) {
        return String.valueOf( ( ( ubic.gemma.model.common.quantitationtype.GeneralType ) object ).getValue() );
    }
    ...
    public Object fromXMLString( String string ) {
        return ubic.gemma.model.common.quantitationtype.GeneralType.fromString( String.valueOf( string ) );
    }
    ...
    @Override
    public int[] sqlTypes() {
        return GeneralTypeEnum.SQL_TYPES;
    }

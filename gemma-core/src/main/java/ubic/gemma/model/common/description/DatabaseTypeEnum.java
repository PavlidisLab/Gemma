...
public final class DatabaseTypeEnum extends DatabaseType implements org.hibernate.usertype.EnhancedUserType {
    ...
    public String objectToSQLString( Object object ) {
        return String.valueOf( ( ( ubic.gemma.model.common.description.DatabaseType ) object ).getValue() );
    }
    ...
    public Object fromXMLString( String string ) {
        return ubic.gemma.model.common.description.DatabaseType.fromString( String.valueOf( string ) );
    }
    ...
    @Override
    public int[] sqlTypes() {
        return DatabaseTypeEnum.SQL_TYPES;
    }

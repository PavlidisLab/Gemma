...
public final class MeasurementKindEnum extends MeasurementKind implements org.hibernate.usertype.EnhancedUserType {
    ...
    public String objectToSQLString( Object object ) {
        return String.valueOf( ( ( ubic.gemma.model.common.measurement.MeasurementKind ) object ).getValue() );
    }
    ...
    public Object fromXMLString( String string ) {
        return ubic.gemma.model.common.measurement.MeasurementKind.fromString( String.valueOf( string ) );
    }
    ...
    @Override
    public int[] sqlTypes() {
        return MeasurementKindEnum.SQL_TYPES;
    }

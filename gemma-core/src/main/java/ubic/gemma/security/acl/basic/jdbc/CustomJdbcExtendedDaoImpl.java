 ...
 * </p>
 * <p>
 * If you are using a cache with <code>BasicAclProvider</code>, you should specify that cache via {@link
 * #setBasicAclEntryCache(BasicAclEntryCache)}. This will cause cache evictions (removals) to take place whenever a DAO
 * mutator method is called.
 * </p>
 * <p>
 * This implementation works with <code>String</code> based recipients and {@link
 * org.springframework.security.acl.basic.NamedEntityObjectIdentity} only. The latter can be changed by overriding
 * {@link #convertAclObjectIdentityToString(AclObjectIdentity)}.
 * </p>
 * 
 * @author Ben Alex
 * @author keshav
 ...
 */
public class CustomJdbcExtendedDaoImpl extends JdbcDaoImpl implements BasicAclExtendedDao {
    // ~ Static fields/initializers
    // =====================================================================================

    private static final Log logger = LogFactory.getLog( CustomJdbcExtendedDaoImpl.class );
    ...
    public CustomJdbcExtendedDaoImpl() {
    ...
    public void create( BasicAclEntry basicAclEntry, boolean createAclPermission ) throws DataAccessException {
        ...
        if ( createAclPermission ) {
            aclPermissionInsert.insert( new Long( aclDetailsHolder.getForeignKeyId() ), basicAclEntry.getRecipient()
                    .toString(), new Integer( basicAclEntry.getMask() ) );
        }
    ...
    public void create( BasicAclEntry basicAclEntry ) throws DataAccessException {
        throw new UnsupportedOperationException( "Use create(BasicAclEntry, boolean) instead." );

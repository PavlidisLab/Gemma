...
public class ProcessedExpressionDataVectorCreateServiceImpl implements ProcessedExpressionDataVectorCreateService {
    ...
    /* (non-Javadoc)
     * @see ubic.gemma.analysis.preprocess.ProcessedExpressionDataVectorCreateService#computeProcessedExpressionData(ubic.gemma.model.expression.experiment.ExpressionExperiment)
     */

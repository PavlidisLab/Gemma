...
public class LinkAnalysisTest {
    ...
    public static void main( String[] args ) {
        ...
        /*
         * DbManager dbManager; try{ dbManager = new DbManager(); ObjectArrayList temp = new ObjectArrayList(); Link
         * oneLink = new Link(1,2,0.3); temp.add(oneLink); dbManager.addLinks(temp, null); } catch(Exception e) {

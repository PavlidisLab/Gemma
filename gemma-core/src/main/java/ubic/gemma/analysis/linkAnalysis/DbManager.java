...
public class DbManager {
    ...
    public void addLinks( ObjectArrayList linkLists, DoubleMatrixNamed dataMatrix ) throws SQLException {
        ...
        this.dbHandle.runUpdateQuery( "CREATE TEMPORARY TABLE  link_temp( " + "p1 CHAR(40) NOT NULL,"
                + "p2 CHAR(40) NOT NULL," + "score DOUBLE NOT NULL default 0," + "pvalue DOUBLE NOT NULL default 0)" );

        /*
         * this.dbHandle.runUpdateQuery( "CREATE TEMPORARY TABLE link_temp (d SMALLINT UNSIGNED NOT NULL," + "p1
         * MEDIUMINT UNSIGNED NOT NULL, p2 MEDIUMINT UNSIGNED NOT NULL, s " + "SMALLINT UNSIGNED NOT NULL, pv SMALLINT
         * UNSIGNED)" );
         */

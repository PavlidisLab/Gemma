...
public class SimpleTTestAnalyzer extends RCommander{
    ...
    /**
     * This method detects the significant genes of an experiment for differential expression
    ...
    protected Hashtable<String, Double> findPValues(String subsetName1, String subsetName2){
        ...
        for (int g = 0; g < numberOfGenes; g++){  
            ...
            for (int k = 0; k < subsetNames.length; k++){
                ...
                else if (subsetNames[k].equals(subsetName2))
                    group2ExpLevels.add(expLevels[k]);
            }
    ...
    public static void main(String[] args){
        ...
        Hashtable<String, Double> sigGenes2 = analyzer.getSignificantGenes("GDS1110", "pre-neoplastic cell", "tumor cell");

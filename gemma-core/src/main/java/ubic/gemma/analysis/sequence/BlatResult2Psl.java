...
public class BlatResult2Psl {
    ...
    /**
     * Creates text that can be displayed directly as a track in UCSC, using their hgTracks program. See
     * {@link  http://genome.ucsc.edu/goldenPath/help/customTrack.html}
     * 
     * @param blatResult
     * @return
     */
    public static String blatResult2PslTrack( BlatResult blatResult ) {
        ...
        buf.append( "## Generated by Gemma (http://www.bioinformatics.ubc.ca/Gemma)\n" );

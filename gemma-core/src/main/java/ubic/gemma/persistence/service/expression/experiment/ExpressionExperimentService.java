...
public interface ExpressionExperimentService extends SecurableBaseService<ExpressionExperiment>,
     ...
     * @param autoGenerated indicate if the new factor value added is auto-generated, if not the
     * {@link ExperimentalFactor#isAutoGenerated()} will be set to false.
     */
    @Secured({ "GROUP_USER", "ACL_SECURABLE_EDIT" })
    FactorValue addFactorValue( ExpressionExperiment ee, FactorValue fv, boolean autoGenerated );
     ...
     */
    @Secured({ "GROUP_USER", "ACL_SECURABLE_EDIT" })
    void addFactorValues( ExpressionExperiment ee, Map<BioMaterial, FactorValue> fvs, boolean autoGenerated );
    ...
    @Nullable
    @Secured({ "IS_AUTHENTICATED_ANONYMOUSLY", "AFTER_ACL_READ" })
    ExpressionExperiment findByDesignId( Long experimentalDesignID );

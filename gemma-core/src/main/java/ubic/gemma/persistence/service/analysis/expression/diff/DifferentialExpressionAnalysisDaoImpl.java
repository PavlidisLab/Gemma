...
public class DifferentialExpressionAnalysisDaoImpl extends DifferentialExpressionAnalysisDaoBase {
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDao#countDownregulated(ubic.gemma.model
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDao#countProbesMeetingThreshold(ubic.
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDao#countUpregulated(ubic.gemma.model
     * .analysis.expression.ExpressionAnalysisResultSet, double)
     */
    @Override
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDao#findByFactor(ubic.gemma.model.expression
     ...
     * (non-Javadoc)
     * 
     * @see AnalysisDao#findByName(java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDao#getAnalyses(java.util.Collection)
     */
    @Override
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDao#getAnalysesByExperimentIds(java.util
     * .Collection)
     */
    @Override
    public Map<Long, Collection<DifferentialExpressionAnalysisValueObject>> getAnalysesByExperimentIds(
        ...
        Collection<DifferentialExpressionAnalysis> hits = this
                ...
                .getCurrentSession()
                .createQuery(
                        "select distinct a from DifferentialExpressionAnalysisImpl a join fetch a.experimentAnalyzed e join"
         ...
         */
        List<DifferentialExpressionAnalysis> analysesofSubsets = this
                .getSessionFactory()
                .getCurrentSession()
                .createQuery(
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDao#getExperimentsWithAnalysis(java.util
     * .Collection)
     */
    @Override
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDao#getExperimentsWithAnalysis(ubic.gemma
     * .model.genome.Taxon)
     */
    @Override
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDaoBase#handleFind(ubic.gemma.model.genome
     ...
     * (non-Javadoc)
     * 
     * @see AnalysisDaoBase#handleFindByInvestigation(ubic.gemma.model.analysis.Investigation)
     */
    @Override
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDaoBase#handleFindByInvestigationIds(
     ...
     * (non-Javadoc)
     * 
     * @see AnalysisDaoBase#handleFindByInvestigations(java.util.Collection)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see AnalysisDaoBase#handleFindByTaxon(ubic.gemma.model.genome.Taxon)
     */
    @Override
     ...
     * 
     * @see
     * DifferentialExpressionAnalysisDaoBase#handleFindExperimentsWithAnalyses

...
public class BlacklistedEntityDaoImpl extends AbstractVoEnabledDao<BlacklistedEntity, BlacklistedValueObject> implements BlacklistedEntityDao {
     ...
     * (non-Javadoc)
     *
     * @see ubic.gemma.persistence.service.blacklist.BlacklistedEntityDao#findByAccession(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see ubic.gemma.persistence.service.blacklist.BlacklistedEntityDao#isBlacklisted(java.lang.String)
     */
    @Override

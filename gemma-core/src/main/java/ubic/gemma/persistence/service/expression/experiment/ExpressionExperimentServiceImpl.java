...
public class ExpressionExperimentServiceImpl
    ...
    @Override
    @Transactional
    public FactorValue addFactorValue( ExpressionExperiment ee, FactorValue fv, boolean autoGenerated ) {
    ...
    @Override
    @Transactional
    public void addFactorValues( ExpressionExperiment ee, Map<BioMaterial, FactorValue> fvs, boolean autoGenerated ) {
        ExpressionExperiment experiment = requireNonNull( expressionExperimentDao.load( ee.getId() ) );
        if ( experiment.getExperimentalDesign() == null ) {
            log.info( "Creating missing experimental design for " + experiment );
            experiment.setExperimentalDesign( new ExperimentalDesign() );
    ...
    @Override
    @Transactional(readOnly = true)
    public ExpressionExperiment findByDesignId( Long experimentalDesignID ) {
        return this.expressionExperimentDao.findByDesignId( experimentalDesignID );
    }

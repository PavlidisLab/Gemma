...
public abstract class DatabaseEntryDaoBase extends org.springframework.orm.hibernate3.support.HibernateDaoSupport
    ...
    public java.lang.Integer countAll() {
        try {
            ...
            throw new java.lang.RuntimeException(
                    "Error performing 'DatabaseEntryDao.countAll()' --> " + th, th );
        }
    }

    /**
     * @see DatabaseEntryDao#create(int, java.util.Collection)
     */
    @Override
    ...
    /**
     * @see DatabaseEntryDao#create(int transform,
    ...
    /**
     * @see DatabaseEntryDao#find(int, java.lang.String,
     *      ubic.gemma.model.common.description.DatabaseEntry)
     */
    ...
    /**
     * @see DatabaseEntryDao#findByAccession(int, java.lang.String,
    ...
    /**
     * @see DatabaseEntryDao#load(int, java.lang.Long)
     */
    @Override
    ...
    /**
     * @see DatabaseEntryDao#loadAll(int)
     */
    @Override
    ...
    /**
     * @see DatabaseEntryDao#remove(java.lang.Long)
     */
    @Override
    ...
    /**
     * @see DatabaseEntryDao#remove(java.util.Collection)
     */
    @Override
    ...
    /**
     * @see DatabaseEntryDao#remove(ubic.gemma.model.common.description.DatabaseEntry)
     */
    @Override
    ...
    /**
     * @see DatabaseEntryDao#update(java.util.Collection)
     */
    @Override
    ...
    /**
     * @see DatabaseEntryDao#update(ubic.gemma.model.common.description.DatabaseEntry)
     */
    @Override

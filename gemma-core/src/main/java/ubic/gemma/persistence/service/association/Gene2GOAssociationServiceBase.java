...
import ubic.gemma.persistence.service.common.description.VocabCharacteristicDao;
...
public abstract class Gene2GOAssociationServiceBase implements Gene2GOAssociationService, InitializingBean {
    ...
    @Autowired
    private VocabCharacteristicDao vocabCharacteristicDao;
    ...
    public void setVocabCharacteristicDao(
            VocabCharacteristicDao vocabCharacteristicDao ) {

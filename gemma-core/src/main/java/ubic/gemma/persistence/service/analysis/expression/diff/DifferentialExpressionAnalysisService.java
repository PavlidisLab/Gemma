...
public interface DifferentialExpressionAnalysisService extends BaseService<DifferentialExpressionAnalysis>, SingleExperimentAnalysisService<DifferentialExpressionAnalysis> {
     ...
     * <p>
     * Probes and contrasts are initialized.
     * @see DifferentialExpressionAnalysisDao#findResultsByGene(Gene, Collection, Map)
     */
    @Secured({ "IS_AUTHENTICATED_ANONYMOUSLY" })
    List<DifferentialExpressionAnalysisResult> findResultsByGene( Gene gene, @Nullable Collection<Long> experimentIds, Map<DifferentialExpressionAnalysisResult, Long> result2ExperimentId );

...
public abstract class CoexpressionAnalysisDaoBase extends AnalysisDaoBase<CoexpressionAnalysis> implements
    ...
    /**
     * @see CoexpressionAnalysisDao#create(int, java.util.Collection)
     */
    @Override
    ...
    /**
     * @see CoexpressionAnalysisDao#create(int transform,
    ...
    /**
     * @see CoexpressionAnalysisDao#findByName(int, java.lang.String)
     */
    ...
    /**
     * @see CoexpressionAnalysisDao#load(int, java.lang.Long)
     */
    ...
    /**
     * @see CoexpressionAnalysisDao#loadAll(int)
     */
    ...
    /**
     * @see CoexpressionAnalysisDao#remove(java.lang.Long)
     */
    ...
    /**
     * @see CoexpressionAnalysisDao#remove(ubic.gemma.model.analysis.expression.coexpression.CoexpressionAnalysis)
     */
    @Override
    ...
    /**
     * @see CoexpressionAnalysisDao#update(ubic.gemma.model.analysis.expression.coexpression.CoexpressionAnalysis)
     */
    @Override

...
public interface CharacteristicService extends BaseService<Characteristic>, FilteringVoEnabledService<Characteristic, CharacteristicValueObject> {
     ...
     */
    Map<String, Characteristic> findCharacteristicsByValueUriOrValueLike( String search, @Nullable Collection<Class<?>> parentClasses );

    Map<String, Long> countCharacteristicsByValueUri( Collection<String> uris, @Nullable Collection<Class<?>> parentClasses );

...
public class SingleCellExpressionExperimentServiceImpl implements SingleCellExpressionExperimentService {
    ...
    public void updateSparsityMetrics( ExpressionExperiment ee ) {
        ...
        if ( preferredQt.isPresent() ) {
            ...
            try ( Stream<SingleCellExpressionDataVector> vecs = expressionExperimentDao.streamSingleCellDataVectors( ee, preferredQt.get(), QueryUtils.DEFAULT_FETCH_SIZE, QueryUtils.DEFAULT_USE_CURSOR_FETCH, false ) ) {

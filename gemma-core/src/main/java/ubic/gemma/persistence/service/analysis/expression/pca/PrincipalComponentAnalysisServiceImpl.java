...
public class PrincipalComponentAnalysisServiceImpl extends AbstractService<PrincipalComponentAnalysis>
    ...
    @Autowired
    private PrincipalComponentAnalysisReadService readService;
    ...
    // =====================================================================
    // Read methods -- delegate to PrincipalComponentAnalysisReadService.
    // ACL @Secured annotations live on the PrincipalComponentAnalysisService
    ...
    public List<ProbeLoading> getTopLoadedProbes( ExpressionExperiment ee, int component, int count ) {
        return readService.getTopLoadedProbes( ee, component, count );
    }

    @Override
    public PrincipalComponentAnalysis loadForExperiment( ExpressionExperiment ee ) {
        return readService.loadForExperiment( ee );
    }

    @Override
    public boolean existsByExperiment( ExpressionExperiment ee ) {
        return readService.existsByExperiment( ee );
    }

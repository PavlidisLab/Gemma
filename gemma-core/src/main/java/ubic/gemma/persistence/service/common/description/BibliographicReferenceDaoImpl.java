...
public class BibliographicReferenceDaoImpl extends BibliographicReferenceDaoBase {
     ...
     * 
     * @see
     * BibliographicReferenceDaoBase#findOrCreate(ubic.gemma.model.common.description
     * .BibliographicReference)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see BibliographicReferenceDao#getRelatedExperiments(java.util.Collection)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see BibliographicReferenceDao#thaw(java.util.Collection)
     */
    @Override

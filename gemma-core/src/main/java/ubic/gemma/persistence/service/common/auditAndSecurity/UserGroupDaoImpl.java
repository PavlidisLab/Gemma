...
import ubic.gemma.model.common.auditAndSecurity.UserGroupImpl;
...
public class UserGroupDaoImpl extends UserGroupDaoBase {
     ...
     * 
     * @see
     * UserGroupDao#addAuthority(ubic.gemma.model.common.auditAndSecurity.UserGroup
     * , java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * UserGroupDao#addToGroup(ubic.gemma.model.common.auditAndSecurity.UserGroup
    ...
    /**
     * @see UserGroupDao#create(int transform,
     ...
     * 
     * @see
     * UserGroupDao#findGroupsForUser(ubic.gemma.model.common.auditAndSecurity
     * .User)
     */
    @Override
    ...
    /**
     * @see UserGroupDao#remove(ubic.gemma.model.common.auditAndSecurity.UserGroup)
     */
    @Override
     ...
     * 
     * @see
     * UserGroupDao#removeAuthority(ubic.gemma.model.common.auditAndSecurity
    ...
    /**
     * @see UserGroupDao#update(ubic.gemma.model.common.auditAndSecurity.UserGroup)
     */
    @Override

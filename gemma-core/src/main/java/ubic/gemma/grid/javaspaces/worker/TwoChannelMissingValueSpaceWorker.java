 ...
 * @version $Id$
 */
public class TwoChannelMissingValueSpaceWorker extends AbstractSpacesWorkerCLI {
    ...
    protected void setRegistrationEntryTask() throws Exception {
        registrationEntry.message = TwoChannelMissingValueTask.class.getName();
    ...
    protected void setWorker() {
        worker = ( CustomDelegatingWorker ) updatedContext.getBean( "twoChannelMissingValueWorker" );
    }

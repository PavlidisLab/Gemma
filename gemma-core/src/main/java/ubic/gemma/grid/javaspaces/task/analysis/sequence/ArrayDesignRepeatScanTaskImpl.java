 ...
 *
 */
package ubic.gemma.grid.javaspaces.task.analysis.sequence;
...
public class ArrayDesignRepeatScanTaskImpl extends BaseSpacesTask implements ArrayDesignRepeatScanTask {
     ...
     * (non-Javadoc)
     * @see
     * ubic.gemma.grid.javaspaces.task.analysis.sequence.ArrayDesignRepeatScanTask#execute(ubic.gemma.grid.javaspaces.analysis

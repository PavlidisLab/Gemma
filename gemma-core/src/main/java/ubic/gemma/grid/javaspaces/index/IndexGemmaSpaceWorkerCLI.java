...
/**
 * This command line interface is used to take {@link IndexGemmaTask} tasks from the {@link JavaSpace} and
 * returns the results.
 * 
 * @author klc
 *
 */
public class IndexGemmaSpaceWorkerCLI extends AbstractSpacesWorkerCLI {

	private static Log log = LogFactory.getLog(IndexGemmaSpaceWorkerCLI.class);
	...
	protected void setWorker() {
		worker = (CustomDelegatingWorker) updatedContext
				.getBean("indexGemmaSpaceWorker");
	...
	protected void setRegistrationEntryTask() throws Exception {
		registrationEntry.message = IndexGemmaTask.class.getName();
	}
	...
	public static void main(String[] args) {
		...
		IndexGemmaSpaceWorkerCLI p = new IndexGemmaSpaceWorkerCLI();
		try {

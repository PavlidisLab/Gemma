...
public class LinkAnalysisCli extends AbstractSpringAwareCLI {
	 ...
	 *These two files could contain the lists of experiment;
	 */ 
	...
	protected void buildOptions() {
        ...
        Option geneFileOption = OptionBuilder.hasArg().isRequired().withArgName( "Gene Expression file" ).withDescription(
        "The Gene Expression File for analysis" ).withLongOpt( "genefile" ).create( 'f' );
        addOption( geneFileOption );

        Option goFileOption = OptionBuilder.hasArg().isRequired().withArgName( "Gene Annotation file" ).withDescription(
        "The Gene Annotation File for gene expression file" ).withLongOpt( "gofile" ).create( 'g' );
        ...
        "If using absolute value in expression file" ).withLongOpt( "abs" ).create( 'a' );
        addOption( absoluteValue );
        
        Option useDB = OptionBuilder.withDescription(
        "If Saving the link into database" ).withLongOpt( "usedb" ).create( 'd' );
        addOption( useDB);
	}

...
create table CELL_LEVEL_CHARACTERISTICS (ID BIGINT not null auto_increment, INDICES LONGBLOB, SINGLE_CELL_DIMENSION_FK BIGINT, primary key (ID)) ENGINE=InnoDB;

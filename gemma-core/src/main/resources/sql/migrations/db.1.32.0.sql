...
alter table QUANTITATION_TYPE add column IS_SINGLE_CELL_PREFERRED TINYINT not null;
...
alter table BIO_ASSAYS2SINGLE_CELL_DIMENSIONS add index BIO_ASSAYS_FKC (BIO_ASSAYS_FK), add constraint BIO_ASSAYS_FKC foreign key (BIO_ASSAYS_FK) references BIO_ASSAY (ID);

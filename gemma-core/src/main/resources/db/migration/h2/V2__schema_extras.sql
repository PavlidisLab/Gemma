--
-- V2 schema extras: tables, columns, and indices that the Hibernate metadata model does NOT emit
-- but the test code path requires. Mirrors the populator chain that BaseDatabaseTest used to apply
-- via DatabaseSchemaPopulator("h2"):
...
--   - sql/h2/init-entities.sql (H2-specific composite indices on CHARACTERISTIC + EE2C)
...
-- ============================================================
-- From sql/h2/init-entities.sql (H2-specific composite indices).
-- ============================================================

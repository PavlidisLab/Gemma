...
public final class expressionExperiment_detail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\t\t// need wrapper panel because tabPanels can't have title headers (it's used for tabs)\n");
      out.write("\t\tnew Gemma.GemmaViewPort({\n");
      out.write("\t\t \tcenterPanelConfig: new Ext.Panel({\n");
      out.write("\t\t \t\titems:[\n");
      out.write("\t\t \t\t\tnew Gemma.ExpressionExperimentPage( {\n");
      out.write("\t\t\t\t\t\teeId: Ext.get(\"eeId\").getValue()\n");
      out.write("\t\t\t\t})],\n");
      out.write("\t\t\t \tlayout:'fit', \n");
      out.write("\t\t\t \ttitle: Ext.get(\"eeShortName\").getValue()\n");
      out.write("\t\t\t })\n");
      out.write("\t\t});\n");
      out.write("\t});\n");
      out.write("\t\n");
      out.write("</script>\n");
      out.write("\n");
      out.write("<input id=\"eeId\" type=\"hidden\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${eeId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\" />\n");
      out.write("<input id=\"taxonName\" type=\"hidden\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${taxonName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("  \" />\n");
      out.write("<input id=\"eeShortName\" type=\"hidden\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${expressionExperiment.shortName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("  \" />\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("<div spellcheck=\"false\" id=\"eedetails\">\n");
      out.write("\t<div id=\"messages\"></div>\n");
      out.write("</div>\n");
      out.write("\n");
      out.write("<div id=\"eepage\"></div>\n");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_jwr_005fscript_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/pages/expressionExperiment.detail.jsp(4,1) name = src type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_jwr_005fscript_005f0.setSrc("/scripts/ajax/ext/data/DwrProxy.js");
    // /WEB-INF/pages/expressionExperiment.detail.jsp(4,1) name = useRandomParam type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_jwr_005fscript_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/pages/expressionExperiment.detail.jsp(6,1) name = src type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_jwr_005fscript_005f1.setSrc("/scripts/app/eeDataFetch.js");
    // /WEB-INF/pages/expressionExperiment.detail.jsp(6,1) name = useRandomParam type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

...
public class GoldenPathTest extends TestCase {
    ...
    public final void testGetThreePrimeDistance() {
        ...
        int actualResult = ( ( ThreePrimeData ) gp.getThreePrimeDistances( "11", location, location + 2 ).get( 0 ) )
                .getDistance();
        ...
        actualResult = ( ( ThreePrimeData ) gp.getThreePrimeDistances( "11", location, location + 200 ).get( 0 ) )
                .getDistance();
        expectedResult = 0;
        assertEquals( expectedResult, actualResult );
        ...
        List actualResultL = gp.getThreePrimeDistances( "11", location + 101, location + 200 );
        ...
        location = 1439902 - 100;
        actualResultL = gp.getThreePrimeDistances( "11", location + 100, location + 200 );
        expectedResultL = null;
        assertEquals( expectedResultL, actualResultL );

        // gene <<<<<, location does not overlap but matches exactly
        location = 206138 + 100;
        actualResult = ( ( ThreePrimeData ) gp.getThreePrimeDistances( "11", location + 100, location + 200 ).get( 0 ) )
                .getDistance();
        expectedResult = 200;
        assertEquals( expectedResult, actualResult );
        ...
        location = 206138 + 100;
        actualResult = ( ( ThreePrimeData ) gp.getThreePrimeDistances( "11", location - 200, location + 200 ).get( 0 ) )
                .getDistance();
        expectedResult = 0;
        assertEquals( expectedResult, actualResult );
        ...
        // gene <<<<<, no overlap
        location = 206138 + 100;
        actualResultL = gp.getThreePrimeDistances( "11", location - 200, location - 199 );
        expectedResultL = null;
        assertEquals( expectedResultL, actualResultL );

        // gene <<<<<, region contains gene entirely
        location = 206138; // start of the gene.
        actualResult = ( ( ThreePrimeData ) gp.getThreePrimeDistances( "11", location - 200, location + 10000 ).get( 0 ) )
                .getDistance();
        expectedResult = 0;
        assertEquals( expectedResult, actualResult );
        ...
        location = 206138; // start of the gene.
        actualResult = gp.getThreePrimeDistances( "11", location - 200, location + 100000 ).size();
        expectedResult = 7;
        assertEquals( expectedResult, actualResult );
